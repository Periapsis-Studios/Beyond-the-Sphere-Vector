...
method computeCost*(self: AStar; fromId: int64; toId: int64): float64 {.gcsafe,
    locks: 0, base.}
method estimateCost*(self: AStar; fromId: int64; toId: int64): float64 {.gcsafe,
    locks: 0, base.}
proc addPoint*(self: AStar; id: int64; position: Vector3;
               weightScale: float64 = 1.0) {.gcsafe, locks: 0.}
...
proc setPointDisabled*(self: AStar; id: int64; disabled: bool = true) {.gcsafe,
    locks: 0.}
proc setPointPosition*(self: AStar; id: int64; position: Vector3) {.gcsafe,
    locks: 0.}
...
proc addPoint(self: AStar; id: int64; position: Vector3;
  ...
  var ptrCallRet: pointer
  aStarAddPointMethodBind.ptrCall(self.godotObject, argsToPassToGodot,
                                  ptrCallRet)
...
proc getIdPath(self: AStar; fromId: int64; toId: int64): PoolIntArray =
  ...
  aStarGetIdPathMethodBind.ptrCall(self.godotObject, argsToPassToGodot,
                                   ptrCallRet)
...
proc getPointConnections(self: AStar; id: int64): PoolIntArray =
  ...
  initGodotPoolIntArray(ptrCallVal)
  ptrCallRet = addr(ptrCallVal)
  aStarGetPointConnectionsMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
  result = newPoolIntArray(ptrCallVal)
...
proc getPointWeightScale(self: AStar; id: int64): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  aStarGetPointWeightScaleMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc hasPoint(self: AStar; id: int64): bool =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  aStarHasPointMethodBind.ptrCall(self.godotObject, argsToPassToGodot,
                                  ptrCallRet)
...
proc removePoint(self: AStar; id: int64) =
  if isNil(aStarRemovePointMethodBind):
    aStarRemovePointMethodBind = getMethod(cstring"AStar",
...
proc reserveSpace(self: AStar; numNodes: int64) =
  if isNil(aStarReserveSpaceMethodBind):
    aStarReserveSpaceMethodBind = getMethod(cstring"AStar",
...
proc setPointWeightScale(self: AStar; id: int64; weightScale: float64) =
  ...
  var ptrCallRet: pointer
  aStarSetPointWeightScaleMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

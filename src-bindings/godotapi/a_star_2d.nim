...
method estimateCost*(self: AStar2D; fromId: int64; toId: int64): float64 {.
    gcsafe, locks: 0, base.}
proc addPoint*(self: AStar2D; id: int64; position: Vector2;
               weightScale: float64 = 1.0) {.gcsafe, locks: 0.}
proc arePointsConnected*(self: AStar2D; id: int64; toId: int64): bool {.gcsafe,
    locks: 0.}
proc clear*(self: AStar2D) {.gcsafe, locks: 0.}
proc connectPoints*(self: AStar2D; id: int64; toId: int64;
...
proc getPointConnections*(self: AStar2D; id: int64): PoolIntArray {.gcsafe,
    locks: 0.}
...
proc setPointDisabled*(self: AStar2D; id: int64; disabled: bool = true) {.
    gcsafe, locks: 0.}
proc setPointPosition*(self: AStar2D; id: int64; position: Vector2) {.gcsafe,
    locks: 0.}
...
proc getIdPath(self: AStar2D; fromId: int64; toId: int64): PoolIntArray =
  if isNil(aStar2DGetIdPathMethodBind):
    aStar2DGetIdPathMethodBind = getMethod(cstring"AStar2D",
        cstring"get_id_path")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc getPoints(self: AStar2D): Array =
  if isNil(aStar2DGetPointsMethodBind):
    aStar2DGetPointsMethodBind = getMethod(cstring"AStar2D",
        cstring"get_points")
  var ptrCallRet: pointer

...
proc `frame100delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame101delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame102delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame103delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame104delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame105delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame106delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame107delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame108delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame109delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame110delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame111delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame112delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame113delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame114delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame115delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame116delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame117delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame118delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame119delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame120delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame121delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame122delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame123delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame124delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame125delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame126delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame127delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame128delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame129delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame130delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame131delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame132delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame133delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame134delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame135delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame136delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame137delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame138delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame139delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame140delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame141delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame142delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame143delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame144delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame145delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame146delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame147delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame148delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame149delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame150delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame151delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame152delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame153delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame154delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame155delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame156delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame157delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame158delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame159delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame160delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame161delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame162delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame163delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame164delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame165delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame166delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame167delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame168delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame169delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame170delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame171delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame172delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame173delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame174delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame175delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame176delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame177delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame178delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame179delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame180delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame181delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame182delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame183delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame184delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame185delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame186delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame187delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame188delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame189delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame190delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame191delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame192delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame193delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame194delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame195delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame196delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame197delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame198delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame199delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame200delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame201delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame202delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame203delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame204delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame205delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame206delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame207delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame208delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame209delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame210delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame211delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame212delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame213delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame214delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame215delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame216delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame217delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame218delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame219delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame220delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame221delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame222delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame223delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame224delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame225delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame226delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame227delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame228delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame229delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame230delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame231delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame232delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame233delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame234delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame235delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame236delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame237delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame238delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame239delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame240delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame241delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame242delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame243delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame244delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame245delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame246delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame247delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame248delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame249delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame250delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame251delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame252delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame253delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame254delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc `frame255delaySec=`*(self: AnimatedTexture; val: float64) {.gcsafe,
    locks: 0.}
...
proc frame0delaySec(self: AnimatedTexture): float64 =
  if isNil(animatedTextureGetFrameDelayMethodBind):
    animatedTextureGetFrameDelayMethodBind = getMethod(
        cstring"AnimatedTexture", cstring"get_frame_delay")
  var
...
proc `frame0delaySec=`(self: AnimatedTexture; val: float64) =
  if isNil(animatedTextureSetFrameDelayMethodBind):
    animatedTextureSetFrameDelayMethodBind = getMethod(
        cstring"AnimatedTexture", cstring"set_frame_delay")
  var
    godotBoundArg0 = 0'i64
...
proc `frames=`(self: AnimatedTexture; val: int64) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  animatedTextureSetFramesMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

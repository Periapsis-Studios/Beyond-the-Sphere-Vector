...
proc addTrack*(self: Animation; typee: int64; atPosition: int64 = -1'i64): int64 {.
    gcsafe, locks: 0.}
proc animationTrackGetKeyAnimation*(self: Animation; trackIdx: int64;
                                    keyIdx: int64): string {.gcsafe, locks: 0.}
proc animationTrackInsertKey*(self: Animation; trackIdx: int64; time: float64;
                              animation: string): int64 {.gcsafe, locks: 0.}
proc animationTrackSetKeyAnimation*(self: Animation; trackIdx: int64;
                                    keyIdx: int64; animation: string) {.gcsafe,
    locks: 0.}
proc audioTrackGetKeyEndOffset*(self: Animation; trackIdx: int64; keyIdx: int64): float64 {.
    gcsafe, locks: 0.}
proc audioTrackGetKeyStartOffset*(self: Animation; trackIdx: int64;
                                  keyIdx: int64): float64 {.gcsafe, locks: 0.}
...
proc audioTrackSetKeyStartOffset*(self: Animation; trackIdx: int64;
                                  keyIdx: int64; offset: float64) {.gcsafe,
    locks: 0.}
...
proc bezierTrackSetKeyOutHandle*(self: Animation; trackIdx: int64;
                                 keyIdx: int64; outHandle: Vector2) {.gcsafe,
    locks: 0.}
...
proc methodTrackGetKeyIndices*(self: Animation; trackIdx: int64;
                               timeSec: float64; delta: float64): PoolIntArray {.
    gcsafe, locks: 0.}
...
proc trackFindKey*(self: Animation; trackIdx: int64; time: float64;
                   exact: bool = false): int64 {.gcsafe, locks: 0.}
...
proc trackGetInterpolationType*(self: Animation; trackIdx: int64): int64 {.
    gcsafe, locks: 0.}
proc trackGetKeyCount*(self: Animation; trackIdx: int64): int64 {.gcsafe,
    locks: 0.}
...
proc trackGetKeyValue*(self: Animation; trackIdx: int64; keyIdx: int64): Variant {.
    gcsafe, locks: 0.}
proc trackGetPath*(self: Animation; trackIdx: int64): NodePath {.gcsafe,
    locks: 0.}
proc trackGetType*(self: Animation; trackIdx: int64): int64 {.gcsafe, locks: 0.}
proc trackInsertKey*(self: Animation; trackIdx: int64; time: float64;
                     key: Variant; transition: float64 = 1.0) {.gcsafe, locks: 0.}
...
proc trackMoveTo*(self: Animation; trackIdx: int64; toIdx: int64) {.gcsafe,
    locks: 0.}
proc trackMoveUp*(self: Animation; trackIdx: int64) {.gcsafe, locks: 0.}
proc trackRemoveKey*(self: Animation; trackIdx: int64; keyIdx: int64) {.gcsafe,
    locks: 0.}
proc trackRemoveKeyAtPosition*(self: Animation; trackIdx: int64;
                               position: float64) {.gcsafe, locks: 0.}
...
proc trackSetKeyTime*(self: Animation; trackIdx: int64; keyIdx: int64;
                      time: float64) {.gcsafe, locks: 0.}
proc trackSetKeyTransition*(self: Animation; trackIdx: int64; keyIdx: int64;
                            transition: float64) {.gcsafe, locks: 0.}
proc trackSetKeyValue*(self: Animation; trackIdx: int64; key: int64;
                       value: Variant) {.gcsafe, locks: 0.}
proc trackSetPath*(self: Animation; trackIdx: int64; path: NodePath) {.gcsafe,
    locks: 0.}
proc trackSwap*(self: Animation; trackIdx: int64; withIdx: int64) {.gcsafe,
    locks: 0.}
proc transformTrackInsertKey*(self: Animation; trackIdx: int64; time: float64;
    ...
    gcsafe, locks: 0.}
proc transformTrackInterpolate*(self: Animation; trackIdx: int64;
                                timeSec: float64): Array {.gcsafe, locks: 0.}
proc valueTrackGetKeyIndices*(self: Animation; trackIdx: int64;
                              timeSec: float64; delta: float64): PoolIntArray {.
    gcsafe, locks: 0.}
proc valueTrackGetUpdateMode*(self: Animation; trackIdx: int64): int64 {.gcsafe,
    locks: 0.}
proc valueTrackInterpolate*(self: Animation; trackIdx: int64; timeSec: float64): Variant {.
    gcsafe, locks: 0.}
...
proc loop(self: Animation): bool =
  if isNil(animationHasLoopMethodBind):
    animationHasLoopMethodBind = getMethod(cstring"Animation",
        cstring"has_loop")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
...
proc `loop=`(self: Animation; val: bool) =
  if isNil(animationSetLoopMethodBind):
    animationSetLoopMethodBind = getMethod(cstring"Animation",
        cstring"set_loop")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc step(self: Animation): float64 =
  if isNil(animationGetStepMethodBind):
    animationGetStepMethodBind = getMethod(cstring"Animation",
        cstring"get_step")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
...
proc `step=`(self: Animation; val: float64) =
  if isNil(animationSetStepMethodBind):
    animationSetStepMethodBind = getMethod(cstring"Animation",
        cstring"set_step")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc addTrack(self: Animation; typee: int64; atPosition: int64 = -1'i64): int64 =
  if isNil(animationAddTrackMethodBind):
    animationAddTrackMethodBind = getMethod(cstring"Animation",
        cstring"add_track")
  var
...
proc audioTrackGetKeyEndOffset(self: Animation; trackIdx: int64; keyIdx: int64): float64 =
  if isNil(animationAudioTrackGetKeyEndOffsetMethodBind):
    animationAudioTrackGetKeyEndOffsetMethodBind = getMethod(
        cstring"Animation", cstring"audio_track_get_key_end_offset")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(trackIdx)
...
proc audioTrackSetKeyEndOffset(self: Animation; trackIdx: int64; keyIdx: int64;
  ...
  if isNil(animationAudioTrackSetKeyEndOffsetMethodBind):
    animationAudioTrackSetKeyEndOffsetMethodBind = getMethod(
        cstring"Animation", cstring"audio_track_set_key_end_offset")
  var
    argsStatic: array[3, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(trackIdx)
...
proc bezierTrackGetKeyInHandle(self: Animation; trackIdx: int64; keyIdx: int64): Vector2 =
  if isNil(animationBezierTrackGetKeyInHandleMethodBind):
    animationBezierTrackGetKeyInHandleMethodBind = getMethod(
        cstring"Animation", cstring"bezier_track_get_key_in_handle")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(trackIdx)
...
proc bezierTrackGetKeyOutHandle(self: Animation; trackIdx: int64; keyIdx: int64): Vector2 =
  if isNil(animationBezierTrackGetKeyOutHandleMethodBind):
    animationBezierTrackGetKeyOutHandleMethodBind = getMethod(
        cstring"Animation", cstring"bezier_track_get_key_out_handle")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(trackIdx)
...
proc bezierTrackSetKeyInHandle(self: Animation; trackIdx: int64; keyIdx: int64;
  ...
  if isNil(animationBezierTrackSetKeyInHandleMethodBind):
    animationBezierTrackSetKeyInHandleMethodBind = getMethod(
        cstring"Animation", cstring"bezier_track_set_key_in_handle")
  var
    argsStatic: array[3, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(trackIdx)
...
proc bezierTrackSetKeyOutHandle(self: Animation; trackIdx: int64; keyIdx: int64;
  ...
  if isNil(animationBezierTrackSetKeyOutHandleMethodBind):
    animationBezierTrackSetKeyOutHandleMethodBind = getMethod(
        cstring"Animation", cstring"bezier_track_set_key_out_handle")
  var
    argsStatic: array[3, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(trackIdx)
...
proc trackGetInterpolationType(self: Animation; trackIdx: int64): int64 =
  if isNil(animationTrackGetInterpolationTypeMethodBind):
    animationTrackGetInterpolationTypeMethodBind = getMethod(
        cstring"Animation", cstring"track_get_interpolation_type")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(trackIdx)
...
proc trackGetKeyTime(self: Animation; trackIdx: int64; keyIdx: int64): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  animationTrackGetKeyTimeMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc trackInsertKey(self: Animation; trackIdx: int64; time: float64;
                    key: Variant; transition: float64 = 1.0) =
...
proc trackIsImported(self: Animation; trackIdx: int64): bool =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  animationTrackIsImportedMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc trackSetEnabled(self: Animation; trackIdx: int64; enabled: bool) =
  ...
  var ptrCallRet: pointer
  animationTrackSetEnabledMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc trackSetInterpolationType(self: Animation; trackIdx: int64;
  ...
  if isNil(animationTrackSetInterpolationTypeMethodBind):
    animationTrackSetInterpolationTypeMethodBind = getMethod(
        cstring"Animation", cstring"track_set_interpolation_type")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(trackIdx)
...
proc trackSetKeyTime(self: Animation; trackIdx: int64; keyIdx: int64;
  ...
  var ptrCallRet: pointer
  animationTrackSetKeyTimeMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc transformTrackInterpolate(self: Animation; trackIdx: int64;
                               timeSec: float64): Array =
  if isNil(animationTransformTrackInterpolateMethodBind):
    animationTransformTrackInterpolateMethodBind = getMethod(
        cstring"Animation", cstring"transform_track_interpolate")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(trackIdx)
...
var animationValueTrackInterpolateMethodBind {.threadvar.}: ptr GodotMethodBind
proc valueTrackInterpolate(self: Animation; trackIdx: int64; timeSec: float64): Variant =
  if isNil(animationValueTrackInterpolateMethodBind):
    animationValueTrackInterpolateMethodBind = getMethod(cstring"Animation",
        cstring"value_track_interpolate")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(trackIdx)
  ...
  initGodotVariant(ptrCallVal)
  ptrCallRet = addr(ptrCallVal)
  animationValueTrackInterpolateMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
  result = newVariant(ptrCallVal)

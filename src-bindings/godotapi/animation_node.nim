...
proc blendAnimation*(self: AnimationNode; animation: string; time: float64;
                     delta: float64; seeked: bool; blend: float64) {.gcsafe,
    locks: 0.}
proc blendInput*(self: AnimationNode; inputIndex: int64; time: float64;
                 seek: bool; blend: float64; filter: int64 = 0'i64;
                 optimize: bool = true): float64 {.gcsafe, locks: 0.}
proc blendNode*(self: AnimationNode; name: string; node: AnimationNode;
                time: float64; seek: bool; blend: float64;
                filter: int64 = 0'i64; optimize: bool = true): float64 {.gcsafe,
    locks: 0.}
method getCaption*(self: AnimationNode): string {.gcsafe, locks: 0, base.}
method getChildByName*(self: AnimationNode; name: string): Object {.gcsafe,
    locks: 0, base.}
...
proc getParameter*(self: AnimationNode; name: string): Variant {.gcsafe,
    locks: 0.}
...
proc isPathFiltered*(self: AnimationNode; path: NodePath): bool {.gcsafe,
    locks: 0.}
method process*(self: AnimationNode; time: float64; seek: bool) {.gcsafe,
    locks: 0, base.}
...
proc setFilterPath*(self: AnimationNode; path: NodePath; enable: bool) {.gcsafe,
    locks: 0.}
proc setParameter*(self: AnimationNode; name: string; value: Variant) {.gcsafe,
    locks: 0.}
...
proc filterEnabled(self: AnimationNode): bool =
  ...
  animationNodeIsFilterEnabledMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc blendNode(self: AnimationNode; name: string; node: AnimationNode;
               time: float64; seek: bool; blend: float64; filter: int64 = 0'i64;
               optimize: bool = true): float64 =
...
proc removeInput(self: AnimationNode; index: int64) =
  ...
  var ptrCallRet: pointer
  animationNodeRemoveInputMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

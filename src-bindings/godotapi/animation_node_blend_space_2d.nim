...
proc `autoTriangles=`*(self: AnimationNodeBlendSpace2D; val: bool) {.gcsafe,
    locks: 0.}
proc blendMode*(self: AnimationNodeBlendSpace2D): int64 {.gcsafe, locks: 0.}
proc `blendMode=`*(self: AnimationNodeBlendSpace2D; val: int64) {.gcsafe,
    locks: 0.}
...
proc `blendPoint0node=`*(self: AnimationNodeBlendSpace2D; val: AnimationRootNode) {.
    gcsafe, locks: 0.}
proc blendPoint0pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc `blendPoint1node=`*(self: AnimationNodeBlendSpace2D; val: AnimationRootNode) {.
    gcsafe, locks: 0.}
proc blendPoint1pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint10node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint10node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint10pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint11node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint11node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint11pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint12node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint12node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint12pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint13node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint13node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint13pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint14node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint14node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint14pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint15node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint15node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint15pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint16node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint16node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint16pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint17node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint17node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint17pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint18node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint18node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint18pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint19node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint19node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint19pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc `blendPoint2node=`*(self: AnimationNodeBlendSpace2D; val: AnimationRootNode) {.
    gcsafe, locks: 0.}
proc blendPoint2pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint20node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint20node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint20pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint21node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint21node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint21pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint22node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint22node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint22pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint23node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint23node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint23pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint24node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint24node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint24pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint25node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint25node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint25pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint26node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint26node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint26pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint27node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint27node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint27pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint28node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint28node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint28pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint29node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint29node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint29pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc `blendPoint3node=`*(self: AnimationNodeBlendSpace2D; val: AnimationRootNode) {.
    gcsafe, locks: 0.}
proc blendPoint3pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint30node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint30node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint30pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint31node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint31node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint31pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint32node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint32node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint32pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint33node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint33node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint33pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint34node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint34node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint34pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint35node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint35node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint35pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint36node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint36node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint36pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint37node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint37node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint37pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint38node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint38node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint38pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint39node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint39node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint39pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc `blendPoint4node=`*(self: AnimationNodeBlendSpace2D; val: AnimationRootNode) {.
    gcsafe, locks: 0.}
proc blendPoint4pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint40node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint40node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint40pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint41node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint41node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint41pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint42node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint42node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint42pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint43node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint43node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint43pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint44node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint44node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint44pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint45node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint45node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint45pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint46node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint46node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint46pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint47node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint47node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint47pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint48node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint48node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint48pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint49node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint49node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint49pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc `blendPoint5node=`*(self: AnimationNodeBlendSpace2D; val: AnimationRootNode) {.
    gcsafe, locks: 0.}
proc blendPoint5pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint50node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint50node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint50pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint51node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint51node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint51pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint52node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint52node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint52pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint53node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint53node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint53pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint54node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint54node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint54pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint55node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint55node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint55pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint56node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint56node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint56pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint57node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint57node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint57pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint58node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint58node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint58pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint59node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint59node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint59pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc `blendPoint6node=`*(self: AnimationNodeBlendSpace2D; val: AnimationRootNode) {.
    gcsafe, locks: 0.}
proc blendPoint6pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint60node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint60node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint60pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint61node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint61node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint61pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint62node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint62node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint62pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc blendPoint63node*(self: AnimationNodeBlendSpace2D): AnimationRootNode {.
    gcsafe, locks: 0.}
proc `blendPoint63node=`*(self: AnimationNodeBlendSpace2D;
                          val: AnimationRootNode) {.gcsafe, locks: 0.}
proc blendPoint63pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc `blendPoint7node=`*(self: AnimationNodeBlendSpace2D; val: AnimationRootNode) {.
    gcsafe, locks: 0.}
proc blendPoint7pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc `blendPoint8node=`*(self: AnimationNodeBlendSpace2D; val: AnimationRootNode) {.
    gcsafe, locks: 0.}
proc blendPoint8pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc `blendPoint9node=`*(self: AnimationNodeBlendSpace2D; val: AnimationRootNode) {.
    gcsafe, locks: 0.}
proc blendPoint9pos*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe,
    locks: 0.}
...
proc `maxSpace=`*(self: AnimationNodeBlendSpace2D; val: Vector2) {.gcsafe,
    locks: 0.}
proc minSpace*(self: AnimationNodeBlendSpace2D): Vector2 {.gcsafe, locks: 0.}
proc `minSpace=`*(self: AnimationNodeBlendSpace2D; val: Vector2) {.gcsafe,
    locks: 0.}
...
proc triangles*(self: AnimationNodeBlendSpace2D): PoolIntArray {.gcsafe,
    locks: 0.}
...
method updateTriangles*(self: AnimationNodeBlendSpace2D) {.gcsafe, locks: 0,
    base.}
proc addBlendPointImpl*(self: AnimationNodeBlendSpace2D;
                        node: AnimationRootNode; pos: Vector2;
                        atIndex: int64 = -1'i64) {.gcsafe, locks: 0.}
proc addTriangle*(self: AnimationNodeBlendSpace2D; x: int64; y: int64; z: int64;
                  atIndex: int64 = -1'i64) {.gcsafe, locks: 0.}
proc getBlendPointCount*(self: AnimationNodeBlendSpace2D): int64 {.gcsafe,
    locks: 0.}
proc getTriangleCount*(self: AnimationNodeBlendSpace2D): int64 {.gcsafe,
    locks: 0.}
proc getTrianglePoint*(self: AnimationNodeBlendSpace2D; triangle: int64;
                       point: int64): int64 {.gcsafe, locks: 0.}

...
proc `graphOffset=`*(self: AnimationNodeBlendTree; val: Vector2) {.gcsafe,
    locks: 0.}
method nodeChanged*(self: AnimationNodeBlendTree; node: string) {.gcsafe,
    locks: 0, base.}
...
proc connectNode*(self: AnimationNodeBlendTree; inputNode: string;
                  inputIndex: int64; outputNode: string) {.gcsafe, locks: 0.}
...
proc getNodePosition*(self: AnimationNodeBlendTree; name: string): Vector2 {.
    gcsafe, locks: 0.}
proc hasNode*(self: AnimationNodeBlendTree; name: string): bool {.gcsafe,
    locks: 0.}
...
proc renameNode*(self: AnimationNodeBlendTree; name: string; newName: string) {.
    gcsafe, locks: 0.}
proc setNodePosition*(self: AnimationNodeBlendTree; name: string;
...
proc connectNode(self: AnimationNodeBlendTree; inputNode: string;
                 inputIndex: int64; outputNode: string) =

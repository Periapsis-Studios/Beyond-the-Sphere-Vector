...
proc `autorestartDelay=`*(self: AnimationNodeOneShot; val: float64) {.gcsafe,
    locks: 0.}
proc autorestartRandomDelay*(self: AnimationNodeOneShot): float64 {.gcsafe,
    locks: 0.}
...
proc `fadeoutTime=`*(self: AnimationNodeOneShot; val: float64) {.gcsafe,
    locks: 0.}
proc mixMode*(self: AnimationNodeOneShot): int64 {.gcsafe, locks: 0.}
proc `mixMode=`*(self: AnimationNodeOneShot; val: int64) {.gcsafe, locks: 0.}
...
proc mixMode(self: AnimationNodeOneShot): int64 =
...
proc `mixMode=`(self: AnimationNodeOneShot; val: int64) =

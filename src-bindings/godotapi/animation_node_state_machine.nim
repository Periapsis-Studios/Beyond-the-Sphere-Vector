...
proc addNode*(self: AnimationNodeStateMachine; name: string;
              node: AnimationNode; position: Vector2 = vec2(0.0, 0.0)) {.gcsafe,
    locks: 0.}
...
proc getGraphOffset*(self: AnimationNodeStateMachine): Vector2 {.gcsafe,
    locks: 0.}
...
proc getTransition*(self: AnimationNodeStateMachine; idx: int64): AnimationNodeStateMachineTransition {.
    gcsafe, locks: 0.}
proc getTransitionCount*(self: AnimationNodeStateMachine): int64 {.gcsafe,
    locks: 0.}
...
proc getTransitionTo*(self: AnimationNodeStateMachine; idx: int64): string {.
    gcsafe, locks: 0.}
proc hasNode*(self: AnimationNodeStateMachine; name: string): bool {.gcsafe,
    locks: 0.}
proc hasTransition*(self: AnimationNodeStateMachine; fromm: string; to: string): bool {.
    gcsafe, locks: 0.}
proc removeNode*(self: AnimationNodeStateMachine; name: string) {.gcsafe,
    locks: 0.}
proc removeTransition*(self: AnimationNodeStateMachine; fromm: string;
                       to: string) {.gcsafe, locks: 0.}
...
proc renameNode*(self: AnimationNodeStateMachine; name: string; newName: string) {.
    gcsafe, locks: 0.}
proc replaceNode*(self: AnimationNodeStateMachine; name: string;
                  node: AnimationNode) {.gcsafe, locks: 0.}
proc setEndNode*(self: AnimationNodeStateMachine; name: string) {.gcsafe,
    locks: 0.}
...
proc setStartNode*(self: AnimationNodeStateMachine; name: string) {.gcsafe,
    locks: 0.}

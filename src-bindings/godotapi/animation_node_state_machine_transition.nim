...
proc `advanceCondition=`*(self: AnimationNodeStateMachineTransition; val: string) {.
    gcsafe, locks: 0.}
proc autoAdvance*(self: AnimationNodeStateMachineTransition): bool {.gcsafe,
    locks: 0.}
proc `autoAdvance=`*(self: AnimationNodeStateMachineTransition; val: bool) {.
    gcsafe, locks: 0.}
proc disabled*(self: AnimationNodeStateMachineTransition): bool {.gcsafe,
    locks: 0.}
proc `disabled=`*(self: AnimationNodeStateMachineTransition; val: bool) {.
    gcsafe, locks: 0.}
proc priority*(self: AnimationNodeStateMachineTransition): int64 {.gcsafe,
    locks: 0.}
proc `priority=`*(self: AnimationNodeStateMachineTransition; val: int64) {.
    gcsafe, locks: 0.}
proc switchMode*(self: AnimationNodeStateMachineTransition): int64 {.gcsafe,
    locks: 0.}
...
proc `xfadeTime=`*(self: AnimationNodeStateMachineTransition; val: float64) {.
    gcsafe, locks: 0.}
var animationNodeStateMachineTransitionGetAdvanceConditionMethodBind
...
var animationNodeStateMachineTransitionSetAdvanceConditionMethodBind
    {.threadvar.}: ptr GodotMethodBind
proc `advanceCondition=`(self: AnimationNodeStateMachineTransition; val: string) =

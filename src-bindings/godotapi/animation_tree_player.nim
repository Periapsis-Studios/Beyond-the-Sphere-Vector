...
proc `masterPlayer=`*(self: AnimationTreePlayer; val: NodePath) {.gcsafe,
    locks: 0.}
proc playbackProcessMode*(self: AnimationTreePlayer): int64 {.gcsafe, locks: 0.}
proc `playbackProcessMode=`*(self: AnimationTreePlayer; val: int64) {.gcsafe,
    locks: 0.}
proc addNode*(self: AnimationTreePlayer; typee: int64; id: string) {.gcsafe,
    locks: 0.}
...
proc animationNodeSetFilterPath*(self: AnimationTreePlayer; id: string;
                                 path: NodePath; enable: bool) {.gcsafe,
    locks: 0.}
...
proc blend2NodeSetAmount*(self: AnimationTreePlayer; id: string; blend: float64) {.
    gcsafe, locks: 0.}
proc blend2NodeSetFilterPath*(self: AnimationTreePlayer; id: string;
...
proc mixNodeSetAmount*(self: AnimationTreePlayer; id: string; ratio: float64) {.
    gcsafe, locks: 0.}
proc nodeExists*(self: AnimationTreePlayer; node: string): bool {.gcsafe,
    locks: 0.}
...
proc nodeGetPosition*(self: AnimationTreePlayer; id: string): Vector2 {.gcsafe,
    locks: 0.}
proc nodeGetType*(self: AnimationTreePlayer; id: string): int64 {.gcsafe,
    locks: 0.}
proc nodeRename*(self: AnimationTreePlayer; node: string; newName: string): Error {.
    gcsafe, locks: 0.}
proc nodeSetPosition*(self: AnimationTreePlayer; id: string;
                      screenPosition: Vector2) {.gcsafe, locks: 0.}
...
proc oneshotNodeIsActive*(self: AnimationTreePlayer; id: string): bool {.gcsafe,
    locks: 0.}
proc oneshotNodeSetAutorestart*(self: AnimationTreePlayer; id: string;
...
proc oneshotNodeSetAutorestartRandomDelay*(self: AnimationTreePlayer;
    id: string; randSec: float64) {.gcsafe, locks: 0.}
...
proc oneshotNodeSetFadeoutTime*(self: AnimationTreePlayer; id: string;
                                timeSec: float64) {.gcsafe, locks: 0.}
proc oneshotNodeSetFilterPath*(self: AnimationTreePlayer; id: string;
                               path: NodePath; enable: bool) {.gcsafe, locks: 0.}
...
proc timescaleNodeGetScale*(self: AnimationTreePlayer; id: string): float64 {.
    gcsafe, locks: 0.}
proc timescaleNodeSetScale*(self: AnimationTreePlayer; id: string;
                            scale: float64) {.gcsafe, locks: 0.}
...
proc transitionNodeHasInputAutoAdvance*(self: AnimationTreePlayer; id: string;
                                        inputIdx: int64): bool {.gcsafe,
    locks: 0.}
proc transitionNodeSetCurrent*(self: AnimationTreePlayer; id: string;
                               inputIdx: int64) {.gcsafe, locks: 0.}
proc transitionNodeSetInputAutoAdvance*(self: AnimationTreePlayer; id: string;
                                        inputIdx: int64; enable: bool) {.gcsafe,
    locks: 0.}
proc transitionNodeSetInputCount*(self: AnimationTreePlayer; id: string;
                                  count: int64) {.gcsafe, locks: 0.}
...
proc active(self: AnimationTreePlayer): bool =
  ...
  animationTreePlayerIsActiveMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc reset(self: AnimationTreePlayer) =
  if isNil(animationTreePlayerResetMethodBind):
    animationTreePlayerResetMethodBind = getMethod(
        cstring"AnimationTreePlayer", cstring"reset")
  var ptrCallRet: pointer

...
method areaInout*(self: Area2D; arg0: int64; arg1: RID; arg2: int64;
                  arg3: int64; arg4: int64) {.gcsafe, locks: 0, base.}
...
method bodyInout*(self: Area2D; arg0: int64; arg1: RID; arg2: int64;
                  arg3: int64; arg4: int64) {.gcsafe, locks: 0, base.}
...
proc gravity(self: Area2D): float64 =
  if isNil(area2DGetGravityMethodBind):
    area2DGetGravityMethodBind = getMethod(cstring"Area2D",
        cstring"get_gravity")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
...
proc `gravity=`(self: Area2D; val: float64) =
  if isNil(area2DSetGravityMethodBind):
    area2DSetGravityMethodBind = getMethod(cstring"Area2D",
        cstring"set_gravity")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc priority(self: Area2D): float64 =
  if isNil(area2DGetPriorityMethodBind):
    area2DGetPriorityMethodBind = getMethod(cstring"Area2D",
        cstring"get_priority")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
...
proc `priority=`(self: Area2D; val: float64) =
  if isNil(area2DSetPriorityMethodBind):
    area2DSetPriorityMethodBind = getMethod(cstring"Area2D",
        cstring"set_priority")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)

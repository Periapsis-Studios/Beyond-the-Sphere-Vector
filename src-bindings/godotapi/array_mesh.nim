...
proc addSurfaceFromArrays*(self: ArrayMesh; primitive: int64; arrays: Array;
                           ...
                           compressFlags: int64 = 2194432'i64) {.gcsafe,
    locks: 0.}
proc clearBlendShapes*(self: ArrayMesh) {.gcsafe, locks: 0.}
proc clearSurfaces*(self: ArrayMesh) {.gcsafe, locks: 0.}
proc getBlendShapeCount*(self: ArrayMesh): int64 {.gcsafe, locks: 0.}
proc getBlendShapeName*(self: ArrayMesh; index: int64): string {.gcsafe,
    locks: 0.}
...
proc setBlendShapeName*(self: ArrayMesh; index: int64; name: string) {.gcsafe,
    locks: 0.}
...
proc surfaceGetArrayIndexLen*(self: ArrayMesh; surfIdx: int64): int64 {.gcsafe,
    locks: 0.}
proc surfaceGetArrayLen*(self: ArrayMesh; surfIdx: int64): int64 {.gcsafe,
    locks: 0.}
proc surfaceGetFormat*(self: ArrayMesh; surfIdx: int64): int64 {.gcsafe,
    locks: 0.}
...
proc surfaceSetName*(self: ArrayMesh; surfIdx: int64; name: string) {.gcsafe,
    locks: 0.}
...
proc addSurfaceFromArrays(self: ArrayMesh; primitive: int64; arrays: Array;
                          blendShapes: Array = newArray();
                          compressFlags: int64 = 2194432'i64) =
...
var arrayMeshClearSurfacesMethodBind {.threadvar.}: ptr GodotMethodBind
proc clearSurfaces(self: ArrayMesh) =
  if isNil(arrayMeshClearSurfacesMethodBind):
    arrayMeshClearSurfacesMethodBind = getMethod(cstring"ArrayMesh",
        cstring"clear_surfaces")
  var ptrCallRet: pointer
  arrayMeshClearSurfacesMethodBind.ptrCall(self.godotObject, nil, ptrCallRet)
...
proc getBlendShapeCount(self: ArrayMesh): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  arrayMeshGetBlendShapeCountMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
var arrayMeshSetBlendShapeNameMethodBind {.threadvar.}: ptr GodotMethodBind
proc setBlendShapeName(self: ArrayMesh; index: int64; name: string) =
  if isNil(arrayMeshSetBlendShapeNameMethodBind):
    arrayMeshSetBlendShapeNameMethodBind = getMethod(cstring"ArrayMesh",
        cstring"set_blend_shape_name")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(index)
  ...
  var ptrCallRet: pointer
  arrayMeshSetBlendShapeNameMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

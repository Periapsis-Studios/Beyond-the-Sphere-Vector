...
method setJoyId*(self: ARVRPositionalTracker; joyId: int64) {.gcsafe, locks: 0,
    base.}
method setMesh*(self: ARVRPositionalTracker; mesh: Mesh) {.gcsafe, locks: 0,
    base.}
method setName*(self: ARVRPositionalTracker; name: string) {.gcsafe, locks: 0,
    base.}
...
method setRwPosition*(self: ARVRPositionalTracker; rwPosition: Vector3) {.
    gcsafe, locks: 0, base.}
method setType*(self: ARVRPositionalTracker; typee: int64) {.gcsafe, locks: 0,
    base.}
...
proc getHand(self: ARVRPositionalTracker): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  aRVRPositionalTrackerGetHandMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc getMesh(self: ARVRPositionalTracker): Mesh =
  ...
  aRVRPositionalTrackerGetMeshMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc getName(self: ARVRPositionalTracker): string =
  ...
  ptrCallRet = addr(ptrCallVal)
  aRVRPositionalTrackerGetNameMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
  result = $ptrCallVal
  deinit(ptrCallVal)
...
proc getTracksPosition(self: ARVRPositionalTracker): bool =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  aRVRPositionalTrackerGetTracksPositionMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
proc getType(self: ARVRPositionalTracker): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  aRVRPositionalTrackerGetTypeMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

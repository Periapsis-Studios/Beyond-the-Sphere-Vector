...
proc `voice1cutoffHz=`*(self: AudioEffectChorus; val: float64) {.gcsafe,
    locks: 0.}
...
proc `voice2cutoffHz=`*(self: AudioEffectChorus; val: float64) {.gcsafe,
    locks: 0.}
...
proc `voice3cutoffHz=`*(self: AudioEffectChorus; val: float64) {.gcsafe,
    locks: 0.}
...
proc `voice4cutoffHz=`*(self: AudioEffectChorus; val: float64) {.gcsafe,
    locks: 0.}

...
proc `data=`(self: AudioStreamSample; val: PoolByteArray) =
  ...
  var ptrCallRet: pointer
  audioStreamSampleSetDataMethodBind.ptrCall(self.godotObject,
...
proc format(self: AudioStreamSample): int64 =
  if isNil(audioStreamSampleGetFormatMethodBind):
    audioStreamSampleGetFormatMethodBind = getMethod(
        cstring"AudioStreamSample", cstring"get_format")
  var ptrCallRet: pointer
...
proc `format=`(self: AudioStreamSample; val: int64) =
  if isNil(audioStreamSampleSetFormatMethodBind):
    audioStreamSampleSetFormatMethodBind = getMethod(
        cstring"AudioStreamSample", cstring"set_format")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc loopEnd(self: AudioStreamSample): int64 =
  if isNil(audioStreamSampleGetLoopEndMethodBind):
    audioStreamSampleGetLoopEndMethodBind = getMethod(
        cstring"AudioStreamSample", cstring"get_loop_end")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  audioStreamSampleGetLoopEndMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `loopEnd=`(self: AudioStreamSample; val: int64) =
  if isNil(audioStreamSampleSetLoopEndMethodBind):
    audioStreamSampleSetLoopEndMethodBind = getMethod(
        cstring"AudioStreamSample", cstring"set_loop_end")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc loopMode(self: AudioStreamSample): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  audioStreamSampleGetLoopModeMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc mixRate(self: AudioStreamSample): int64 =
  if isNil(audioStreamSampleGetMixRateMethodBind):
    audioStreamSampleGetMixRateMethodBind = getMethod(
        cstring"AudioStreamSample", cstring"get_mix_rate")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  audioStreamSampleGetMixRateMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `mixRate=`(self: AudioStreamSample; val: int64) =
  if isNil(audioStreamSampleSetMixRateMethodBind):
    audioStreamSampleSetMixRateMethodBind = getMethod(
        cstring"AudioStreamSample", cstring"set_mix_rate")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc `stereo=`(self: AudioStreamSample; val: bool) =
  if isNil(audioStreamSampleSetStereoMethodBind):
    audioStreamSampleSetStereoMethodBind = getMethod(
        cstring"AudioStreamSample", cstring"set_stereo")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc saveToWav(self: AudioStreamSample; path: string): Error =
  if isNil(audioStreamSampleSaveToWavMethodBind):
    audioStreamSampleSaveToWavMethodBind = getMethod(
        cstring"AudioStreamSample", cstring"save_to_wav")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)

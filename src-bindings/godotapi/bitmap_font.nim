...
proc addChar*(self: BitmapFont; character: int64; texture: int64; rect: Rect2;
    ...
    gcsafe, locks: 0.}
proc addKerningPair*(self: BitmapFont; charA: int64; charB: int64;
                     kerning: int64) {.gcsafe, locks: 0.}
...
proc chars(self: BitmapFont): PoolIntArray =
  ...
  bitmapFontUnderscoregetCharsMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc addChar(self: BitmapFont; character: int64; texture: int64; rect: Rect2;
  ...
  if isNil(bitmapFontAddCharMethodBind):
    bitmapFontAddCharMethodBind = getMethod(cstring"BitmapFont",
        cstring"add_char")
  var
...
proc addKerningPair(self: BitmapFont; charA: int64; charB: int64; kerning: int64) =
  ...
  var ptrCallRet: pointer
  bitmapFontAddKerningPairMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc getKerningPair(self: BitmapFont; charA: int64; charB: int64): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  bitmapFontGetKerningPairMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

...
method allocateTexture*(self: CameraFeed; width: int64; height: int64;
                        format: int64; textureType: int64; dataType: int64) {.
    gcsafe, locks: 0, base.}
...
method setYCbCrImgs*(self: CameraFeed; yImg: Image; cbcrImg: Image) {.gcsafe,
    locks: 0, base.}
...
proc getName(self: CameraFeed): string =
  if isNil(cameraFeedGetNameMethodBind):
    cameraFeedGetNameMethodBind = getMethod(cstring"CameraFeed",
        cstring"get_name")
  var ptrCallRet: pointer

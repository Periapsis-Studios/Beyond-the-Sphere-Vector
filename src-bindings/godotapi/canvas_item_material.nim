...
proc `particlesAnimHFrames=`*(self: CanvasItemMaterial; val: int64) {.gcsafe,
    locks: 0.}
proc particlesAnimLoop*(self: CanvasItemMaterial): bool {.gcsafe, locks: 0.}
proc `particlesAnimLoop=`*(self: CanvasItemMaterial; val: bool) {.gcsafe,
    locks: 0.}
proc particlesAnimVFrames*(self: CanvasItemMaterial): int64 {.gcsafe, locks: 0.}
proc `particlesAnimVFrames=`*(self: CanvasItemMaterial; val: int64) {.gcsafe,
    locks: 0.}
proc particlesAnimation*(self: CanvasItemMaterial): bool {.gcsafe, locks: 0.}
proc `particlesAnimation=`*(self: CanvasItemMaterial; val: bool) {.gcsafe,
    locks: 0.}
...
proc particlesAnimLoop(self: CanvasItemMaterial): bool =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  canvasItemMaterialGetParticlesAnimLoopMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)

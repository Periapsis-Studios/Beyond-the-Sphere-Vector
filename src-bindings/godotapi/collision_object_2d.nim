...
proc collisionLayer*(self: CollisionObject2D): int64 {.gcsafe, locks: 0.}
proc `collisionLayer=`*(self: CollisionObject2D; val: int64) {.gcsafe, locks: 0.}
proc collisionMask*(self: CollisionObject2D): int64 {.gcsafe, locks: 0.}
proc `collisionMask=`*(self: CollisionObject2D; val: int64) {.gcsafe, locks: 0.}
...
proc createShapeOwner*(self: CollisionObject2D; owner: Object): int64 {.gcsafe,
    locks: 0.}
proc getCollisionLayerBit*(self: CollisionObject2D; bit: int64): bool {.gcsafe,
    locks: 0.}
proc getCollisionMaskBit*(self: CollisionObject2D; bit: int64): bool {.gcsafe,
    locks: 0.}
...
proc isShapeOwnerOneWayCollisionEnabled*(self: CollisionObject2D; ownerId: int64): bool {.
    gcsafe, locks: 0.}
proc removeShapeOwner*(self: CollisionObject2D; ownerId: int64) {.gcsafe,
    locks: 0.}
proc setCollisionLayerBit*(self: CollisionObject2D; bit: int64; value: bool) {.
    gcsafe, locks: 0.}
proc setCollisionMaskBit*(self: CollisionObject2D; bit: int64; value: bool) {.
    gcsafe, locks: 0.}
...
proc shapeOwnerGetShapeCount*(self: CollisionObject2D; ownerId: int64): int64 {.
    gcsafe, locks: 0.}
proc shapeOwnerGetShapeIndex*(self: CollisionObject2D; ownerId: int64;
                              shapeId: int64): int64 {.gcsafe, locks: 0.}
proc shapeOwnerGetTransform*(self: CollisionObject2D; ownerId: int64): Transform2D {.
    gcsafe, locks: 0.}
proc shapeOwnerRemoveShape*(self: CollisionObject2D; ownerId: int64;
                            shapeId: int64) {.gcsafe, locks: 0.}
proc shapeOwnerSetDisabled*(self: CollisionObject2D; ownerId: int64;
...
proc shapeOwnerSetOneWayCollisionMargin*(self: CollisionObject2D;
    ownerId: int64; margin: float64) {.gcsafe, locks: 0.}
proc shapeOwnerSetTransform*(self: CollisionObject2D; ownerId: int64;
                             transform: Transform2D) {.gcsafe, locks: 0.}
var collisionObject2DGetCollisionLayerMethodBind {.threadvar.}: ptr GodotMethodBind
proc collisionLayer(self: CollisionObject2D): int64 =
  if isNil(collisionObject2DGetCollisionLayerMethodBind):
    collisionObject2DGetCollisionLayerMethodBind = getMethod(
        cstring"CollisionObject2D", cstring"get_collision_layer")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  collisionObject2DGetCollisionLayerMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

var collisionObject2DSetCollisionLayerMethodBind {.threadvar.}: ptr GodotMethodBind
proc `collisionLayer=`(self: CollisionObject2D; val: int64) =
  if isNil(collisionObject2DSetCollisionLayerMethodBind):
    collisionObject2DSetCollisionLayerMethodBind = getMethod(
        cstring"CollisionObject2D", cstring"set_collision_layer")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  collisionObject2DSetCollisionLayerMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

var collisionObject2DGetCollisionMaskMethodBind {.threadvar.}: ptr GodotMethodBind
proc collisionMask(self: CollisionObject2D): int64 =
  if isNil(collisionObject2DGetCollisionMaskMethodBind):
    collisionObject2DGetCollisionMaskMethodBind = getMethod(
        cstring"CollisionObject2D", cstring"get_collision_mask")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  collisionObject2DGetCollisionMaskMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

var collisionObject2DSetCollisionMaskMethodBind {.threadvar.}: ptr GodotMethodBind
proc `collisionMask=`(self: CollisionObject2D; val: int64) =
  if isNil(collisionObject2DSetCollisionMaskMethodBind):
    collisionObject2DSetCollisionMaskMethodBind = getMethod(
        cstring"CollisionObject2D", cstring"set_collision_mask")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  collisionObject2DSetCollisionMaskMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc inputPickable(self: CollisionObject2D): bool =
  if isNil(collisionObject2DIsPickableMethodBind):
    collisionObject2DIsPickableMethodBind = getMethod(
        cstring"CollisionObject2D", cstring"is_pickable")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  collisionObject2DIsPickableMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
var collisionObject2DGetCollisionLayerBitMethodBind {.threadvar.}: ptr GodotMethodBind
proc getCollisionLayerBit(self: CollisionObject2D; bit: int64): bool =
  if isNil(collisionObject2DGetCollisionLayerBitMethodBind):
    collisionObject2DGetCollisionLayerBitMethodBind = getMethod(
        cstring"CollisionObject2D", cstring"get_collision_layer_bit")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  collisionObject2DGetCollisionLayerBitMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

var collisionObject2DGetCollisionMaskBitMethodBind {.threadvar.}: ptr GodotMethodBind
proc getCollisionMaskBit(self: CollisionObject2D; bit: int64): bool =
  if isNil(collisionObject2DGetCollisionMaskBitMethodBind):
    collisionObject2DGetCollisionMaskBitMethodBind = getMethod(
        cstring"CollisionObject2D", cstring"get_collision_mask_bit")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(bit)
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  collisionObject2DGetCollisionMaskBitMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
var collisionObject2DSetCollisionLayerBitMethodBind {.threadvar.}: ptr GodotMethodBind
proc setCollisionLayerBit(self: CollisionObject2D; bit: int64; value: bool) =
  if isNil(collisionObject2DSetCollisionLayerBitMethodBind):
    collisionObject2DSetCollisionLayerBitMethodBind = getMethod(
        cstring"CollisionObject2D", cstring"set_collision_layer_bit")
  var
  ...
  var ptrCallRet: pointer
  collisionObject2DSetCollisionLayerBitMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

var collisionObject2DSetCollisionMaskBitMethodBind {.threadvar.}: ptr GodotMethodBind
proc setCollisionMaskBit(self: CollisionObject2D; bit: int64; value: bool) =
  if isNil(collisionObject2DSetCollisionMaskBitMethodBind):
    collisionObject2DSetCollisionMaskBitMethodBind = getMethod(
        cstring"CollisionObject2D", cstring"set_collision_mask_bit")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(bit)
  argsToPassToGodot[][1] = unsafeAddr(value)
  var ptrCallRet: pointer
  collisionObject2DSetCollisionMaskBitMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

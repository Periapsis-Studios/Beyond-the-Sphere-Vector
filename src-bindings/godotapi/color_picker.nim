...
method hsvDraw*(self: ColorPicker; arg0: int64; arg1: Control) {.gcsafe,
    locks: 0, base.}
...
method presetInput*(self: ColorPicker; arg0: InputEvent) {.gcsafe, locks: 0,
    base.}
method sampleDraw*(self: ColorPicker) {.gcsafe, locks: 0, base.}
method sampleInput*(self: ColorPicker; arg0: InputEvent) {.gcsafe, locks: 0,
    base.}
method screenInput*(self: ColorPicker; arg0: InputEvent) {.gcsafe, locks: 0,
    base.}
...
proc presetsEnabled(self: ColorPicker): bool =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  colorPickerArePresetsEnabledMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc presetsVisible(self: ColorPicker): bool =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  colorPickerArePresetsVisibleMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
method htmlEntered(self: ColorPicker; arg0: string) =
  if isNil(colorPickerUnderscorehtmlEnteredMethodBind):
    colorPickerUnderscorehtmlEnteredMethodBind = getMethod(
        cstring"ColorPicker", cstring"_html_entered")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
method presetInput(self: ColorPicker; arg0: InputEvent) =
  if isNil(colorPickerUnderscorepresetInputMethodBind):
    colorPickerUnderscorepresetInputMethodBind = getMethod(
        cstring"ColorPicker", cstring"_preset_input")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
var colorPickerUnderscoresampleInputMethodBind {.threadvar.}: ptr GodotMethodBind
method sampleInput(self: ColorPicker; arg0: InputEvent) =
  if isNil(colorPickerUnderscoresampleInputMethodBind):
    colorPickerUnderscoresampleInputMethodBind = getMethod(
        cstring"ColorPicker", cstring"_sample_input")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  let argToPassToGodot0 = if not arg0.isNil:
  ...
  argsToPassToGodot[][0] = argToPassToGodot0
  var ptrCallRet: pointer
  colorPickerUnderscoresampleInputMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
method screenInput(self: ColorPicker; arg0: InputEvent) =
  if isNil(colorPickerUnderscorescreenInputMethodBind):
    colorPickerUnderscorescreenInputMethodBind = getMethod(
        cstring"ColorPicker", cstring"_screen_input")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  let argToPassToGodot0 = if not arg0.isNil:
...
method screenPickPressed(self: ColorPicker) =
  ...
  var ptrCallRet: pointer
  colorPickerUnderscorescreenPickPressedMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
method valueChanged(self: ColorPicker; arg0: float64) =
  if isNil(colorPickerUnderscorevalueChangedMethodBind):
    colorPickerUnderscorevalueChangedMethodBind = getMethod(
        cstring"ColorPicker", cstring"_value_changed")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(arg0)

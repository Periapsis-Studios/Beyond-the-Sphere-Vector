...
method aboutToShow*(self: ColorPickerButton) {.gcsafe, locks: 0, base.}
method colorChanged*(self: ColorPickerButton; arg0: Color) {.gcsafe, locks: 0,
    base.}
...
var colorPickerButtonUnderscoreaboutToShowMethodBind {.threadvar.}: ptr GodotMethodBind
method aboutToShow(self: ColorPickerButton) =
  if isNil(colorPickerButtonUnderscoreaboutToShowMethodBind):
    colorPickerButtonUnderscoreaboutToShowMethodBind = getMethod(
        cstring"ColorPickerButton", cstring"_about_to_show")
  var ptrCallRet: pointer
  colorPickerButtonUnderscoreaboutToShowMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
method modalClosed(self: ColorPickerButton) =
  ...
  var ptrCallRet: pointer
  colorPickerButtonUnderscoremodalClosedMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
proc getPicker(self: ColorPickerButton): ColorPicker =
  if isNil(colorPickerButtonGetPickerMethodBind):
    colorPickerButtonGetPickerMethodBind = getMethod(
        cstring"ColorPickerButton", cstring"get_picker")
  var ptrCallRet: pointer

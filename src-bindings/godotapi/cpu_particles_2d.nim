...
proc `angularVelocityCurve=`*(self: CPUParticles2D; val: Curve) {.gcsafe,
    locks: 0.}
proc angularVelocityRandom*(self: CPUParticles2D): float64 {.gcsafe, locks: 0.}
proc `angularVelocityRandom=`*(self: CPUParticles2D; val: float64) {.gcsafe,
    locks: 0.}
...
proc `emissionColors=`*(self: CPUParticles2D; val: PoolColorArray) {.gcsafe,
    locks: 0.}
...
proc `emissionRectExtents=`*(self: CPUParticles2D; val: Vector2) {.gcsafe,
    locks: 0.}
...
proc `emissionSphereRadius=`*(self: CPUParticles2D; val: float64) {.gcsafe,
    locks: 0.}
...
proc `hueVariationRandom=`*(self: CPUParticles2D; val: float64) {.gcsafe,
    locks: 0.}
...
proc `initialVelocityRandom=`*(self: CPUParticles2D; val: float64) {.gcsafe,
    locks: 0.}
...
proc `lifetimeRandomness=`*(self: CPUParticles2D; val: float64) {.gcsafe,
    locks: 0.}
...
proc `linearAccelRandom=`*(self: CPUParticles2D; val: float64) {.gcsafe,
    locks: 0.}
...
proc `orbitVelocityRandom=`*(self: CPUParticles2D; val: float64) {.gcsafe,
    locks: 0.}
...
proc `radialAccelRandom=`*(self: CPUParticles2D; val: float64) {.gcsafe,
    locks: 0.}
...
proc `scaleAmountRandom=`*(self: CPUParticles2D; val: float64) {.gcsafe,
    locks: 0.}
...
proc `tangentialAccelCurve=`*(self: CPUParticles2D; val: Curve) {.gcsafe,
    locks: 0.}
proc tangentialAccelRandom*(self: CPUParticles2D): float64 {.gcsafe, locks: 0.}
proc `tangentialAccelRandom=`*(self: CPUParticles2D; val: float64) {.gcsafe,
    locks: 0.}
...
proc convertFromParticles*(self: CPUParticles2D; particles: Node) {.gcsafe,
    locks: 0.}
...
proc emissionShape(self: CPUParticles2D): int64 =
  if isNil(cPUParticles2DGetEmissionShapeMethodBind):
    cPUParticles2DGetEmissionShapeMethodBind = getMethod(
        cstring"CPUParticles2D", cstring"get_emission_shape")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
...
proc `emissionShape=`(self: CPUParticles2D; val: int64) =
  if isNil(cPUParticles2DSetEmissionShapeMethodBind):
    cPUParticles2DSetEmissionShapeMethodBind = getMethod(
        cstring"CPUParticles2D", cstring"set_emission_shape")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc flagAlignY(self: CPUParticles2D): bool =
  if isNil(cPUParticles2DGetParticleFlagMethodBind):
    cPUParticles2DGetParticleFlagMethodBind = getMethod(
        cstring"CPUParticles2D", cstring"get_particle_flag")
  var
...
proc `flagAlignY=`(self: CPUParticles2D; val: bool) =
  if isNil(cPUParticles2DSetParticleFlagMethodBind):
    cPUParticles2DSetParticleFlagMethodBind = getMethod(
        cstring"CPUParticles2D", cstring"set_particle_flag")
  var
    godotBoundArg0 = 0'i64
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc `gravity=`(self: CPUParticles2D; val: Vector2) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  cPUParticles2DSetGravityMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc `oneShot=`(self: CPUParticles2D; val: bool) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  cPUParticles2DSetOneShotMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc speedScale(self: CPUParticles2D): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  cPUParticles2DGetSpeedScaleMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `texture=`(self: CPUParticles2D; val: Texture) =
  ...
  argsToPassToGodot[][0] = argToPassToGodot0
  var ptrCallRet: pointer
  cPUParticles2DSetTextureMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
method textureChanged(self: CPUParticles2D) =
  ...
  var ptrCallRet: pointer
  cPUParticles2DUnderscoretextureChangedMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)

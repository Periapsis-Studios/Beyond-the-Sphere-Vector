...
proc `directionalShadowBiasSplitScale=`*(self: DirectionalLight; val: float64) {.
    gcsafe, locks: 0.}
proc directionalShadowBlendSplits*(self: DirectionalLight): bool {.gcsafe,
    locks: 0.}
proc `directionalShadowBlendSplits=`*(self: DirectionalLight; val: bool) {.
    gcsafe, locks: 0.}
proc directionalShadowDepthRange*(self: DirectionalLight): int64 {.gcsafe,
    locks: 0.}
...
proc `directionalShadowMode=`*(self: DirectionalLight; val: int64) {.gcsafe,
    locks: 0.}
proc directionalShadowNormalBias*(self: DirectionalLight): float64 {.gcsafe,
    locks: 0.}
proc `directionalShadowNormalBias=`*(self: DirectionalLight; val: float64) {.
    gcsafe, locks: 0.}
proc directionalShadowSplit1*(self: DirectionalLight): float64 {.gcsafe,
    locks: 0.}
proc `directionalShadowSplit1=`*(self: DirectionalLight; val: float64) {.gcsafe,
    locks: 0.}
proc directionalShadowSplit2*(self: DirectionalLight): float64 {.gcsafe,
    locks: 0.}
proc `directionalShadowSplit2=`*(self: DirectionalLight; val: float64) {.gcsafe,
    locks: 0.}
proc directionalShadowSplit3*(self: DirectionalLight): float64 {.gcsafe,
    locks: 0.}
...
proc directionalShadowBiasSplitScale(self: DirectionalLight): float64 =
  ...
  directionalLightGetParamMethodBind.ptrCall(self.godotObject,
...
proc `directionalShadowBiasSplitScale=`(self: DirectionalLight; val: float64) =
  ...
  var ptrCallRet: pointer
  directionalLightSetParamMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

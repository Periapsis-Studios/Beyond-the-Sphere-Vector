...
const
  ...
  FEATURE_FILESYSTEM_DOCK* = 5'i64
  FEATURE_IMPORT_DOCK* = 6'i64
  FEATURE_MAX* = 7'i64
  FEATURE_NODE_DOCK* = 4'i64
...
proc isFeatureDisabled*(self: EditorFeatureProfile; feature: int64): bool {.
    gcsafe, locks: 0.}
proc loadFromFile*(self: EditorFeatureProfile; path: string): Error {.gcsafe,
    locks: 0.}
proc saveToFile*(self: EditorFeatureProfile; path: string): Error {.gcsafe,
    locks: 0.}
proc setDisableClass*(self: EditorFeatureProfile; className: string;
...
proc setDisableClassProperty*(self: EditorFeatureProfile; className: string;
                              property: string; disable: bool) {.gcsafe,
    locks: 0.}
proc setDisableFeature*(self: EditorFeatureProfile; feature: int64;
                        disable: bool) {.gcsafe, locks: 0.}

...
proc `disableOverwriteWarning=`*(self: EditorFileDialog; val: bool) {.gcsafe,
    locks: 0.}
...
method dirEntered*(self: EditorFileDialog; arg0: string) {.gcsafe, locks: 0,
    base.}
...
method favoriteSelected*(self: EditorFileDialog; arg0: int64) {.gcsafe,
    locks: 0, base.}
method fileEntered*(self: EditorFileDialog; arg0: string) {.gcsafe, locks: 0,
    base.}
method filterSelected*(self: EditorFileDialog; arg0: int64) {.gcsafe, locks: 0,
    base.}
...
method itemDbSelected*(self: EditorFileDialog; arg0: int64) {.gcsafe, locks: 0,
    base.}
method itemListItemRmbSelected*(self: EditorFileDialog; arg0: int64;
                                arg1: Vector2) {.gcsafe, locks: 0, base.}
method itemListRmbClicked*(self: EditorFileDialog; arg0: Vector2) {.gcsafe,
    locks: 0, base.}
method itemMenuIdPressed*(self: EditorFileDialog; arg0: int64) {.gcsafe,
    locks: 0, base.}
method itemSelected*(self: EditorFileDialog; arg0: int64) {.gcsafe, locks: 0,
    base.}
...
method multiSelected*(self: EditorFileDialog; arg0: int64; arg1: bool) {.gcsafe,
    locks: 0, base.}
method recentSelected*(self: EditorFileDialog; arg0: int64) {.gcsafe, locks: 0,
    base.}
method saveConfirmPressed*(self: EditorFileDialog) {.gcsafe, locks: 0, base.}
method selectDrive*(self: EditorFileDialog; arg0: int64) {.gcsafe, locks: 0,
    base.}
...
method thumbnailResult*(self: EditorFileDialog; arg0: string; arg1: Texture;
                        arg2: Texture; arg3: Variant) {.gcsafe, locks: 0, base.}
method unhandledInput*(self: EditorFileDialog; event: InputEvent) {.gcsafe,
    locks: 0.}
...
proc clearFilters(self: EditorFileDialog) =
  if isNil(editorFileDialogClearFiltersMethodBind):
    editorFileDialogClearFiltersMethodBind = getMethod(
        cstring"EditorFileDialog", cstring"clear_filters")
  var ptrCallRet: pointer
  editorFileDialogClearFiltersMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

...
method filterChanged*(self: EditorInspector; arg0: string) {.gcsafe, locks: 0,
    base.}
...
method propertyChanged*(self: EditorInspector; arg0: string; arg1: Variant;
                        arg2: string = ""; arg3: bool = false) {.gcsafe,
    locks: 0, base.}
method propertyChangedUpdateAll*(self: EditorInspector; arg0: string;
                                 arg1: Variant; arg2: string; arg3: bool) {.
    gcsafe, locks: 0, base.}
...
method propertyKeyed*(self: EditorInspector; arg0: string; arg1: bool) {.gcsafe,
    locks: 0, base.}
method propertyKeyedWithValue*(self: EditorInspector; arg0: string;
                               arg1: Variant; arg2: bool) {.gcsafe, locks: 0,
    base.}
...
method resourceSelected*(self: EditorInspector; arg0: string; arg1: Resource) {.
    gcsafe, locks: 0, base.}
method vscrollChanged*(self: EditorInspector; arg0: float64) {.gcsafe, locks: 0,
    base.}

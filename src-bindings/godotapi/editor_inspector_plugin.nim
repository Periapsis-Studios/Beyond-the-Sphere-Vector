...
proc addPropertyEditorForMultipleProperties*(self: EditorInspectorPlugin;
    label: string; properties: PoolStringArray; editor: Control) {.gcsafe,
    locks: 0.}
method canHandle*(self: EditorInspectorPlugin; objectt: Object): bool {.gcsafe,
    locks: 0, base.}
method parseBegin*(self: EditorInspectorPlugin; objectt: Object) {.gcsafe,
    locks: 0, base.}
method parseCategory*(self: EditorInspectorPlugin; objectt: Object;
                      category: string) {.gcsafe, locks: 0, base.}
method parseEnd*(self: EditorInspectorPlugin) {.gcsafe, locks: 0, base.}
method parseProperty*(self: EditorInspectorPlugin; objectt: Object;
                      typee: int64; path: string; hint: int64; hintText: string;
                      usage: int64): bool {.gcsafe, locks: 0, base.}

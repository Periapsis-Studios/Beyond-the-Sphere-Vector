...
method canBeHidden*(self: EditorSpatialGizmoPlugin): bool {.gcsafe, locks: 0,
    base.}
method commitHandle*(self: EditorSpatialGizmoPlugin; gizmo: EditorSpatialGizmo;
                     index: int64; restore: Variant; cancel: bool) {.gcsafe,
    locks: 0, base.}
...
method getHandleValue*(self: EditorSpatialGizmoPlugin;
                       gizmo: EditorSpatialGizmo; index: int64): Variant {.
    gcsafe, locks: 0, base.}
proc getMaterial*(self: EditorSpatialGizmoPlugin; name: string;
                  gizmo: EditorSpatialGizmo = nil): SpatialMaterial {.gcsafe,
    locks: 0.}
method getName*(self: EditorSpatialGizmoPlugin): string {.gcsafe, locks: 0, base.}
method getPriority*(self: EditorSpatialGizmoPlugin): int64 {.gcsafe, locks: 0,
    base.}
...
method setHandle*(self: EditorSpatialGizmoPlugin; gizmo: EditorSpatialGizmo;
                  index: int64; camera: Camera; point: Vector2) {.gcsafe,
    locks: 0, base.}
...
proc getMaterial(self: EditorSpatialGizmoPlugin; name: string;
                 gizmo: EditorSpatialGizmo = nil): SpatialMaterial =
...
method getPriority(self: EditorSpatialGizmoPlugin): int64 =

...
method grabberGuiInput*(self: EditorSpinSlider; arg0: InputEvent) {.gcsafe,
    locks: 0, base.}
...
method valueInputEntered*(self: EditorSpinSlider; arg0: string) {.gcsafe,
    locks: 0, base.}
method valueInputGuiInput*(self: EditorSpinSlider; event: InputEvent) {.gcsafe,
    locks: 0, base.}
...
proc `label=`(self: EditorSpinSlider; val: string) =
  ...
  var ptrCallRet: pointer
  editorSpinSliderSetLabelMethodBind.ptrCall(self.godotObject,
...
proc `readOnly=`(self: EditorSpinSlider; val: bool) =
  if isNil(editorSpinSliderSetReadOnlyMethodBind):
    editorSpinSliderSetReadOnlyMethodBind = getMethod(
        cstring"EditorSpinSlider", cstring"set_read_only")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
var editorSpinSliderUnderscorevalueInputGuiInputMethodBind {.threadvar.}: ptr GodotMethodBind
method valueInputGuiInput(self: EditorSpinSlider; event: InputEvent) =
  if isNil(editorSpinSliderUnderscorevalueInputGuiInputMethodBind):
    editorSpinSliderUnderscorevalueInputGuiInputMethodBind = getMethod(
        cstring"EditorSpinSlider", cstring"_value_input_gui_input")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  let argToPassToGodot0 = if not event.isNil:
  ...
  argsToPassToGodot[][0] = argToPassToGodot0
  var ptrCallRet: pointer
  editorSpinSliderUnderscorevalueInputGuiInputMethodBind.ptrCall(
      self.godotObject, argsToPassToGodot, ptrCallRet)

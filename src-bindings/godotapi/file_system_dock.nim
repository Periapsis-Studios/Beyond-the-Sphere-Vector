...
method fileListActivateFile*(self: FileSystemDock; arg0: int64) {.gcsafe,
    locks: 0, base.}
method fileListGuiInput*(self: FileSystemDock; arg0: InputEvent) {.gcsafe,
    locks: 0, base.}
method fileListRmbOption*(self: FileSystemDock; option: int64) {.gcsafe,
    locks: 0, base.}
method fileListRmbPressed*(self: FileSystemDock; arg0: Vector2) {.gcsafe,
    locks: 0, base.}
...
method fileListThumbnailDone*(self: FileSystemDock; arg0: string; arg1: Texture;
                              arg2: Texture; arg3: Variant) {.gcsafe, locks: 0,
    base.}
...
method fileSortPopup*(self: FileSystemDock; arg0: int64) {.gcsafe, locks: 0,
    base.}
method folderRemoved*(self: FileSystemDock; arg0: string) {.gcsafe, locks: 0,
    base.}
...
method navigateToPath*(self: FileSystemDock; arg0: string; arg1: bool = false) {.
    gcsafe, locks: 0, base.}
method previewInvalidated*(self: FileSystemDock; arg0: string) {.gcsafe,
    locks: 0, base.}
...
method searchChanged*(self: FileSystemDock; arg0: string; arg1: Control) {.
    gcsafe, locks: 0, base.}
method selectFile*(self: FileSystemDock; arg0: string; arg1: bool) {.gcsafe,
    locks: 0, base.}
method toggleFileDisplay*(self: FileSystemDock) {.gcsafe, locks: 0, base.}
method toggleSplitMode*(self: FileSystemDock; arg0: bool) {.gcsafe, locks: 0,
    base.}
...
method treeGuiInput*(self: FileSystemDock; arg0: InputEvent) {.gcsafe, locks: 0,
    base.}
method treeMultiSelected*(self: FileSystemDock; arg0: Object; arg1: int64;
                          arg2: bool) {.gcsafe, locks: 0, base.}
method treeRmbEmpty*(self: FileSystemDock; arg0: Vector2) {.gcsafe, locks: 0,
    base.}
method treeRmbOption*(self: FileSystemDock; option: int64) {.gcsafe, locks: 0,
    base.}
method treeRmbSelect*(self: FileSystemDock; arg0: Vector2) {.gcsafe, locks: 0,
    base.}
...
method updateTree*(self: FileSystemDock; arg0: PoolStringArray; arg1: bool;
                   arg2: bool; arg3: bool) {.gcsafe, locks: 0, base.}
proc canDropDataFw*(self: FileSystemDock; point: Vector2; data: Variant;
                    fromm: Control): bool {.gcsafe, locks: 0.}
proc dropDataFw*(self: FileSystemDock; point: Vector2; data: Variant;
                 fromm: Control) {.gcsafe, locks: 0.}
proc getDragDataFw*(self: FileSystemDock; point: Vector2; fromm: Control): Variant {.
    gcsafe, locks: 0.}
proc navigateToPathImpl*(self: FileSystemDock; path: string) {.gcsafe, locks: 0.}
...
var fileSystemDockUnderscorefileSortPopupMethodBind {.threadvar.}: ptr GodotMethodBind
method fileSortPopup(self: FileSystemDock; arg0: int64) =
  if isNil(fileSystemDockUnderscorefileSortPopupMethodBind):
    fileSystemDockUnderscorefileSortPopupMethodBind = getMethod(
        cstring"FileSystemDock", cstring"_file_sort_popup")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(arg0)
  var ptrCallRet: pointer
  fileSystemDockUnderscorefileSortPopupMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
method makeDirConfirm(self: FileSystemDock) =
  ...
  var ptrCallRet: pointer
  fileSystemDockUnderscoremakeDirConfirmMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
method rescan(self: FileSystemDock) =
  if isNil(fileSystemDockUnderscorerescanMethodBind):
    fileSystemDockUnderscorerescanMethodBind = getMethod(
        cstring"FileSystemDock", cstring"_rescan")
  var ptrCallRet: pointer
...
proc dropDataFw(self: FileSystemDock; point: Vector2; data: Variant;
  ...
  argsToPassToGodot[][2] = argToPassToGodot2
  var ptrCallRet: pointer
  fileSystemDockDropDataFwMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc navigateToPathImpl(self: FileSystemDock; path: string) =

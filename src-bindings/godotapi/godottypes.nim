...
type
  ...
  CullInstance* = ref object of Spatial
    ## singleton: false
                                       ## instanciable: false
                                       ## is_reference: false
  
  VisualInstance* = ref object of CullInstance
    ## singleton: false
                                              ## instanciable: false
                                              ## is_reference: false
  ...
  VisibilityNotifier* = ref object of CullInstance
    ## singleton: false
                                                  ## instanciable: true
                                                  ## is_reference: false
  ...
  OccluderShape* = ref object of Resource
    ## singleton: false
                                         ## instanciable: false
                                         ## is_reference: true
  ...
  AESContext* = ref object of Reference
    ## singleton: false
                                       ## instanciable: true
                                       ## is_reference: true
  ...
  VisualShaderNodeUniformRef* = ref object of VisualShaderNode
    ## singleton: false
                                                              ## instanciable: true
                                                              ## is_reference: true
  ...
  RoomManager* = ref object of Spatial
    ## singleton: false
                                      ## instanciable: true
                                      ## is_reference: false
  ...
  Occluder* = ref object of Spatial
    ## singleton: false
                                   ## instanciable: true
                                   ## is_reference: false
  ...
  WebXRInterface* = ref object of ARVRInterface
    ## singleton: false
                                               ## instanciable: false
                                               ## is_reference: true
  ...
  EditorSceneImporterFBX* = ref object of EditorSceneImporter
    ## singleton: false
                                                             ## instanciable: false
                                                             ## is_reference: true
  ...
  PackedSceneGLTF* = ref object of PackedScene
    ## singleton: false
                                              ## instanciable: true
                                              ## is_reference: true
  ...
  EditorSceneImporterGLTF* = ref object of EditorSceneImporter
    ## singleton: false
                                                              ## instanciable: false
                                                              ## is_reference: true
  ...
  HMACContext* = ref object of Reference
    ## singleton: false
                                        ## instanciable: true
                                        ## is_reference: true
  ...
  JavaScriptObject* = ref object of Reference
    ## singleton: false
                                             ## instanciable: false
                                             ## is_reference: true
  ...
  PhysicsTestMotionResult* = ref object of Reference
    ## singleton: false
                                                    ## instanciable: true
                                                    ## is_reference: true
  ...
  ARVRPositionalTracker* = ref object of Reference
    ## singleton: false
                                                  ## instanciable: true
                                                  ## is_reference: true
  ...
  OccluderShapeSphere* = ref object of OccluderShape
    ## singleton: false
                                                    ## instanciable: true
                                                    ## is_reference: true
  ...
  Listener2D* = ref object of Node2D
    ## singleton: false
                                    ## instanciable: true
                                    ## is_reference: false
  ...
  RoomGroup* = ref object of Spatial
    ## singleton: false
                                    ## instanciable: true
                                    ## is_reference: false
...
registerClass(CullInstance, "CullInstance", true)
...
registerClass(EditorResourcePicker, "EditorResourcePicker", true)
...
registerClass(OccluderShape, "OccluderShape", true)
...
registerClass(AESContext, "AESContext", true)
...
registerClass(VisualScriptBasicTypeConstant, "VisualScriptBasicTypeConstant",
              true)
...
registerClass(Portal, "Portal", true)
...
registerClass(GLTFNode, "GLTFNode", true)
...
registerClass(GLTFDocument, "GLTFDocument", true)
registerClass(AspectRatioContainer, "AspectRatioContainer", true)
...
registerClass(VisualShaderNodeUniformRef, "VisualShaderNodeUniformRef", true)
registerClass(VisualScriptExpression, "VisualScriptExpression", true)
registerClass(AudioEffectCapture, "AudioEffectCapture", true)
...
registerClass(RoomManager, "RoomManager", true)
...
registerClass(VisualShaderNodeVectorDecompose,
              "VisualShaderNodeVectorDecompose", true)
registerClass(DampedSpringJoint2D, "DampedSpringJoint2D", true)
registerClass(Occluder, "Occluder", true)
...
registerClass(WebXRInterface, "WebXRInterface", true)
...
registerClass(EditorSceneImporterFBX, "EditorSceneImporterFBX", true)
...
registerClass(PackedSceneGLTF, "PackedSceneGLTF", true)
registerClass(EditorResourcePreviewGenerator, "EditorResourcePreviewGenerator",
              true)
registerClass(VisualShaderNodeVectorRefract, "VisualShaderNodeVectorRefract",
              true)
...
registerClass(VisualShaderNodeTransformMult, "VisualShaderNodeTransformMult",
              true)
...
registerClass(VisualShaderNodeTransformFunc, "VisualShaderNodeTransformFunc",
              true)
...
registerClass(VisualShaderNodeBooleanConstant,
              "VisualShaderNodeBooleanConstant", true)
...
registerClass(GLTFAnimation, "GLTFAnimation", true)
registerClass(VisualShaderNodeVectorScalarMix,
              "VisualShaderNodeVectorScalarMix", true)
...
registerClass(EditorSceneImporterGLTF, "EditorSceneImporterGLTF", true)
...
registerClass(GLTFState, "GLTFState", true)
...
registerClass(HMACContext, "HMACContext", true)
...
registerClass(JavaScriptObject, "JavaScriptObject", true)
...
registerClass(GLTFAccessor, "GLTFAccessor", true)
...
registerClass(GLTFCamera, "GLTFCamera", true)
...
registerClass(VisualShaderNodeVectorDistance, "VisualShaderNodeVectorDistance",
              true)
registerClass(GLTFMesh, "GLTFMesh", true)
...
registerClass(PhysicsTestMotionResult, "PhysicsTestMotionResult", true)
...
registerClass(GLTFSpecGloss, "GLTFSpecGloss", true)
...
registerClass(GLTFTexture, "GLTFTexture", true)
...
registerClass(EditorNavigationMeshGenerator, "EditorNavigationMeshGenerator",
              true)
...
registerClass(VisualShaderNodeScalarUniform, "VisualShaderNodeScalarUniform",
              true)
...
registerClass(VisualShaderNodeColorConstant, "VisualShaderNodeColorConstant",
              true)
registerClass(Generic6DOFJoint, "Generic6DOFJoint", true)
registerClass(GLTFBufferView, "GLTFBufferView", true)
registerClass(ReferenceRect, "ReferenceRect", true)
registerClass(VisualScriptIterator, "VisualScriptIterator", true)
registerClass(Physics2DShapeQueryParameters, "Physics2DShapeQueryParameters",
              true)
registerClass(VisualScriptSubCall, "VisualScriptSubCall", true)
registerClass(EditorInspectorPlugin, "EditorInspectorPlugin", true)
registerClass(GLTFSkeleton, "GLTFSkeleton", true)
registerClass(EditorScriptPicker, "EditorScriptPicker", true)
...
registerClass(GLTFSkin, "GLTFSkin", true)
...
registerClass(VisualShaderNodeVectorCompose, "VisualShaderNodeVectorCompose",
              true)
...
registerClass(AudioStreamMP3, "AudioStreamMP3", true)
registerClass(GLTFLight, "GLTFLight", true)
...
registerClass(OccluderShapeSphere, "OccluderShapeSphere", true)
...
registerClass(Listener2D, "Listener2D", true)
...
registerClass(RoomGroup, "RoomGroup", true)

...
proc getConnectionInputColor*(self: GraphNode; idx: int64): Color {.gcsafe,
    locks: 0.}
...
proc getConnectionInputPosition*(self: GraphNode; idx: int64): Vector2 {.gcsafe,
    locks: 0.}
proc getConnectionInputType*(self: GraphNode; idx: int64): int64 {.gcsafe,
    locks: 0.}
proc getConnectionOutputColor*(self: GraphNode; idx: int64): Color {.gcsafe,
    locks: 0.}
...
proc getConnectionOutputPosition*(self: GraphNode; idx: int64): Vector2 {.
    gcsafe, locks: 0.}
proc getConnectionOutputType*(self: GraphNode; idx: int64): int64 {.gcsafe,
    locks: 0.}
...
proc setSlot*(self: GraphNode; idx: int64; enableLeft: bool; typeLeft: int64;
              colorLeft: Color; enableRight: bool; typeRight: int64;
              colorRight: Color; customLeft: Texture = nil;
              customRight: Texture = nil) {.gcsafe, locks: 0.}
proc setSlotColorLeft*(self: GraphNode; idx: int64; colorLeft: Color) {.gcsafe,
    locks: 0.}
proc setSlotColorRight*(self: GraphNode; idx: int64; colorRight: Color) {.
    gcsafe, locks: 0.}
proc setSlotEnabledLeft*(self: GraphNode; idx: int64; enableLeft: bool) {.
    gcsafe, locks: 0.}
proc setSlotEnabledRight*(self: GraphNode; idx: int64; enableRight: bool) {.
    gcsafe, locks: 0.}
proc setSlotTypeLeft*(self: GraphNode; idx: int64; typeLeft: int64) {.gcsafe,
    locks: 0.}
proc setSlotTypeRight*(self: GraphNode; idx: int64; typeRight: int64) {.gcsafe,
    locks: 0.}
...
proc title(self: GraphNode): string =
  if isNil(graphNodeGetTitleMethodBind):
    graphNodeGetTitleMethodBind = getMethod(cstring"GraphNode",
        cstring"get_title")
  var ptrCallRet: pointer
...
proc `title=`(self: GraphNode; val: string) =
  if isNil(graphNodeSetTitleMethodBind):
    graphNodeSetTitleMethodBind = getMethod(cstring"GraphNode",
        cstring"set_title")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc getConnectionInputPosition(self: GraphNode; idx: int64): Vector2 =
  if isNil(graphNodeGetConnectionInputPositionMethodBind):
    graphNodeGetConnectionInputPositionMethodBind = getMethod(
        cstring"GraphNode", cstring"get_connection_input_position")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(idx)
...
proc getSlotTypeLeft(self: GraphNode; idx: int64): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  graphNodeGetSlotTypeLeftMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc setSlot(self: GraphNode; idx: int64; enableLeft: bool; typeLeft: int64;
             colorLeft: Color; enableRight: bool; typeRight: int64;
             colorRight: Color; customLeft: Texture = nil;
             customRight: Texture = nil) =
  if isNil(graphNodeSetSlotMethodBind):
    graphNodeSetSlotMethodBind = getMethod(cstring"GraphNode",
        cstring"set_slot")
  var
...
var graphNodeSetSlotColorLeftMethodBind {.threadvar.}: ptr GodotMethodBind
proc setSlotColorLeft(self: GraphNode; idx: int64; colorLeft: Color) =
  if isNil(graphNodeSetSlotColorLeftMethodBind):
    graphNodeSetSlotColorLeftMethodBind = getMethod(cstring"GraphNode",
        cstring"set_slot_color_left")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(idx)
  argsToPassToGodot[][1] = unsafeAddr(colorLeft)
  var ptrCallRet: pointer
  graphNodeSetSlotColorLeftMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

var graphNodeSetSlotColorRightMethodBind {.threadvar.}: ptr GodotMethodBind
proc setSlotColorRight(self: GraphNode; idx: int64; colorRight: Color) =
  if isNil(graphNodeSetSlotColorRightMethodBind):
    graphNodeSetSlotColorRightMethodBind = getMethod(cstring"GraphNode",
        cstring"set_slot_color_right")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(idx)
  argsToPassToGodot[][1] = unsafeAddr(colorRight)
  var ptrCallRet: pointer
  graphNodeSetSlotColorRightMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

var graphNodeSetSlotEnabledLeftMethodBind {.threadvar.}: ptr GodotMethodBind
proc setSlotEnabledLeft(self: GraphNode; idx: int64; enableLeft: bool) =
  if isNil(graphNodeSetSlotEnabledLeftMethodBind):
    graphNodeSetSlotEnabledLeftMethodBind = getMethod(cstring"GraphNode",
        cstring"set_slot_enabled_left")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(idx)
  argsToPassToGodot[][1] = unsafeAddr(enableLeft)
  var ptrCallRet: pointer
  graphNodeSetSlotEnabledLeftMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

var graphNodeSetSlotEnabledRightMethodBind {.threadvar.}: ptr GodotMethodBind
proc setSlotEnabledRight(self: GraphNode; idx: int64; enableRight: bool) =
  if isNil(graphNodeSetSlotEnabledRightMethodBind):
    graphNodeSetSlotEnabledRightMethodBind = getMethod(cstring"GraphNode",
        cstring"set_slot_enabled_right")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(idx)
  argsToPassToGodot[][1] = unsafeAddr(enableRight)
  var ptrCallRet: pointer
  graphNodeSetSlotEnabledRightMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

var graphNodeSetSlotTypeLeftMethodBind {.threadvar.}: ptr GodotMethodBind
proc setSlotTypeLeft(self: GraphNode; idx: int64; typeLeft: int64) =
  if isNil(graphNodeSetSlotTypeLeftMethodBind):
    graphNodeSetSlotTypeLeftMethodBind = getMethod(cstring"GraphNode",
        cstring"set_slot_type_left")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(idx)
  argsToPassToGodot[][1] = unsafeAddr(typeLeft)
  var ptrCallRet: pointer
  graphNodeSetSlotTypeLeftMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

var graphNodeSetSlotTypeRightMethodBind {.threadvar.}: ptr GodotMethodBind
proc setSlotTypeRight(self: GraphNode; idx: int64; typeRight: int64) =
  if isNil(graphNodeSetSlotTypeRightMethodBind):
    graphNodeSetSlotTypeRightMethodBind = getMethod(cstring"GraphNode",
        cstring"set_slot_type_right")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(idx)
  argsToPassToGodot[][1] = unsafeAddr(typeRight)
  var ptrCallRet: pointer
  graphNodeSetSlotTypeRightMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

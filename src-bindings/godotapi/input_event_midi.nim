...
proc `channel=`(self: InputEventMIDI; val: int64) =
  ...
  var ptrCallRet: pointer
  inputEventMIDISetChannelMethodBind.ptrCall(self.godotObject,
...
proc instrument(self: InputEventMIDI): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  inputEventMIDIGetInstrumentMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `message=`(self: InputEventMIDI; val: int64) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  inputEventMIDISetMessageMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

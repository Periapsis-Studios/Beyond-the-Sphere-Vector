...
proc addIconItem*(self: ItemList; icon: Texture; selectable: bool = true) {.
    gcsafe, locks: 0.}
proc addItem*(self: ItemList; text: string; icon: Texture = nil;
              selectable: bool = true) {.gcsafe, locks: 0.}
...
proc setItemCustomFgColor*(self: ItemList; idx: int64; customFgColor: Color) {.
    gcsafe, locks: 0.}
proc setItemDisabled*(self: ItemList; idx: int64; disabled: bool) {.gcsafe,
    locks: 0.}
...
proc setItemIconModulate*(self: ItemList; idx: int64; modulate: Color) {.gcsafe,
    locks: 0.}
proc setItemIconRegion*(self: ItemList; idx: int64; rect: Rect2) {.gcsafe,
    locks: 0.}
proc setItemIconTransposed*(self: ItemList; idx: int64; transposed: bool) {.
    gcsafe, locks: 0.}
proc setItemMetadata*(self: ItemList; idx: int64; metadata: Variant) {.gcsafe,
    locks: 0.}
proc setItemSelectable*(self: ItemList; idx: int64; selectable: bool) {.gcsafe,
    locks: 0.}
proc setItemText*(self: ItemList; idx: int64; text: string) {.gcsafe, locks: 0.}
proc setItemTooltip*(self: ItemList; idx: int64; tooltip: string) {.gcsafe,
    locks: 0.}
proc setItemTooltipEnabled*(self: ItemList; idx: int64; enable: bool) {.gcsafe,
    locks: 0.}
...
proc `allowReselect=`(self: ItemList; val: bool) =
  ...
  var ptrCallRet: pointer
  itemListSetAllowReselectMethodBind.ptrCall(self.godotObject,
...
proc fixedColumnWidth(self: ItemList): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  itemListGetFixedColumnWidthMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `fixedIconSize=`(self: ItemList; val: Vector2) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  itemListSetFixedIconSizeMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc isItemSelectable(self: ItemList; idx: int64): bool =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  itemListIsItemSelectableMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc moveItem(self: ItemList; fromIdx: int64; toIdx: int64) =
  if isNil(itemListMoveItemMethodBind):
    itemListMoveItemMethodBind = getMethod(cstring"ItemList",
        cstring"move_item")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc select(self: ItemList; idx: int64; single: bool = true) =
  ...
  var ptrCallRet: pointer
  itemListSelectMethodBind.ptrCall(self.godotObject, argsToPassToGodot,
                                   ptrCallRet)

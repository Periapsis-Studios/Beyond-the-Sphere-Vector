...
proc `colliderMetadata=`*(self: KinematicCollision; val: Variant) {.gcsafe,
    locks: 0.}
proc colliderRid*(self: KinematicCollision): RID {.gcsafe, locks: 0.}
proc `colliderRid=`*(self: KinematicCollision; val: RID) {.gcsafe, locks: 0.}
...
proc `colliderShapeIndex=`*(self: KinematicCollision; val: int64) {.gcsafe,
    locks: 0.}
proc colliderVelocity*(self: KinematicCollision): Vector3 {.gcsafe, locks: 0.}
proc `colliderVelocity=`*(self: KinematicCollision; val: Vector3) {.gcsafe,
    locks: 0.}
...
proc getAngle*(self: KinematicCollision;
               upDirection: Vector3 = vec3(0.0, 1.0, 0.0)): float64 {.gcsafe,
    locks: 0.}
...
var kinematicCollisionGetColliderRidMethodBind {.threadvar.}: ptr GodotMethodBind
proc colliderRid(self: KinematicCollision): RID =
  if isNil(kinematicCollisionGetColliderRidMethodBind):
    kinematicCollisionGetColliderRidMethodBind = getMethod(
        cstring"KinematicCollision", cstring"get_collider_rid")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  kinematicCollisionGetColliderRidMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

proc `colliderRid=`(self: KinematicCollision; val: RID) =
  if isNil(kinematicCollisionMethodBind):
    kinematicCollisionMethodBind = getMethod(cstring"KinematicCollision",
        cstring"")
  var
...
proc normal(self: KinematicCollision): Vector3 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  kinematicCollisionGetNormalMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc travel(self: KinematicCollision): Vector3 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  kinematicCollisionGetTravelMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
var kinematicCollisionGetAngleMethodBind {.threadvar.}: ptr GodotMethodBind
proc getAngle(self: KinematicCollision;
              upDirection: Vector3 = vec3(0.0, 1.0, 0.0)): float64 =
  if isNil(kinematicCollisionGetAngleMethodBind):
    kinematicCollisionGetAngleMethodBind = getMethod(
        cstring"KinematicCollision", cstring"get_angle")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  kinematicCollisionGetAngleMethodBind.ptrCall(self.godotObject,

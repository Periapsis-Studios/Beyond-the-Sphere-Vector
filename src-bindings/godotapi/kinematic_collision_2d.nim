...
proc `colliderMetadata=`*(self: KinematicCollision2D; val: Variant) {.gcsafe,
    locks: 0.}
proc colliderRid*(self: KinematicCollision2D): RID {.gcsafe, locks: 0.}
proc `colliderRid=`*(self: KinematicCollision2D; val: RID) {.gcsafe, locks: 0.}
proc colliderShape*(self: KinematicCollision2D): Object {.gcsafe, locks: 0.}
proc `colliderShape=`*(self: KinematicCollision2D; val: Object) {.gcsafe,
    locks: 0.}
proc colliderShapeIndex*(self: KinematicCollision2D): int64 {.gcsafe, locks: 0.}
proc `colliderShapeIndex=`*(self: KinematicCollision2D; val: int64) {.gcsafe,
    locks: 0.}
proc colliderVelocity*(self: KinematicCollision2D): Vector2 {.gcsafe, locks: 0.}
proc `colliderVelocity=`*(self: KinematicCollision2D; val: Vector2) {.gcsafe,
    locks: 0.}
...
proc getAngle*(self: KinematicCollision2D;
...
var kinematicCollision2DGetColliderRidMethodBind {.threadvar.}: ptr GodotMethodBind
proc colliderRid(self: KinematicCollision2D): RID =
  if isNil(kinematicCollision2DGetColliderRidMethodBind):
    kinematicCollision2DGetColliderRidMethodBind = getMethod(
        cstring"KinematicCollision2D", cstring"get_collider_rid")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  kinematicCollision2DGetColliderRidMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

proc `colliderRid=`(self: KinematicCollision2D; val: RID) =
  if isNil(kinematicCollision2DMethodBind):
    kinematicCollision2DMethodBind = getMethod(cstring"KinematicCollision2D",
        cstring"")
  var
...
var kinematicCollision2DGetAngleMethodBind {.threadvar.}: ptr GodotMethodBind
proc getAngle(self: KinematicCollision2D; upDirection: Vector2 = vec2(0.0, -1.0)): float64 =
  if isNil(kinematicCollision2DGetAngleMethodBind):
    kinematicCollision2DGetAngleMethodBind = getMethod(
        cstring"KinematicCollision2D", cstring"get_angle")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  kinematicCollision2DGetAngleMethodBind.ptrCall(self.godotObject,

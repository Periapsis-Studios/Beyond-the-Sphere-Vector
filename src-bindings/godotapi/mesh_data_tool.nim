...
proc commitToSurface*(self: MeshDataTool; mesh: ArrayMesh): Error {.gcsafe,
    locks: 0.}
...
proc getEdgeFaces*(self: MeshDataTool; idx: int64): PoolIntArray {.gcsafe,
    locks: 0.}
...
proc getFaceEdge*(self: MeshDataTool; idx: int64; edge: int64): int64 {.gcsafe,
    locks: 0.}
...
proc getVertexBones*(self: MeshDataTool; idx: int64): PoolIntArray {.gcsafe,
    locks: 0.}
...
proc getVertexEdges*(self: MeshDataTool; idx: int64): PoolIntArray {.gcsafe,
    locks: 0.}
proc getVertexFaces*(self: MeshDataTool; idx: int64): PoolIntArray {.gcsafe,
    locks: 0.}
proc getVertexMeta*(self: MeshDataTool; idx: int64): Variant {.gcsafe, locks: 0.}
proc getVertexNormal*(self: MeshDataTool; idx: int64): Vector3 {.gcsafe,
    locks: 0.}
...
proc getVertexWeights*(self: MeshDataTool; idx: int64): PoolRealArray {.gcsafe,
    locks: 0.}
proc setEdgeMeta*(self: MeshDataTool; idx: int64; meta: Variant) {.gcsafe,
    locks: 0.}
proc setFaceMeta*(self: MeshDataTool; idx: int64; meta: Variant) {.gcsafe,
    locks: 0.}
proc setMaterial*(self: MeshDataTool; material: Material) {.gcsafe, locks: 0.}
proc setVertex*(self: MeshDataTool; idx: int64; vertex: Vector3) {.gcsafe,
    locks: 0.}
proc setVertexBones*(self: MeshDataTool; idx: int64; bones: PoolIntArray) {.
    gcsafe, locks: 0.}
proc setVertexColor*(self: MeshDataTool; idx: int64; color: Color) {.gcsafe,
    locks: 0.}
proc setVertexMeta*(self: MeshDataTool; idx: int64; meta: Variant) {.gcsafe,
    locks: 0.}
...
proc setVertexTangent*(self: MeshDataTool; idx: int64; tangent: Plane) {.gcsafe,
    locks: 0.}
proc setVertexUv*(self: MeshDataTool; idx: int64; uv: Vector2) {.gcsafe,
    locks: 0.}
proc setVertexUv2*(self: MeshDataTool; idx: int64; uv2: Vector2) {.gcsafe,
    locks: 0.}
...
proc clear(self: MeshDataTool) =
  if isNil(meshDataToolClearMethodBind):
    meshDataToolClearMethodBind = getMethod(cstring"MeshDataTool",
        cstring"clear")
...
proc getEdgeFaces(self: MeshDataTool; idx: int64): PoolIntArray =
  ...
  ptrCallRet = addr(ptrCallVal)
  meshDataToolGetEdgeFacesMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc getVertexUv2(self: MeshDataTool; idx: int64): Vector2 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  meshDataToolGetVertexUv2MethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc setVertexUv2(self: MeshDataTool; idx: int64; uv2: Vector2) =
  ...
  var ptrCallRet: pointer
  meshDataToolSetVertexUv2MethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

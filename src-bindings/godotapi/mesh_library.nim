...
proc getItemMeshTransform*(self: MeshLibrary; id: int64): Transform {.gcsafe,
    locks: 0.}
proc getItemName*(self: MeshLibrary; id: int64): string {.gcsafe, locks: 0.}
proc getItemNavmesh*(self: MeshLibrary; id: int64): NavigationMesh {.gcsafe,
    locks: 0.}
...
proc setItemMeshTransform*(self: MeshLibrary; id: int64;
                           meshTransform: Transform) {.gcsafe, locks: 0.}
...
proc setItemNavmeshTransform*(self: MeshLibrary; id: int64; navmesh: Transform) {.
    gcsafe, locks: 0.}
proc setItemPreview*(self: MeshLibrary; id: int64; texture: Texture) {.gcsafe,
    locks: 0.}
proc setItemShapes*(self: MeshLibrary; id: int64; shapes: Array) {.gcsafe,
    locks: 0.}
...
var meshLibraryGetItemMeshTransformMethodBind {.threadvar.}: ptr GodotMethodBind
proc getItemMeshTransform(self: MeshLibrary; id: int64): Transform =
  if isNil(meshLibraryGetItemMeshTransformMethodBind):
    meshLibraryGetItemMeshTransformMethodBind = getMethod(cstring"MeshLibrary",
        cstring"get_item_mesh_transform")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(id)
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  meshLibraryGetItemMeshTransformMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc getItemShapes(self: MeshLibrary; id: int64): Array =
  ...
  ptrCallRet = addr(ptrCallVal)
  meshLibraryGetItemShapesMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
var meshLibrarySetItemMeshTransformMethodBind {.threadvar.}: ptr GodotMethodBind
proc setItemMeshTransform(self: MeshLibrary; id: int64; meshTransform: Transform) =
  if isNil(meshLibrarySetItemMeshTransformMethodBind):
    meshLibrarySetItemMeshTransformMethodBind = getMethod(cstring"MeshLibrary",
        cstring"set_item_mesh_transform")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(id)
  argsToPassToGodot[][1] = unsafeAddr(meshTransform)
  var ptrCallRet: pointer
  meshLibrarySetItemMeshTransformMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc setItemShapes(self: MeshLibrary; id: int64; shapes: Array) =
  ...
  var ptrCallRet: pointer
  meshLibrarySetItemShapesMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

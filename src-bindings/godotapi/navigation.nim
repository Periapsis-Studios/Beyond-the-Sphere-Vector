...
proc getClosestPoint*(self: Navigation; toPoint: Vector3): Vector3 {.gcsafe,
    locks: 0.}
...
proc getClosestPointToSegment*(self: Navigation; start: Vector3; endd: Vector3;
                               useCollision: bool = false): Vector3 {.gcsafe,
    locks: 0.}
...
proc getClosestPointToSegment(self: Navigation; start: Vector3; endd: Vector3;
  ...
  if isNil(navigationGetClosestPointToSegmentMethodBind):
    navigationGetClosestPointToSegmentMethodBind = getMethod(
        cstring"Navigation", cstring"get_closest_point_to_segment")
  var

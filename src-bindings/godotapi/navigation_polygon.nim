...
proc `vertices=`*(self: NavigationPolygon; val: PoolVector2Array) {.gcsafe,
    locks: 0.}
...
proc addPolygon*(self: NavigationPolygon; polygon: PoolIntArray) {.gcsafe,
    locks: 0.}
...
proc getPolygon*(self: NavigationPolygon; idx: int64): PoolIntArray {.gcsafe,
    locks: 0.}
...
proc outlines(self: NavigationPolygon): Array =
  ...
  navigationPolygonUnderscoregetOutlinesMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
proc polygons(self: NavigationPolygon): Array =
  ...
  initGodotArray(ptrCallVal)
  ptrCallRet = addr(ptrCallVal)
  navigationPolygonUnderscoregetPolygonsMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
  result = newArray(ptrCallVal)
...
proc vertices(self: NavigationPolygon): PoolVector2Array =
  ...
  ptrCallRet = addr(ptrCallVal)
  navigationPolygonGetVerticesMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc addOutline(self: NavigationPolygon; outline: PoolVector2Array) =
  if isNil(navigationPolygonAddOutlineMethodBind):
    navigationPolygonAddOutlineMethodBind = getMethod(
        cstring"NavigationPolygon", cstring"add_outline")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc addPolygon(self: NavigationPolygon; polygon: PoolIntArray) =
  if isNil(navigationPolygonAddPolygonMethodBind):
    navigationPolygonAddPolygonMethodBind = getMethod(
        cstring"NavigationPolygon", cstring"add_polygon")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc getOutline(self: NavigationPolygon; idx: int64): PoolVector2Array =
  if isNil(navigationPolygonGetOutlineMethodBind):
    navigationPolygonGetOutlineMethodBind = getMethod(
        cstring"NavigationPolygon", cstring"get_outline")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc getPolygon(self: NavigationPolygon; idx: int64): PoolIntArray =
  if isNil(navigationPolygonGetPolygonMethodBind):
    navigationPolygonGetPolygonMethodBind = getMethod(
        cstring"NavigationPolygon", cstring"get_polygon")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(idx)
...
proc setOutline(self: NavigationPolygon; idx: int64; outline: PoolVector2Array) =
  if isNil(navigationPolygonSetOutlineMethodBind):
    navigationPolygonSetOutlineMethodBind = getMethod(
        cstring"NavigationPolygon", cstring"set_outline")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(idx)

...
proc `alwaysOrdered=`*(self: NetworkedMultiplayerENet; val: bool) {.gcsafe,
    locks: 0.}
proc channelCount*(self: NetworkedMultiplayerENet): int64 {.gcsafe, locks: 0.}
proc `channelCount=`*(self: NetworkedMultiplayerENet; val: int64) {.gcsafe,
    locks: 0.}
...
proc `compressionMode=`*(self: NetworkedMultiplayerENet; val: int64) {.gcsafe,
    locks: 0.}
proc dtlsHostname*(self: NetworkedMultiplayerENet): string {.gcsafe, locks: 0.}
proc `dtlsHostname=`*(self: NetworkedMultiplayerENet; val: string) {.gcsafe,
    locks: 0.}
proc dtlsVerify*(self: NetworkedMultiplayerENet): bool {.gcsafe, locks: 0.}
proc `dtlsVerify=`*(self: NetworkedMultiplayerENet; val: bool) {.gcsafe,
    locks: 0.}
proc serverRelay*(self: NetworkedMultiplayerENet): bool {.gcsafe, locks: 0.}
proc `serverRelay=`*(self: NetworkedMultiplayerENet; val: bool) {.gcsafe,
    locks: 0.}
...
proc disconnectPeer*(self: NetworkedMultiplayerENet; id: int64;
                     now: bool = false) {.gcsafe, locks: 0.}
proc getLastPacketChannel*(self: NetworkedMultiplayerENet): int64 {.gcsafe,
    locks: 0.}
...
proc getPeerAddress*(self: NetworkedMultiplayerENet; id: int64): string {.
    gcsafe, locks: 0.}
proc getPeerPort*(self: NetworkedMultiplayerENet; id: int64): int64 {.gcsafe,
    locks: 0.}
...
proc setDtlsKey*(self: NetworkedMultiplayerENet; key: CryptoKey) {.gcsafe,
    locks: 0.}
proc setPeerTimeout*(self: NetworkedMultiplayerENet; id: int64;
                     timeoutLimit: int64; timeoutMin: int64; timeoutMax: int64) {.
    gcsafe, locks: 0.}
...
var networkedMultiplayerENetGetDtlsHostnameMethodBind {.threadvar.}: ptr GodotMethodBind
proc dtlsHostname(self: NetworkedMultiplayerENet): string =
  if isNil(networkedMultiplayerENetGetDtlsHostnameMethodBind):
    networkedMultiplayerENetGetDtlsHostnameMethodBind = getMethod(
        cstring"NetworkedMultiplayerENet", cstring"get_dtls_hostname")
  var ptrCallRet: pointer
  var ptrCallVal: GodotString
  ptrCallRet = addr(ptrCallVal)
  networkedMultiplayerENetGetDtlsHostnameMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
  result = $ptrCallVal
  deinit(ptrCallVal)

var networkedMultiplayerENetSetDtlsHostnameMethodBind {.threadvar.}: ptr GodotMethodBind
proc `dtlsHostname=`(self: NetworkedMultiplayerENet; val: string) =
  if isNil(networkedMultiplayerENetSetDtlsHostnameMethodBind):
    networkedMultiplayerENetSetDtlsHostnameMethodBind = getMethod(
        cstring"NetworkedMultiplayerENet", cstring"set_dtls_hostname")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  ...
  var ptrCallRet: pointer
  networkedMultiplayerENetSetDtlsHostnameMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
var networkedMultiplayerENetSetPeerTimeoutMethodBind {.threadvar.}: ptr GodotMethodBind
proc setPeerTimeout(self: NetworkedMultiplayerENet; id: int64;
                    timeoutLimit: int64; timeoutMin: int64; timeoutMax: int64) =
  if isNil(networkedMultiplayerENetSetPeerTimeoutMethodBind):
    networkedMultiplayerENetSetPeerTimeoutMethodBind = getMethod(
        cstring"NetworkedMultiplayerENet", cstring"set_peer_timeout")
  var
    argsStatic: array[4, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(id)
  argsToPassToGodot[][1] = unsafeAddr(timeoutLimit)
  argsToPassToGodot[][2] = unsafeAddr(timeoutMin)
  argsToPassToGodot[][3] = unsafeAddr(timeoutMax)
  var ptrCallRet: pointer
  networkedMultiplayerENetSetPeerTimeoutMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

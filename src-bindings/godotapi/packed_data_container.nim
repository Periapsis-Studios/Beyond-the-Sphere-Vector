...
method iterGet*(self: PackedDataContainer; arg0: Variant): Variant {.gcsafe,
    locks: 0, base.}
method iterInit*(self: PackedDataContainer; arg0: Array): Variant {.gcsafe,
    locks: 0, base.}
method iterNext*(self: PackedDataContainer; arg0: Array): Variant {.gcsafe,
    locks: 0, base.}

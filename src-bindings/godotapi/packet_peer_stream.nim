...
proc `inputBufferMaxSize=`*(self: PacketPeerStream; val: int64) {.gcsafe,
    locks: 0.}
proc outputBufferMaxSize*(self: PacketPeerStream): int64 {.gcsafe, locks: 0.}
proc `outputBufferMaxSize=`*(self: PacketPeerStream; val: int64) {.gcsafe,
    locks: 0.}
...
proc outputBufferMaxSize(self: PacketPeerStream): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  packetPeerStreamGetOutputBufferMaxSizeMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)

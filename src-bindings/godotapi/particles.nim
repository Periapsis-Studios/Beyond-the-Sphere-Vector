...
proc drawPass1(self: Particles): Mesh =
  ...
  particlesGetDrawPassMeshMethodBind.ptrCall(self.godotObject,
...
proc `drawPass1=`(self: Particles; val: Mesh) =
  ...
  var ptrCallRet: pointer
  particlesSetDrawPassMeshMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc fractDelta(self: Particles): bool =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  particlesGetFractionalDeltaMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc processMaterial(self: Particles): Material =
  ...
  var ptrCallVal: ptr GodotObject
  ptrCallRet = addr(ptrCallVal)
  particlesGetProcessMaterialMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
  result = asNimGodotObject[type(result)](ptrCallVal, false, true)
...
proc randomness(self: Particles): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  particlesGetRandomnessRatioMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

...
proc `angularVelocity=`*(self: ParticlesMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `animOffsetCurve=`*(self: ParticlesMaterial; val: Texture) {.gcsafe,
    locks: 0.}
proc animOffsetRandom*(self: ParticlesMaterial): float64 {.gcsafe, locks: 0.}
proc `animOffsetRandom=`*(self: ParticlesMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `animSpeedCurve=`*(self: ParticlesMaterial; val: Texture) {.gcsafe,
    locks: 0.}
proc animSpeedRandom*(self: ParticlesMaterial): float64 {.gcsafe, locks: 0.}
proc `animSpeedRandom=`*(self: ParticlesMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `emissionBoxExtents=`*(self: ParticlesMaterial; val: Vector3) {.gcsafe,
    locks: 0.}
...
proc `emissionPointCount=`*(self: ParticlesMaterial; val: int64) {.gcsafe,
    locks: 0.}
...
proc `emissionPointTexture=`*(self: ParticlesMaterial; val: Texture) {.gcsafe,
    locks: 0.}
proc emissionRingAxis*(self: ParticlesMaterial): Vector3 {.gcsafe, locks: 0.}
proc `emissionRingAxis=`*(self: ParticlesMaterial; val: Vector3) {.gcsafe,
    locks: 0.}
proc emissionRingHeight*(self: ParticlesMaterial): float64 {.gcsafe, locks: 0.}
proc `emissionRingHeight=`*(self: ParticlesMaterial; val: float64) {.gcsafe,
    locks: 0.}
proc emissionRingInnerRadius*(self: ParticlesMaterial): float64 {.gcsafe,
    locks: 0.}
proc `emissionRingInnerRadius=`*(self: ParticlesMaterial; val: float64) {.
    gcsafe, locks: 0.}
proc emissionRingRadius*(self: ParticlesMaterial): float64 {.gcsafe, locks: 0.}
proc `emissionRingRadius=`*(self: ParticlesMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `hueVariationCurve=`*(self: ParticlesMaterial; val: Texture) {.gcsafe,
    locks: 0.}
proc hueVariationRandom*(self: ParticlesMaterial): float64 {.gcsafe, locks: 0.}
proc `hueVariationRandom=`*(self: ParticlesMaterial; val: float64) {.gcsafe,
    locks: 0.}
proc initialVelocity*(self: ParticlesMaterial): float64 {.gcsafe, locks: 0.}
proc `initialVelocity=`*(self: ParticlesMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `lifetimeRandomness=`*(self: ParticlesMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `linearAccelCurve=`*(self: ParticlesMaterial; val: Texture) {.gcsafe,
    locks: 0.}
proc linearAccelRandom*(self: ParticlesMaterial): float64 {.gcsafe, locks: 0.}
proc `linearAccelRandom=`*(self: ParticlesMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `orbitVelocityCurve=`*(self: ParticlesMaterial; val: Texture) {.gcsafe,
    locks: 0.}
proc orbitVelocityRandom*(self: ParticlesMaterial): float64 {.gcsafe, locks: 0.}
proc `orbitVelocityRandom=`*(self: ParticlesMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `radialAccelCurve=`*(self: ParticlesMaterial; val: Texture) {.gcsafe,
    locks: 0.}
proc radialAccelRandom*(self: ParticlesMaterial): float64 {.gcsafe, locks: 0.}
proc `radialAccelRandom=`*(self: ParticlesMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `tangentialAccel=`*(self: ParticlesMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `tangentialAccelRandom=`*(self: ParticlesMaterial; val: float64) {.gcsafe,
    locks: 0.}
proc trailColorModifier*(self: ParticlesMaterial): GradientTexture {.gcsafe,
    locks: 0.}
...
proc trailSizeModifier*(self: ParticlesMaterial): CurveTexture {.gcsafe,
    locks: 0.}
...
proc emissionBoxExtents(self: ParticlesMaterial): Vector3 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  particlesMaterialGetEmissionBoxExtentsMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
proc emissionPointCount(self: ParticlesMaterial): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  particlesMaterialGetEmissionPointCountMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
var particlesMaterialGetEmissionRingAxisMethodBind {.threadvar.}: ptr GodotMethodBind
proc emissionRingAxis(self: ParticlesMaterial): Vector3 =
  if isNil(particlesMaterialGetEmissionRingAxisMethodBind):
    particlesMaterialGetEmissionRingAxisMethodBind = getMethod(
        cstring"ParticlesMaterial", cstring"get_emission_ring_axis")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  particlesMaterialGetEmissionRingAxisMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

var particlesMaterialSetEmissionRingAxisMethodBind {.threadvar.}: ptr GodotMethodBind
proc `emissionRingAxis=`(self: ParticlesMaterial; val: Vector3) =
  if isNil(particlesMaterialSetEmissionRingAxisMethodBind):
    particlesMaterialSetEmissionRingAxisMethodBind = getMethod(
        cstring"ParticlesMaterial", cstring"set_emission_ring_axis")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  particlesMaterialSetEmissionRingAxisMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

var particlesMaterialGetEmissionRingHeightMethodBind {.threadvar.}: ptr GodotMethodBind
proc emissionRingHeight(self: ParticlesMaterial): float64 =
  if isNil(particlesMaterialGetEmissionRingHeightMethodBind):
    particlesMaterialGetEmissionRingHeightMethodBind = getMethod(
        cstring"ParticlesMaterial", cstring"get_emission_ring_height")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  particlesMaterialGetEmissionRingHeightMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)

var particlesMaterialSetEmissionRingHeightMethodBind {.threadvar.}: ptr GodotMethodBind
proc `emissionRingHeight=`(self: ParticlesMaterial; val: float64) =
  if isNil(particlesMaterialSetEmissionRingHeightMethodBind):
    particlesMaterialSetEmissionRingHeightMethodBind = getMethod(
        cstring"ParticlesMaterial", cstring"set_emission_ring_height")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  particlesMaterialSetEmissionRingHeightMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

var particlesMaterialGetEmissionRingInnerRadiusMethodBind {.threadvar.}: ptr GodotMethodBind
proc emissionRingInnerRadius(self: ParticlesMaterial): float64 =
  if isNil(particlesMaterialGetEmissionRingInnerRadiusMethodBind):
    particlesMaterialGetEmissionRingInnerRadiusMethodBind = getMethod(
        cstring"ParticlesMaterial", cstring"get_emission_ring_inner_radius")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  particlesMaterialGetEmissionRingInnerRadiusMethodBind.ptrCall(
      self.godotObject, nil, ptrCallRet)

var particlesMaterialSetEmissionRingInnerRadiusMethodBind {.threadvar.}: ptr GodotMethodBind
proc `emissionRingInnerRadius=`(self: ParticlesMaterial; val: float64) =
  if isNil(particlesMaterialSetEmissionRingInnerRadiusMethodBind):
    particlesMaterialSetEmissionRingInnerRadiusMethodBind = getMethod(
        cstring"ParticlesMaterial", cstring"set_emission_ring_inner_radius")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  particlesMaterialSetEmissionRingInnerRadiusMethodBind.ptrCall(
      self.godotObject, argsToPassToGodot, ptrCallRet)

var particlesMaterialGetEmissionRingRadiusMethodBind {.threadvar.}: ptr GodotMethodBind
proc emissionRingRadius(self: ParticlesMaterial): float64 =
  if isNil(particlesMaterialGetEmissionRingRadiusMethodBind):
    particlesMaterialGetEmissionRingRadiusMethodBind = getMethod(
        cstring"ParticlesMaterial", cstring"get_emission_ring_radius")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  particlesMaterialGetEmissionRingRadiusMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)

var particlesMaterialSetEmissionRingRadiusMethodBind {.threadvar.}: ptr GodotMethodBind
proc `emissionRingRadius=`(self: ParticlesMaterial; val: float64) =
  if isNil(particlesMaterialSetEmissionRingRadiusMethodBind):
    particlesMaterialSetEmissionRingRadiusMethodBind = getMethod(
        cstring"ParticlesMaterial", cstring"set_emission_ring_radius")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  particlesMaterialSetEmissionRingRadiusMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc flagAlignY(self: ParticlesMaterial): bool =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  particlesMaterialGetFlagMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc `flagAlignY=`(self: ParticlesMaterial; val: bool) =
  ...
  argsToPassToGodot[][1] = unsafeAddr(val)
  var ptrCallRet: pointer
  particlesMaterialSetFlagMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc flatness(self: ParticlesMaterial): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  particlesMaterialGetFlatnessMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc gravity(self: ParticlesMaterial): Vector3 =
  if isNil(particlesMaterialGetGravityMethodBind):
    particlesMaterialGetGravityMethodBind = getMethod(
        cstring"ParticlesMaterial", cstring"get_gravity")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  particlesMaterialGetGravityMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `gravity=`(self: ParticlesMaterial; val: Vector3) =
  if isNil(particlesMaterialSetGravityMethodBind):
    particlesMaterialSetGravityMethodBind = getMethod(
        cstring"ParticlesMaterial", cstring"set_gravity")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc lifetimeRandomness(self: ParticlesMaterial): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  particlesMaterialGetLifetimeRandomnessMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
proc spread(self: ParticlesMaterial): float64 =
  if isNil(particlesMaterialGetSpreadMethodBind):
    particlesMaterialGetSpreadMethodBind = getMethod(
        cstring"ParticlesMaterial", cstring"get_spread")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
...
proc `spread=`(self: ParticlesMaterial; val: float64) =
  if isNil(particlesMaterialSetSpreadMethodBind):
    particlesMaterialSetSpreadMethodBind = getMethod(
        cstring"ParticlesMaterial", cstring"set_spread")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc trailColorModifier(self: ParticlesMaterial): GradientTexture =
  ...
  var ptrCallVal: ptr GodotObject
  ptrCallRet = addr(ptrCallVal)
  particlesMaterialGetTrailColorModifierMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
  result = asNimGodotObject[type(result)](ptrCallVal, false, true)

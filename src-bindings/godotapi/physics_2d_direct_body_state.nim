...
proc angularVelocity*(self: Physics2DDirectBodyState): float64 {.gcsafe,
    locks: 0.}
...
proc `inverseMass=`*(self: Physics2DDirectBodyState; val: float64) {.gcsafe,
    locks: 0.}
...
proc totalAngularDamp*(self: Physics2DDirectBodyState): float64 {.gcsafe,
    locks: 0.}
...
proc `totalGravity=`*(self: Physics2DDirectBodyState; val: Vector2) {.gcsafe,
    locks: 0.}
proc totalLinearDamp*(self: Physics2DDirectBodyState): float64 {.gcsafe,
    locks: 0.}
...
proc addForce*(self: Physics2DDirectBodyState; offset: Vector2; force: Vector2) {.
    gcsafe, locks: 0.}
proc addTorque*(self: Physics2DDirectBodyState; torque: float64) {.gcsafe,
    locks: 0.}
proc applyCentralImpulse*(self: Physics2DDirectBodyState; impulse: Vector2) {.
    gcsafe, locks: 0.}
proc applyImpulse*(self: Physics2DDirectBodyState; offset: Vector2;
                   impulse: Vector2) {.gcsafe, locks: 0.}
...
proc getContactColliderObject*(self: Physics2DDirectBodyState; contactIdx: int64): Object {.
    gcsafe, locks: 0.}
proc getContactColliderPosition*(self: Physics2DDirectBodyState;
...
proc getContactColliderShapeMetadata*(self: Physics2DDirectBodyState;
                                      contactIdx: int64): Variant {.gcsafe,
    locks: 0.}
...
proc getSpaceState*(self: Physics2DDirectBodyState): Physics2DDirectSpaceState {.
    gcsafe, locks: 0.}
proc getVelocityAtLocalPosition*(self: Physics2DDirectBodyState;
                                 localPosition: Vector2): Vector2 {.gcsafe,
    locks: 0.}
...
proc `inverseInertia=`(self: Physics2DDirectBodyState; val: float64) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  physics2DDirectBodyStateMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc inverseMass(self: Physics2DDirectBodyState): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  physics2DDirectBodyStateGetInverseMassMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
var physics2DDirectBodyStateGetVelocityAtLocalPositionMethodBind {.threadvar.}: ptr GodotMethodBind
proc getVelocityAtLocalPosition(self: Physics2DDirectBodyState;
                                localPosition: Vector2): Vector2 =
  if isNil(physics2DDirectBodyStateGetVelocityAtLocalPositionMethodBind):
    physics2DDirectBodyStateGetVelocityAtLocalPositionMethodBind = getMethod(
        cstring"Physics2DDirectBodyState",
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  physics2DDirectBodyStateGetVelocityAtLocalPositionMethodBind.ptrCall(
      self.godotObject, argsToPassToGodot, ptrCallRet)

...
proc areaGetShapeTransform*(area: RID; shapeIdx: int64): Transform2D {.gcsafe,
    locks: 0.}
...
proc bodyAddForce*(body: RID; offset: Vector2; force: Vector2) {.gcsafe,
    locks: 0.}
...
proc bodyGetContinuousCollisionDetectionMode*(body: RID): int64 {.gcsafe,
    locks: 0.}
...
proc bodyGetShapeMetadata*(body: RID; shapeIdx: int64): Variant {.gcsafe,
    locks: 0.}
proc bodyGetShapeTransform*(body: RID; shapeIdx: int64): Transform2D {.gcsafe,
    locks: 0.}
...
proc bodyTestMotion*(body: RID; fromm: Transform2D; motion: Vector2;
                     ...
                     resultVal: Physics2DTestMotionResult = nil;
...
proc dampedStringJointGetParam*(joint: RID; param: int64): float64 {.gcsafe,
    locks: 0.}
...
proc spaceGetDirectState*(space: RID): Physics2DDirectSpaceState {.gcsafe,
    locks: 0.}
...
proc bodyAddTorque(body: RID; torque: float64) =
  ...
  if isNil(physics2DServerBodyAddTorqueMethodBind):
    physics2DServerBodyAddTorqueMethodBind = getMethod(
        cstring"Physics2DServer", cstring"body_add_torque")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(body)
...
var physics2DServerBodyGetContinuousCollisionDetectionModeMethodBind
...
var physics2DServerBodySetContinuousCollisionDetectionModeMethodBind
    {.threadvar.}: ptr GodotMethodBind
...
proc bodyTestMotion(body: RID; fromm: Transform2D; motion: Vector2;
  ...
  if isNil(physics2DServerBodyTestMotionMethodBind):
    physics2DServerBodyTestMotionMethodBind = getMethod(
        cstring"Physics2DServer", cstring"body_test_motion")
  var
  ...
  argsToPassToGodot[][6] = unsafeAddr(excludeRaycastShapes)
  argsToPassToGodot[][7] = exclude.godotArray
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
...
proc getProcessInfo(processInfo: int64): int64 =
  ...
  if isNil(physics2DServerGetProcessInfoMethodBind):
    physics2DServerGetProcessInfoMethodBind = getMethod(
        cstring"Physics2DServer", cstring"get_process_info")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc jointGetParam(joint: RID; param: int64): float64 =
  ...
  if isNil(physics2DServerJointGetParamMethodBind):
    physics2DServerJointGetParamMethodBind = getMethod(
        cstring"Physics2DServer", cstring"joint_get_param")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(joint)
...
proc jointSetParam(joint: RID; param: int64; value: float64) =
  ...
  if isNil(physics2DServerJointSetParamMethodBind):
    physics2DServerJointSetParamMethodBind = getMethod(
        cstring"Physics2DServer", cstring"joint_set_param")
  var
    argsStatic: array[3, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(joint)
...
proc pinJointCreate(anchor: Vector2; bodyA: RID; bodyB: RID = initRID()): RID =
  ...
  if isNil(physics2DServerPinJointCreateMethodBind):
    physics2DServerPinJointCreateMethodBind = getMethod(
        cstring"Physics2DServer", cstring"pin_joint_create")
  var
    argsStatic: array[3, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc rayShapeCreate(): RID =
  ...
  if isNil(physics2DServerRayShapeCreateMethodBind):
    physics2DServerRayShapeCreateMethodBind = getMethod(
        cstring"Physics2DServer", cstring"ray_shape_create")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
...
proc setActive(active: bool) =
  ...
  var ptrCallRet: pointer
  physics2DServerSetActiveMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

var physics2DServerSetCollisionIterationsMethodBind {.threadvar.}: ptr GodotMethodBind
proc setCollisionIterations(iterations: int64) =
  if isNil(singletonPhysics2DServer):
    singletonPhysics2DServer = getSingleton[Physics2DServer]()
  let self = singletonPhysics2DServer
  if isNil(physics2DServerSetCollisionIterationsMethodBind):
    physics2DServerSetCollisionIterationsMethodBind = getMethod(
        cstring"Physics2DServer", cstring"set_collision_iterations")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(iterations)
  var ptrCallRet: pointer
  physics2DServerSetCollisionIterationsMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc spaceGetParam(space: RID; param: int64): float64 =
  ...
  if isNil(physics2DServerSpaceGetParamMethodBind):
    physics2DServerSpaceGetParamMethodBind = getMethod(
        cstring"Physics2DServer", cstring"space_get_param")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(space)
...
proc spaceIsActive(space: RID): bool =
  ...
  if isNil(physics2DServerSpaceIsActiveMethodBind):
    physics2DServerSpaceIsActiveMethodBind = getMethod(
        cstring"Physics2DServer", cstring"space_is_active")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(space)
...
proc spaceSetActive(space: RID; active: bool) =
  ...
  if isNil(physics2DServerSpaceSetActiveMethodBind):
    physics2DServerSpaceSetActiveMethodBind = getMethod(
        cstring"Physics2DServer", cstring"space_set_active")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(space)
...
proc spaceSetParam(space: RID; param: int64; value: float64) =
  ...
  if isNil(physics2DServerSpaceSetParamMethodBind):
    physics2DServerSpaceSetParamMethodBind = getMethod(
        cstring"Physics2DServer", cstring"space_set_param")
  var
    argsStatic: array[3, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(space)

...
proc collideWithAreas*(self: Physics2DShapeQueryParameters): bool {.gcsafe,
    locks: 0.}
proc `collideWithAreas=`*(self: Physics2DShapeQueryParameters; val: bool) {.
    gcsafe, locks: 0.}
proc collideWithBodies*(self: Physics2DShapeQueryParameters): bool {.gcsafe,
    locks: 0.}
proc `collideWithBodies=`*(self: Physics2DShapeQueryParameters; val: bool) {.
    gcsafe, locks: 0.}
proc collisionLayer*(self: Physics2DShapeQueryParameters): int64 {.gcsafe,
    locks: 0.}
...
proc `exclude=`*(self: Physics2DShapeQueryParameters; val: Array) {.gcsafe,
    locks: 0.}
proc margin*(self: Physics2DShapeQueryParameters): float64 {.gcsafe, locks: 0.}
proc `margin=`*(self: Physics2DShapeQueryParameters; val: float64) {.gcsafe,
    locks: 0.}
proc motion*(self: Physics2DShapeQueryParameters): Vector2 {.gcsafe, locks: 0.}
proc `motion=`*(self: Physics2DShapeQueryParameters; val: Vector2) {.gcsafe,
    locks: 0.}
proc shapeRid*(self: Physics2DShapeQueryParameters): RID {.gcsafe, locks: 0.}
proc `shapeRid=`*(self: Physics2DShapeQueryParameters; val: RID) {.gcsafe,
    locks: 0.}
proc transform*(self: Physics2DShapeQueryParameters): Transform2D {.gcsafe,
    locks: 0.}
...
proc setShape*(self: Physics2DShapeQueryParameters; shape: Resource) {.gcsafe,
    locks: 0.}
var physics2DShapeQueryParametersIsCollideWithAreasEnabledMethodBind
...
proc margin(self: Physics2DShapeQueryParameters): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  physics2DShapeQueryParametersGetMarginMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
proc motion(self: Physics2DShapeQueryParameters): Vector2 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  physics2DShapeQueryParametersGetMotionMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)

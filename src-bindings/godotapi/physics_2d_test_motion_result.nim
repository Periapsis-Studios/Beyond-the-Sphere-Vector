...
proc `collider=`*(self: Physics2DTestMotionResult; val: Object) {.gcsafe,
    locks: 0.}
proc colliderId*(self: Physics2DTestMotionResult): int64 {.gcsafe, locks: 0.}
proc `colliderId=`*(self: Physics2DTestMotionResult; val: int64) {.gcsafe,
    locks: 0.}
proc colliderRid*(self: Physics2DTestMotionResult): RID {.gcsafe, locks: 0.}
proc `colliderRid=`*(self: Physics2DTestMotionResult; val: RID) {.gcsafe,
    locks: 0.}
proc colliderShape*(self: Physics2DTestMotionResult): int64 {.gcsafe, locks: 0.}
proc `colliderShape=`*(self: Physics2DTestMotionResult; val: int64) {.gcsafe,
    locks: 0.}
proc colliderVelocity*(self: Physics2DTestMotionResult): Vector2 {.gcsafe,
    locks: 0.}
proc `colliderVelocity=`*(self: Physics2DTestMotionResult; val: Vector2) {.
    gcsafe, locks: 0.}
proc collisionDepth*(self: Physics2DTestMotionResult): float64 {.gcsafe,
    locks: 0.}
proc `collisionDepth=`*(self: Physics2DTestMotionResult; val: float64) {.gcsafe,
    locks: 0.}
proc collisionNormal*(self: Physics2DTestMotionResult): Vector2 {.gcsafe,
    locks: 0.}
proc `collisionNormal=`*(self: Physics2DTestMotionResult; val: Vector2) {.
    gcsafe, locks: 0.}
proc collisionPoint*(self: Physics2DTestMotionResult): Vector2 {.gcsafe,
    locks: 0.}
proc `collisionPoint=`*(self: Physics2DTestMotionResult; val: Vector2) {.gcsafe,
    locks: 0.}
proc collisionSafeFraction*(self: Physics2DTestMotionResult): float64 {.gcsafe,
    locks: 0.}
proc `collisionSafeFraction=`*(self: Physics2DTestMotionResult; val: float64) {.
    gcsafe, locks: 0.}
proc collisionUnsafeFraction*(self: Physics2DTestMotionResult): float64 {.
    gcsafe, locks: 0.}
proc `collisionUnsafeFraction=`*(self: Physics2DTestMotionResult; val: float64) {.
    gcsafe, locks: 0.}
proc motion*(self: Physics2DTestMotionResult): Vector2 {.gcsafe, locks: 0.}
proc `motion=`*(self: Physics2DTestMotionResult; val: Vector2) {.gcsafe,
    locks: 0.}
proc motionRemainder*(self: Physics2DTestMotionResult): Vector2 {.gcsafe,
    locks: 0.}
...
proc colliderId(self: Physics2DTestMotionResult): int64 =
  ...
  physics2DTestMotionResultGetColliderIdMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
var physics2DTestMotionResultGetCollisionDepthMethodBind {.threadvar.}: ptr GodotMethodBind
proc collisionDepth(self: Physics2DTestMotionResult): float64 =
  if isNil(physics2DTestMotionResultGetCollisionDepthMethodBind):
    physics2DTestMotionResultGetCollisionDepthMethodBind = getMethod(
        cstring"Physics2DTestMotionResult", cstring"get_collision_depth")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  physics2DTestMotionResultGetCollisionDepthMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)

proc `collisionDepth=`(self: Physics2DTestMotionResult; val: float64) =
  if isNil(physics2DTestMotionResultMethodBind):
    physics2DTestMotionResultMethodBind = getMethod(
        cstring"Physics2DTestMotionResult", cstring"")
  var
...
var physics2DTestMotionResultGetCollisionSafeFractionMethodBind {.threadvar.}: ptr GodotMethodBind
proc collisionSafeFraction(self: Physics2DTestMotionResult): float64 =
  if isNil(physics2DTestMotionResultGetCollisionSafeFractionMethodBind):
    physics2DTestMotionResultGetCollisionSafeFractionMethodBind = getMethod(
        cstring"Physics2DTestMotionResult",
        cstring"get_collision_safe_fraction")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  physics2DTestMotionResultGetCollisionSafeFractionMethodBind.ptrCall(
      self.godotObject, nil, ptrCallRet)
...
var physics2DTestMotionResultGetCollisionUnsafeFractionMethodBind {.threadvar.}: ptr GodotMethodBind
proc collisionUnsafeFraction(self: Physics2DTestMotionResult): float64 =
  if isNil(physics2DTestMotionResultGetCollisionUnsafeFractionMethodBind):
    physics2DTestMotionResultGetCollisionUnsafeFractionMethodBind = getMethod(
        cstring"Physics2DTestMotionResult",
        cstring"get_collision_unsafe_fraction")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  physics2DTestMotionResultGetCollisionUnsafeFractionMethodBind.ptrCall(
      self.godotObject, nil, ptrCallRet)

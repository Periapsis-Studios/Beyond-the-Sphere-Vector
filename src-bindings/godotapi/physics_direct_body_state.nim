...
proc `centerOfMass=`*(self: PhysicsDirectBodyState; val: Vector3) {.gcsafe,
    locks: 0.}
proc inverseInertia*(self: PhysicsDirectBodyState): Vector3 {.gcsafe, locks: 0.}
proc `inverseInertia=`*(self: PhysicsDirectBodyState; val: Vector3) {.gcsafe,
    locks: 0.}
proc inverseMass*(self: PhysicsDirectBodyState): float64 {.gcsafe, locks: 0.}
proc `inverseMass=`*(self: PhysicsDirectBodyState; val: float64) {.gcsafe,
    locks: 0.}
proc linearVelocity*(self: PhysicsDirectBodyState): Vector3 {.gcsafe, locks: 0.}
proc `linearVelocity=`*(self: PhysicsDirectBodyState; val: Vector3) {.gcsafe,
    locks: 0.}
proc principalInertiaAxes*(self: PhysicsDirectBodyState): Basis {.gcsafe,
    locks: 0.}
...
proc `totalGravity=`*(self: PhysicsDirectBodyState; val: Vector3) {.gcsafe,
    locks: 0.}
...
proc `transform=`*(self: PhysicsDirectBodyState; val: Transform) {.gcsafe,
    locks: 0.}
proc addCentralForce*(self: PhysicsDirectBodyState; force: Vector3) {.gcsafe,
    locks: 0.}
proc addForce*(self: PhysicsDirectBodyState; force: Vector3; position: Vector3) {.
    gcsafe, locks: 0.}
proc addTorque*(self: PhysicsDirectBodyState; torque: Vector3) {.gcsafe,
    locks: 0.}
proc applyCentralImpulse*(self: PhysicsDirectBodyState; j: Vector3) {.gcsafe,
    locks: 0.}
proc applyImpulse*(self: PhysicsDirectBodyState; position: Vector3; j: Vector3) {.
    gcsafe, locks: 0.}
proc applyTorqueImpulse*(self: PhysicsDirectBodyState; j: Vector3) {.gcsafe,
    locks: 0.}
...
proc getSpaceState*(self: PhysicsDirectBodyState): PhysicsDirectSpaceState {.
    gcsafe, locks: 0.}
proc getVelocityAtLocalPosition*(self: PhysicsDirectBodyState;
                                 localPosition: Vector3): Vector3 {.gcsafe,
    locks: 0.}
...
proc `centerOfMass=`(self: PhysicsDirectBodyState; val: Vector3) =
  if isNil(physicsDirectBodyStateMethodBind):
    physicsDirectBodyStateMethodBind = getMethod(
        cstring"PhysicsDirectBodyState", cstring"")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
var physicsDirectBodyStateGetVelocityAtLocalPositionMethodBind {.threadvar.}: ptr GodotMethodBind
proc getVelocityAtLocalPosition(self: PhysicsDirectBodyState;
                                localPosition: Vector3): Vector3 =
  if isNil(physicsDirectBodyStateGetVelocityAtLocalPositionMethodBind):
    physicsDirectBodyStateGetVelocityAtLocalPositionMethodBind = getMethod(
        cstring"PhysicsDirectBodyState",
        cstring"get_velocity_at_local_position")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(localPosition)
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  physicsDirectBodyStateGetVelocityAtLocalPositionMethodBind.ptrCall(
      self.godotObject, argsToPassToGodot, ptrCallRet)

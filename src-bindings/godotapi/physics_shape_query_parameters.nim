...
proc collideWithAreas*(self: PhysicsShapeQueryParameters): bool {.gcsafe,
    locks: 0.}
proc `collideWithAreas=`*(self: PhysicsShapeQueryParameters; val: bool) {.
    gcsafe, locks: 0.}
proc collideWithBodies*(self: PhysicsShapeQueryParameters): bool {.gcsafe,
    locks: 0.}
...
proc `exclude=`*(self: PhysicsShapeQueryParameters; val: Array) {.gcsafe,
    locks: 0.}
proc margin*(self: PhysicsShapeQueryParameters): float64 {.gcsafe, locks: 0.}
proc `margin=`*(self: PhysicsShapeQueryParameters; val: float64) {.gcsafe,
    locks: 0.}
proc shapeRid*(self: PhysicsShapeQueryParameters): RID {.gcsafe, locks: 0.}
proc `shapeRid=`*(self: PhysicsShapeQueryParameters; val: RID) {.gcsafe,
    locks: 0.}
...
proc `transform=`*(self: PhysicsShapeQueryParameters; val: Transform) {.gcsafe,
    locks: 0.}
proc setShape*(self: PhysicsShapeQueryParameters; shape: Resource) {.gcsafe,
    locks: 0.}
...
proc shapeRid(self: PhysicsShapeQueryParameters): RID =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  physicsShapeQueryParametersGetShapeRidMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)

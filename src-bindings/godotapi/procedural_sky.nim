...
proc groundCurve(self: ProceduralSky): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  proceduralSkyGetGroundCurveMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc groundEnergy(self: ProceduralSky): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  proceduralSkyGetGroundEnergyMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `skyCurve=`(self: ProceduralSky; val: float64) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  proceduralSkySetSkyCurveMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc skyHorizonColor(self: ProceduralSky): Color =
  if isNil(proceduralSkyGetSkyHorizonColorMethodBind):
    proceduralSkyGetSkyHorizonColorMethodBind = getMethod(
        cstring"ProceduralSky", cstring"get_sky_horizon_color")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
...
proc `skyHorizonColor=`(self: ProceduralSky; val: Color) =
  if isNil(proceduralSkySetSkyHorizonColorMethodBind):
    proceduralSkySetSkyHorizonColorMethodBind = getMethod(
        cstring"ProceduralSky", cstring"set_sky_horizon_color")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc skyTopColor(self: ProceduralSky): Color =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  proceduralSkyGetSkyTopColorMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc sunAngleMax(self: ProceduralSky): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  proceduralSkyGetSunAngleMaxMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc sunAngleMin(self: ProceduralSky): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  proceduralSkyGetSunAngleMinMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `sunColor=`(self: ProceduralSky; val: Color) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  proceduralSkySetSunColorMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc `sunCurve=`(self: ProceduralSky; val: float64) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  proceduralSkySetSunCurveMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc sunLatitude(self: ProceduralSky): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  proceduralSkyGetSunLatitudeMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc sunLongitude(self: ProceduralSky): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  proceduralSkyGetSunLongitudeMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc textureSize(self: ProceduralSky): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  proceduralSkyGetTextureSizeMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

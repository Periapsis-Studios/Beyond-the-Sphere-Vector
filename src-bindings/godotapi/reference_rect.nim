...
proc borderWidth*(self: ReferenceRect): float64 {.gcsafe, locks: 0.}
proc `borderWidth=`*(self: ReferenceRect; val: float64) {.gcsafe, locks: 0.}
...
proc borderColor(self: ReferenceRect): Color =
  ...
  referenceRectGetBorderColorMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
var referenceRectGetBorderWidthMethodBind {.threadvar.}: ptr GodotMethodBind
proc borderWidth(self: ReferenceRect): float64 =
  if isNil(referenceRectGetBorderWidthMethodBind):
    referenceRectGetBorderWidthMethodBind = getMethod(cstring"ReferenceRect",
        cstring"get_border_width")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  referenceRectGetBorderWidthMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

var referenceRectSetBorderWidthMethodBind {.threadvar.}: ptr GodotMethodBind
proc `borderWidth=`(self: ReferenceRect; val: float64) =
  if isNil(referenceRectSetBorderWidthMethodBind):
    referenceRectSetBorderWidthMethodBind = getMethod(cstring"ReferenceRect",
  ...
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  referenceRectSetBorderWidthMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

...
proc search*(self: RegEx; subject: string; offset: int64 = 0'i64;
             endd: int64 = -1'i64): RegExMatch {.gcsafe, locks: 0.}
proc searchAll*(self: RegEx; subject: string; offset: int64 = 0'i64;
                endd: int64 = -1'i64): Array {.gcsafe, locks: 0.}
proc sub*(self: RegEx; subject: string; replacement: string; all: bool = false;
          offset: int64 = 0'i64; endd: int64 = -1'i64): string {.gcsafe,
    locks: 0.}
...
proc searchAll(self: RegEx; subject: string; offset: int64 = 0'i64;
  ...
  initGodotArray(ptrCallVal)
  ptrCallRet = addr(ptrCallVal)
  regExSearchAllMethodBind.ptrCall(self.godotObject, argsToPassToGodot,
                                   ptrCallRet)
  deinit(argToPassToGodot0)
  result = newArray(ptrCallVal)

...
proc getEnd*(self: RegExMatch; name: Variant = newVariant(0)): int64 {.gcsafe,
    locks: 0.}
proc getGroupCount*(self: RegExMatch): int64 {.gcsafe, locks: 0.}
proc getStart*(self: RegExMatch; name: Variant = newVariant(0)): int64 {.gcsafe,
    locks: 0.}
...
proc getEnd(self: RegExMatch; name: Variant = newVariant(0)): int64 =
  if isNil(regExMatchGetEndMethodBind):
    regExMatchGetEndMethodBind = getMethod(cstring"RegExMatch",
        cstring"get_end")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)

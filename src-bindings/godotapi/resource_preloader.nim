...
proc addResource*(self: ResourcePreloader; name: string; resource: Resource) {.
    gcsafe, locks: 0.}
proc getResource*(self: ResourcePreloader; name: string): Resource {.gcsafe,
    locks: 0.}
proc getResourceList*(self: ResourcePreloader): PoolStringArray {.gcsafe,
    locks: 0.}
proc hasResource*(self: ResourcePreloader; name: string): bool {.gcsafe,
    locks: 0.}

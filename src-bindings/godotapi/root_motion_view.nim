...
proc animationPath(self: RootMotionView): NodePath =
  if isNil(rootMotionViewGetAnimationPathMethodBind):
    rootMotionViewGetAnimationPathMethodBind = getMethod(
        cstring"RootMotionView", cstring"get_animation_path")
...
proc `animationPath=`(self: RootMotionView; val: NodePath) =
  if isNil(rootMotionViewSetAnimationPathMethodBind):
    rootMotionViewSetAnimationPathMethodBind = getMethod(
        cstring"RootMotionView", cstring"set_animation_path")
  var

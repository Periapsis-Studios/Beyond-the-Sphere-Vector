...
proc getConnectionMethod*(self: SceneState; idx: int64): string {.gcsafe,
    locks: 0.}
proc getConnectionSignal*(self: SceneState; idx: int64): string {.gcsafe,
    locks: 0.}
proc getConnectionSource*(self: SceneState; idx: int64): NodePath {.gcsafe,
    locks: 0.}
proc getConnectionTarget*(self: SceneState; idx: int64): NodePath {.gcsafe,
    locks: 0.}
proc getNodeCount*(self: SceneState): int64 {.gcsafe, locks: 0.}
proc getNodeGroups*(self: SceneState; idx: int64): PoolStringArray {.gcsafe,
    locks: 0.}
proc getNodeIndex*(self: SceneState; idx: int64): int64 {.gcsafe, locks: 0.}
proc getNodeInstance*(self: SceneState; idx: int64): PackedScene {.gcsafe,
    locks: 0.}
...
proc getNodeOwnerPath*(self: SceneState; idx: int64): NodePath {.gcsafe,
    locks: 0.}
proc getNodePath*(self: SceneState; idx: int64; forParent: bool = false): NodePath {.
    gcsafe, locks: 0.}
proc getNodePropertyCount*(self: SceneState; idx: int64): int64 {.gcsafe,
    locks: 0.}
...
proc isNodeInstancePlaceholder*(self: SceneState; idx: int64): bool {.gcsafe,
    locks: 0.}
...
proc getConnectionCount(self: SceneState): int64 =
  ...
  sceneStateGetConnectionCountMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

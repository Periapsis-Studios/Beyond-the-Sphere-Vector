...
method browsePath*(self: ScriptCreateDialog; arg0: bool; arg1: bool) {.gcsafe,
    locks: 0, base.}
method builtInPressed*(self: ScriptCreateDialog) {.gcsafe, locks: 0, base.}
method classNameChanged*(self: ScriptCreateDialog; arg0: string) {.gcsafe,
    locks: 0, base.}
method create*(self: ScriptCreateDialog) {.gcsafe, locks: 0, base.}
method fileSelected*(self: ScriptCreateDialog; arg0: string) {.gcsafe, locks: 0,
    base.}
method langChanged*(self: ScriptCreateDialog; arg0: int64) {.gcsafe, locks: 0,
    base.}
method parentNameChanged*(self: ScriptCreateDialog; arg0: string) {.gcsafe,
    locks: 0, base.}
method pathChanged*(self: ScriptCreateDialog; arg0: string) {.gcsafe, locks: 0,
    base.}
method pathEntered*(self: ScriptCreateDialog; arg0: string) {.gcsafe, locks: 0,
    base.}
method pathHboxSorted*(self: ScriptCreateDialog) {.gcsafe, locks: 0, base.}
method templateChanged*(self: ScriptCreateDialog; arg0: int64) {.gcsafe,
    locks: 0, base.}
proc config*(self: ScriptCreateDialog; inherits: string; path: string;
             builtInEnabled: bool = true; loadEnabled: bool = true) {.gcsafe,
    locks: 0.}
...
proc config(self: ScriptCreateDialog; inherits: string; path: string;
  ...
  var ptrCallRet: pointer
  scriptCreateDialogConfigMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
  deinit(argToPassToGodot0)

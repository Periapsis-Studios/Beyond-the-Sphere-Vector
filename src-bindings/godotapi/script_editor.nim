...
method breaked*(self: ScriptEditor; arg0: bool; arg1: bool) {.gcsafe, locks: 0,
    base.}
method clearExecution*(self: ScriptEditor; arg0: Reference) {.gcsafe, locks: 0,
    base.}
method closeAllTabs*(self: ScriptEditor) {.gcsafe, locks: 0, base.}
method closeCurrentTab*(self: ScriptEditor; arg0: bool) {.gcsafe, locks: 0, base.}
method closeDiscardCurrentTab*(self: ScriptEditor; arg0: string) {.gcsafe,
    locks: 0, base.}
...
method fileDialogAction*(self: ScriptEditor; arg0: string) {.gcsafe, locks: 0,
    base.}
method filterMethodsTextChanged*(self: ScriptEditor; arg0: string) {.gcsafe,
    locks: 0, base.}
method filterScriptsTextChanged*(self: ScriptEditor; arg0: string) {.gcsafe,
    locks: 0, base.}
...
method gotoScriptLine*(self: ScriptEditor; arg0: Reference; arg1: int64) {.
    gcsafe, locks: 0, base.}
method gotoScriptLine2*(self: ScriptEditor; arg0: int64) {.gcsafe, locks: 0,
    base.}
...
method helpOverviewSelected*(self: ScriptEditor; arg0: int64) {.gcsafe,
    locks: 0, base.}
...
method input*(self: ScriptEditor; event: InputEvent) {.gcsafe, locks: 0.}
method liveAutoReloadRunningScripts*(self: ScriptEditor) {.gcsafe, locks: 0,
    base.}
method membersOverviewSelected*(self: ScriptEditor; arg0: int64) {.gcsafe,
    locks: 0, base.}
...
method onFindInFilesModifiedFiles*(self: ScriptEditor; arg0: PoolStringArray) {.
    gcsafe, locks: 0, base.}
method onFindInFilesRequested*(self: ScriptEditor; arg0: string) {.gcsafe,
    locks: 0, base.}
method onFindInFilesResultSelected*(self: ScriptEditor; arg0: string;
                                    arg1: int64; arg2: int64; arg3: int64) {.
    gcsafe, locks: 0, base.}
method openRecentScript*(self: ScriptEditor; arg0: int64) {.gcsafe, locks: 0,
    base.}
method queueCloseTabs*(self: ScriptEditor) {.gcsafe, locks: 0, base.}
...
method resSavedCallback*(self: ScriptEditor; arg0: Resource) {.gcsafe, locks: 0,
    base.}
...
method scriptListGuiInput*(self: ScriptEditor; arg0: InputEvent) {.gcsafe,
    locks: 0, base.}
method scriptSelected*(self: ScriptEditor; arg0: int64) {.gcsafe, locks: 0, base.}
method scriptSplitDragged*(self: ScriptEditor; arg0: float64) {.gcsafe,
    locks: 0, base.}
...
method startFindInFiles*(self: ScriptEditor; arg0: bool) {.gcsafe, locks: 0,
    base.}
...
proc canDropDataFw*(self: ScriptEditor; point: Vector2; data: Variant;
                    fromm: Control): bool {.gcsafe, locks: 0.}
proc dropDataFw*(self: ScriptEditor; point: Vector2; data: Variant;
...
proc openScriptCreateDialog*(self: ScriptEditor; baseName: string;
                             basePath: string) {.gcsafe, locks: 0.}
...
method closeCurrentTab(self: ScriptEditor; arg0: bool) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(arg0)
  var ptrCallRet: pointer
  scriptEditorUnderscorecloseCurrentTabMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
method editorPlay(self: ScriptEditor) =
  if isNil(scriptEditorUnderscoreeditorPlayMethodBind):
    scriptEditorUnderscoreeditorPlayMethodBind = getMethod(
        cstring"ScriptEditor", cstring"_editor_play")
  var ptrCallRet: pointer
...
method editorStop(self: ScriptEditor) =
  if isNil(scriptEditorUnderscoreeditorStopMethodBind):
    scriptEditorUnderscoreeditorStopMethodBind = getMethod(
        cstring"ScriptEditor", cstring"_editor_stop")
  var ptrCallRet: pointer
...
method helpSearch(self: ScriptEditor; arg0: string) =
  if isNil(scriptEditorUnderscorehelpSearchMethodBind):
    scriptEditorUnderscorehelpSearchMethodBind = getMethod(
        cstring"ScriptEditor", cstring"_help_search")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  var argToPassToGodot0 = toGodotString(arg0)
...
var scriptEditorUnderscoreinputMethodBind {.threadvar.}: ptr GodotMethodBind
method input(self: ScriptEditor; event: InputEvent) =
  if isNil(scriptEditorUnderscoreinputMethodBind):
    scriptEditorUnderscoreinputMethodBind = getMethod(cstring"ScriptEditor",
        cstring"_input")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  ...
  argsToPassToGodot[][0] = argToPassToGodot0
  var ptrCallRet: pointer
  scriptEditorUnderscoreinputMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
method menuOption(self: ScriptEditor; arg0: int64) =
  if isNil(scriptEditorUnderscoremenuOptionMethodBind):
    scriptEditorUnderscoremenuOptionMethodBind = getMethod(
        cstring"ScriptEditor", cstring"_menu_option")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(arg0)
...
var scriptEditorUnderscorequeueCloseTabsMethodBind {.threadvar.}: ptr GodotMethodBind
method queueCloseTabs(self: ScriptEditor) =
  if isNil(scriptEditorUnderscorequeueCloseTabsMethodBind):
    scriptEditorUnderscorequeueCloseTabsMethodBind = getMethod(
        cstring"ScriptEditor", cstring"_queue_close_tabs")
  var ptrCallRet: pointer
  scriptEditorUnderscorequeueCloseTabsMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
method tabChanged(self: ScriptEditor; arg0: int64) =
  if isNil(scriptEditorUnderscoretabChangedMethodBind):
    scriptEditorUnderscoretabChangedMethodBind = getMethod(
        cstring"ScriptEditor", cstring"_tab_changed")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(arg0)
...
proc getCurrentScript(self: ScriptEditor): Script =
  ...
  ptrCallRet = addr(ptrCallVal)
  scriptEditorGetCurrentScriptMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

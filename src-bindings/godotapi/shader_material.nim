...
proc getShaderParam*(self: ShaderMaterial; param: string): Variant {.gcsafe,
    locks: 0.}
proc propertyCanRevert*(self: ShaderMaterial; name: string): bool {.gcsafe,
    locks: 0.}
proc propertyGetRevert*(self: ShaderMaterial; name: string): Variant {.gcsafe,
    locks: 0.}

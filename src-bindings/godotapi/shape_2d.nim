...
proc collideAndGetContacts*(self: Shape2D; localXform: Transform2D;
    ...
    gcsafe, locks: 0.}
proc collideWithMotion*(self: Shape2D; localXform: Transform2D;
                        localMotion: Vector2; withShape: Shape2D;
                        shapeXform: Transform2D; shapeMotion: Vector2): bool {.
    gcsafe, locks: 0.}
proc collideWithMotionAndGetContacts*(self: Shape2D; localXform: Transform2D;
                                      localMotion: Vector2; withShape: Shape2D;
                                      shapeXform: Transform2D;
                                      shapeMotion: Vector2): Array {.gcsafe,
    locks: 0.}
...
proc collide(self: Shape2D; localXform: Transform2D; withShape: Shape2D;
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  shape2DCollideMethodBind.ptrCall(self.godotObject, argsToPassToGodot,
                                   ptrCallRet)
...
proc collideWithMotion(self: Shape2D; localXform: Transform2D;
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  shape2DCollideWithMotionMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

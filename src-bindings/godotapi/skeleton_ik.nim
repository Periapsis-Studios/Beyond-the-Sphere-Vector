...
proc magnet(self: SkeletonIK): Vector3 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  skeletonIKGetMagnetPositionMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `minDistance=`(self: SkeletonIK; val: float64) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  skeletonIKSetMinDistanceMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc overrideTipBasis(self: SkeletonIK): bool =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  skeletonIKIsOverrideTipBasisMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc target(self: SkeletonIK): Transform =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  skeletonIKGetTargetTransformMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc getParentSkeleton(self: SkeletonIK): Skeleton =
  ...
  ptrCallRet = addr(ptrCallVal)
  skeletonIKGetParentSkeletonMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

...
proc `angularLimitlowerAngle=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
proc angularLimitrestitution*(self: SliderJoint): float64 {.gcsafe, locks: 0.}
proc `angularLimitrestitution=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
proc angularLimitsoftness*(self: SliderJoint): float64 {.gcsafe, locks: 0.}
proc `angularLimitsoftness=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
proc angularLimitupperAngle*(self: SliderJoint): float64 {.gcsafe, locks: 0.}
proc `angularLimitupperAngle=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
proc angularMotiondamping*(self: SliderJoint): float64 {.gcsafe, locks: 0.}
proc `angularMotiondamping=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
proc angularMotionrestitution*(self: SliderJoint): float64 {.gcsafe, locks: 0.}
proc `angularMotionrestitution=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
proc angularMotionsoftness*(self: SliderJoint): float64 {.gcsafe, locks: 0.}
proc `angularMotionsoftness=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
...
proc `angularOrthorestitution=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
proc angularOrthosoftness*(self: SliderJoint): float64 {.gcsafe, locks: 0.}
proc `angularOrthosoftness=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
...
proc `linearLimitlowerDistance=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
proc linearLimitrestitution*(self: SliderJoint): float64 {.gcsafe, locks: 0.}
proc `linearLimitrestitution=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
...
proc `linearLimitupperDistance=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
...
proc `linearMotionrestitution=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
proc linearMotionsoftness*(self: SliderJoint): float64 {.gcsafe, locks: 0.}
proc `linearMotionsoftness=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}
...
proc `linearOrthorestitution=`*(self: SliderJoint; val: float64) {.gcsafe,
    locks: 0.}

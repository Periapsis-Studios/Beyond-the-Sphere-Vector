...
proc `anisotropyFlowmap=`*(self: SpatialMaterial; val: Texture) {.gcsafe,
    locks: 0.}
...
proc `clearcoatTexture=`*(self: SpatialMaterial; val: Texture) {.gcsafe,
    locks: 0.}
...
proc `flagsAlbedoTexForceSrgb=`*(self: SpatialMaterial; val: bool) {.gcsafe,
    locks: 0.}
proc flagsDisableAmbientLight*(self: SpatialMaterial): bool {.gcsafe, locks: 0.}
proc `flagsDisableAmbientLight=`*(self: SpatialMaterial; val: bool) {.gcsafe,
    locks: 0.}
proc flagsDoNotReceiveShadows*(self: SpatialMaterial): bool {.gcsafe, locks: 0.}
proc `flagsDoNotReceiveShadows=`*(self: SpatialMaterial; val: bool) {.gcsafe,
    locks: 0.}
...
proc `flagsUseShadowToOpacity=`*(self: SpatialMaterial; val: bool) {.gcsafe,
    locks: 0.}
proc flagsVertexLighting*(self: SpatialMaterial): bool {.gcsafe, locks: 0.}
proc `flagsVertexLighting=`*(self: SpatialMaterial; val: bool) {.gcsafe,
    locks: 0.}
proc flagsWorldTriplanar*(self: SpatialMaterial): bool {.gcsafe, locks: 0.}
proc `flagsWorldTriplanar=`*(self: SpatialMaterial; val: bool) {.gcsafe,
    locks: 0.}
...
proc `metallicSpecular=`*(self: SpatialMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `metallicTextureChannel=`*(self: SpatialMaterial; val: int64) {.gcsafe,
    locks: 0.}
...
proc paramsAlphaScissorThreshold*(self: SpatialMaterial): float64 {.gcsafe,
    locks: 0.}
...
proc `paramsBillboardKeepScale=`*(self: SpatialMaterial; val: bool) {.gcsafe,
    locks: 0.}
proc paramsBillboardMode*(self: SpatialMaterial): int64 {.gcsafe, locks: 0.}
proc `paramsBillboardMode=`*(self: SpatialMaterial; val: int64) {.gcsafe,
    locks: 0.}
...
proc `paramsDepthDrawMode=`*(self: SpatialMaterial; val: int64) {.gcsafe,
    locks: 0.}
...
proc `paramsGrowAmount=`*(self: SpatialMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `paramsSpecularMode=`*(self: SpatialMaterial; val: int64) {.gcsafe,
    locks: 0.}
proc paramsUseAlphaScissor*(self: SpatialMaterial): bool {.gcsafe, locks: 0.}
proc `paramsUseAlphaScissor=`*(self: SpatialMaterial; val: bool) {.gcsafe,
    locks: 0.}
proc particlesAnimHFrames*(self: SpatialMaterial): int64 {.gcsafe, locks: 0.}
proc `particlesAnimHFrames=`*(self: SpatialMaterial; val: int64) {.gcsafe,
    locks: 0.}
...
proc `particlesAnimVFrames=`*(self: SpatialMaterial; val: int64) {.gcsafe,
    locks: 0.}
proc proximityFadeDistance*(self: SpatialMaterial): float64 {.gcsafe, locks: 0.}
proc `proximityFadeDistance=`*(self: SpatialMaterial; val: float64) {.gcsafe,
    locks: 0.}
proc proximityFadeEnable*(self: SpatialMaterial): bool {.gcsafe, locks: 0.}
proc `proximityFadeEnable=`*(self: SpatialMaterial; val: bool) {.gcsafe,
    locks: 0.}
...
proc `refractionTexture=`*(self: SpatialMaterial; val: Texture) {.gcsafe,
    locks: 0.}
...
proc `roughnessTexture=`*(self: SpatialMaterial; val: Texture) {.gcsafe,
    locks: 0.}
proc roughnessTextureChannel*(self: SpatialMaterial): int64 {.gcsafe, locks: 0.}
proc `roughnessTextureChannel=`*(self: SpatialMaterial; val: int64) {.gcsafe,
    locks: 0.}
proc subsurfScatterEnabled*(self: SpatialMaterial): bool {.gcsafe, locks: 0.}
proc `subsurfScatterEnabled=`*(self: SpatialMaterial; val: bool) {.gcsafe,
    locks: 0.}
...
proc `subsurfScatterTexture=`*(self: SpatialMaterial; val: Texture) {.gcsafe,
    locks: 0.}
...
proc `transmissionEnabled=`*(self: SpatialMaterial; val: bool) {.gcsafe,
    locks: 0.}
proc transmissionTexture*(self: SpatialMaterial): Texture {.gcsafe, locks: 0.}
proc `transmissionTexture=`*(self: SpatialMaterial; val: Texture) {.gcsafe,
    locks: 0.}
...
proc `uv1TriplanarSharpness=`*(self: SpatialMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `uv2TriplanarSharpness=`*(self: SpatialMaterial; val: float64) {.gcsafe,
    locks: 0.}
...
proc `vertexColorUseAsAlbedo=`*(self: SpatialMaterial; val: bool) {.gcsafe,
    locks: 0.}
...
proc `albedoColor=`(self: SpatialMaterial; val: Color) =
  ...
  var ptrCallRet: pointer
  spatialMaterialSetAlbedoMethodBind.ptrCall(self.godotObject,
...
proc anisotropy(self: SpatialMaterial): float64 =
  if isNil(spatialMaterialGetAnisotropyMethodBind):
    spatialMaterialGetAnisotropyMethodBind = getMethod(
        cstring"SpatialMaterial", cstring"get_anisotropy")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spatialMaterialGetAnisotropyMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `anisotropy=`(self: SpatialMaterial; val: float64) =
  if isNil(spatialMaterialSetAnisotropyMethodBind):
    spatialMaterialSetAnisotropyMethodBind = getMethod(
        cstring"SpatialMaterial", cstring"set_anisotropy")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc clearcoat(self: SpatialMaterial): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spatialMaterialGetClearcoatMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc depthFlipBinormal(self: SpatialMaterial): bool =
  if isNil(spatialMaterialGetDepthDeepParallaxFlipBinormalMethodBind):
    spatialMaterialGetDepthDeepParallaxFlipBinormalMethodBind = getMethod(
        cstring"SpatialMaterial",
        cstring"get_depth_deep_parallax_flip_binormal")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
...
proc `depthFlipBinormal=`(self: SpatialMaterial; val: bool) =
  if isNil(spatialMaterialSetDepthDeepParallaxFlipBinormalMethodBind):
    spatialMaterialSetDepthDeepParallaxFlipBinormalMethodBind = getMethod(
        cstring"SpatialMaterial",
        cstring"set_depth_deep_parallax_flip_binormal")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc depthScale(self: SpatialMaterial): float64 =
  if isNil(spatialMaterialGetDepthScaleMethodBind):
    spatialMaterialGetDepthScaleMethodBind = getMethod(
        cstring"SpatialMaterial", cstring"get_depth_scale")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spatialMaterialGetDepthScaleMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `depthScale=`(self: SpatialMaterial; val: float64) =
  if isNil(spatialMaterialSetDepthScaleMethodBind):
    spatialMaterialSetDepthScaleMethodBind = getMethod(
        cstring"SpatialMaterial", cstring"set_depth_scale")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc normalScale(self: SpatialMaterial): float64 =
  if isNil(spatialMaterialGetNormalScaleMethodBind):
    spatialMaterialGetNormalScaleMethodBind = getMethod(
        cstring"SpatialMaterial", cstring"get_normal_scale")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
...
proc `normalScale=`(self: SpatialMaterial; val: float64) =
  if isNil(spatialMaterialSetNormalScaleMethodBind):
    spatialMaterialSetNormalScaleMethodBind = getMethod(
        cstring"SpatialMaterial", cstring"set_normal_scale")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc paramsBlendMode(self: SpatialMaterial): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spatialMaterialGetBlendModeMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc paramsDiffuseMode(self: SpatialMaterial): int64 =
  if isNil(spatialMaterialGetDiffuseModeMethodBind):
    spatialMaterialGetDiffuseModeMethodBind = getMethod(
        cstring"SpatialMaterial", cstring"get_diffuse_mode")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
...
proc `paramsDiffuseMode=`(self: SpatialMaterial; val: int64) =
  if isNil(spatialMaterialSetDiffuseModeMethodBind):
    spatialMaterialSetDiffuseModeMethodBind = getMethod(
        cstring"SpatialMaterial", cstring"set_diffuse_mode")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc paramsGrow(self: SpatialMaterial): bool =
  if isNil(spatialMaterialIsGrowEnabledMethodBind):
    spatialMaterialIsGrowEnabledMethodBind = getMethod(
        cstring"SpatialMaterial", cstring"is_grow_enabled")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spatialMaterialIsGrowEnabledMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `paramsGrow=`(self: SpatialMaterial; val: bool) =
  if isNil(spatialMaterialSetGrowEnabledMethodBind):
    spatialMaterialSetGrowEnabledMethodBind = getMethod(
        cstring"SpatialMaterial", cstring"set_grow_enabled")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc paramsLineWidth(self: SpatialMaterial): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spatialMaterialGetLineWidthMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc paramsPointSize(self: SpatialMaterial): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spatialMaterialGetPointSizeMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc particlesAnimHFrames(self: SpatialMaterial): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spatialMaterialGetParticlesAnimHFramesMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
proc particlesAnimVFrames(self: SpatialMaterial): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spatialMaterialGetParticlesAnimVFramesMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
proc refractionScale(self: SpatialMaterial): float64 =
  if isNil(spatialMaterialGetRefractionMethodBind):
    spatialMaterialGetRefractionMethodBind = getMethod(
        cstring"SpatialMaterial", cstring"get_refraction")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spatialMaterialGetRefractionMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `refractionScale=`(self: SpatialMaterial; val: float64) =
  if isNil(spatialMaterialSetRefractionMethodBind):
    spatialMaterialSetRefractionMethodBind = getMethod(
        cstring"SpatialMaterial", cstring"set_refraction")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
...
proc roughness(self: SpatialMaterial): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spatialMaterialGetRoughnessMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc uv1Offset(self: SpatialMaterial): Vector3 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spatialMaterialGetUv1OffsetMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc uv2Offset(self: SpatialMaterial): Vector3 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spatialMaterialGetUv2OffsetMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

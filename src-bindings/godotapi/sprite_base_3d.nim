...
proc alphaCut(self: SpriteBase3D): int64 =
  ...
  spriteBase3DGetAlphaCutModeMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc billboard(self: SpriteBase3D): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  spriteBase3DGetBillboardModeMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc `pixelSize=`(self: SpriteBase3D; val: float64) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  spriteBase3DSetPixelSizeMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc generateTriangleMesh(self: SpriteBase3D): TriangleMesh =
  if isNil(spriteBase3DGenerateTriangleMeshMethodBind):
    spriteBase3DGenerateTriangleMeshMethodBind = getMethod(
        cstring"SpriteBase3D", cstring"generate_triangle_mesh")
  var ptrCallRet: pointer

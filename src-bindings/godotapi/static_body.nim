...
proc `constantAngularVelocity=`*(self: StaticBody; val: Vector3) {.gcsafe,
    locks: 0.}
proc constantLinearVelocity*(self: StaticBody): Vector3 {.gcsafe, locks: 0.}
proc `constantLinearVelocity=`*(self: StaticBody; val: Vector3) {.gcsafe,
    locks: 0.}
proc friction*(self: StaticBody): float64 {.gcsafe, locks: 0.}
proc `friction=`*(self: StaticBody; val: float64) {.gcsafe, locks: 0.}
proc physicsMaterialOverride*(self: StaticBody): PhysicsMaterial {.gcsafe,
    locks: 0.}

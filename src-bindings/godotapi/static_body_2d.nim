...
proc `constantAngularVelocity=`*(self: StaticBody2D; val: float64) {.gcsafe,
    locks: 0.}
proc constantLinearVelocity*(self: StaticBody2D): Vector2 {.gcsafe, locks: 0.}
proc `constantLinearVelocity=`*(self: StaticBody2D; val: Vector2) {.gcsafe,
    locks: 0.}
proc friction*(self: StaticBody2D): float64 {.gcsafe, locks: 0.}
proc `friction=`*(self: StaticBody2D; val: float64) {.gcsafe, locks: 0.}
proc physicsMaterialOverride*(self: StaticBody2D): PhysicsMaterial {.gcsafe,
    locks: 0.}
proc `physicsMaterialOverride=`*(self: StaticBody2D; val: PhysicsMaterial) {.
    gcsafe, locks: 0.}
method reloadPhysicsCharacteristics*(self: StaticBody2D) {.gcsafe, locks: 0,
    base.}
...
proc constantAngularVelocity(self: StaticBody2D): float64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  staticBody2DGetConstantAngularVelocityMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)
...
proc physicsMaterialOverride(self: StaticBody2D): PhysicsMaterial =
  ...
  staticBody2DGetPhysicsMaterialOverrideMethodBind.ptrCall(self.godotObject,
      nil, ptrCallRet)

...
proc commit*(self: SurfaceTool; existing: ArrayMesh = nil;
             flags: int64 = 2194432'i64): ArrayMesh {.gcsafe, locks: 0.}
proc commitToArrays*(self: SurfaceTool): Array {.gcsafe, locks: 0.}
proc createFrom*(self: SurfaceTool; existing: Mesh; surface: int64) {.gcsafe,
    locks: 0.}
...
proc addUv(self: SurfaceTool; uv: Vector2) =
  if isNil(surfaceToolAddUvMethodBind):
    surfaceToolAddUvMethodBind = getMethod(cstring"SurfaceTool",
        cstring"add_uv")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc addUv2(self: SurfaceTool; uv2: Vector2) =
  if isNil(surfaceToolAddUv2MethodBind):
    surfaceToolAddUv2MethodBind = getMethod(cstring"SurfaceTool",
        cstring"add_uv2")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc commit(self: SurfaceTool; existing: ArrayMesh = nil;
            flags: int64 = 2194432'i64): ArrayMesh =
  if isNil(surfaceToolCommitMethodBind):
    surfaceToolCommitMethodBind = getMethod(cstring"SurfaceTool",
        cstring"commit")
  var
...
proc generateTangents(self: SurfaceTool) =
  ...
  var ptrCallRet: pointer
  surfaceToolGenerateTangentsMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)

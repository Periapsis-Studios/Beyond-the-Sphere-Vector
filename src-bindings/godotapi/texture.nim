...
proc draw*(self: Texture; canvasItem: RID; position: Vector2;
           ...
           transpose: bool = false; normalMap: Texture = nil) {.gcsafe, locks: 0.}
proc drawRect*(self: Texture; canvasItem: RID; rect: Rect2; tile: bool;
               modulate: Color = initColor(1.0, 1.0, 1.0, 1.0);
               transpose: bool = false; normalMap: Texture = nil) {.gcsafe,
    locks: 0.}
proc drawRectRegion*(self: Texture; canvasItem: RID; rect: Rect2;
                     srcRect: Rect2;
                     modulate: Color = initColor(1.0, 1.0, 1.0, 1.0);
...
proc getHeight(self: Texture): int64 =
  if isNil(textureGetHeightMethodBind):
    textureGetHeightMethodBind = getMethod(cstring"Texture",
        cstring"get_height")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)

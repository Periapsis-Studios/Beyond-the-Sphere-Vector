...
const
  FLAGS_DEFAULT_TEXTURE_3D* = 4'i64
  FLAGS_DEFAULT_TEXTURE_ARRAY* = 7'i64
...
proc setDataPartial*(self: TextureLayered; image: Image; xOffset: int64;
                     yOffset: int64; layer: int64; mipmap: int64 = 0'i64) {.
    gcsafe, locks: 0.}
proc setLayerData*(self: TextureLayered; image: Image; layer: int64) {.gcsafe,
    locks: 0.}

...
method forwardAtlasSubtileSelection*(self: TileSet; atlastileId: int64;
    ...
    gcsafe, locks: 0, base.}
method forwardSubtileSelection*(self: TileSet; autotileId: int64;
                                bitmask: int64; tilemap: Object;
                                tileLocation: Vector2): Vector2 {.gcsafe,
    locks: 0, base.}
...
proc autotileGetIconCoordinate*(self: TileSet; id: int64): Vector2 {.gcsafe,
    locks: 0.}
...
proc autotileSetBitmask*(self: TileSet; id: int64; bitmask: Vector2; flag: int64) {.
    gcsafe, locks: 0.}
proc autotileSetBitmaskMode*(self: TileSet; id: int64; mode: int64) {.gcsafe,
    locks: 0.}
...
proc autotileSetSize*(self: TileSet; id: int64; size: Vector2) {.gcsafe,
    locks: 0.}
proc autotileSetSpacing*(self: TileSet; id: int64; spacing: int64) {.gcsafe,
    locks: 0.}
...
proc tileGetLightOccluder*(self: TileSet; id: int64): OccluderPolygon2D {.
    gcsafe, locks: 0.}
proc tileGetMaterial*(self: TileSet; id: int64): ShaderMaterial {.gcsafe,
    locks: 0.}
...
proc tileGetOccluderOffset*(self: TileSet; id: int64): Vector2 {.gcsafe,
    locks: 0.}
proc tileGetRegion*(self: TileSet; id: int64): Rect2 {.gcsafe, locks: 0.}
proc tileGetShape*(self: TileSet; id: int64; shapeId: int64): Shape2D {.gcsafe,
    locks: 0.}
...
proc tileSetLightOccluder*(self: TileSet; id: int64;
                           lightOccluder: OccluderPolygon2D) {.gcsafe, locks: 0.}
...
proc tileSetNavigationPolygonOffset*(self: TileSet; id: int64;
    ...
    locks: 0.}
proc tileSetNormalMap*(self: TileSet; id: int64; normalMap: Texture) {.gcsafe,
    locks: 0.}
...
proc tileSetShape*(self: TileSet; id: int64; shapeId: int64; shape: Shape2D) {.
    gcsafe, locks: 0.}
proc tileSetShapeOffset*(self: TileSet; id: int64; shapeId: int64;
                         shapeOffset: Vector2) {.gcsafe, locks: 0.}
...
proc tileSetTexture*(self: TileSet; id: int64; texture: Texture) {.gcsafe,
    locks: 0.}
proc tileSetTextureOffset*(self: TileSet; id: int64; textureOffset: Vector2) {.
    gcsafe, locks: 0.}
proc tileSetTileMode*(self: TileSet; id: int64; tilemode: int64) {.gcsafe,
    locks: 0.}
...
proc autotileGetZIndex(self: TileSet; id: int64; coord: Vector2): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  tileSetAutotileGetZIndexMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc autotileSetZIndex(self: TileSet; id: int64; coord: Vector2; zIndex: int64) =
  ...
  var ptrCallRet: pointer
  tileSetAutotileSetZIndexMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc createTile(self: TileSet; id: int64) =
  if isNil(tileSetCreateTileMethodBind):
    tileSetCreateTileMethodBind = getMethod(cstring"TileSet",
        cstring"create_tile")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc removeTile(self: TileSet; id: int64) =
  if isNil(tileSetRemoveTileMethodBind):
    tileSetRemoveTileMethodBind = getMethod(cstring"TileSet",
        cstring"remove_tile")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc tileGetNavigationPolygonOffset(self: TileSet; id: int64): Vector2 =
  if isNil(tileSetTileGetNavigationPolygonOffsetMethodBind):
    tileSetTileGetNavigationPolygonOffsetMethodBind = getMethod(
        cstring"TileSet", cstring"tile_get_navigation_polygon_offset")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(id)
...
proc tileGetShapeCount(self: TileSet; id: int64): int64 =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  tileSetTileGetShapeCountMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc tileSetNavigationPolygonOffset(self: TileSet; id: int64;
  ...
  if isNil(tileSetTileSetNavigationPolygonOffsetMethodBind):
    tileSetTileSetNavigationPolygonOffsetMethodBind = getMethod(
        cstring"TileSet", cstring"tile_set_navigation_polygon_offset")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(id)

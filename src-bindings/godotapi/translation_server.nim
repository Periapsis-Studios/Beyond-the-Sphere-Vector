...
proc getLocale(): string =
  ...
  if isNil(translationServerGetLocaleMethodBind):
    translationServerGetLocaleMethodBind = getMethod(
        cstring"TranslationServer", cstring"get_locale")
  var ptrCallRet: pointer
...
proc setLocale(locale: string) =
  ...
  if isNil(translationServerSetLocaleMethodBind):
    translationServerSetLocaleMethodBind = getMethod(
        cstring"TranslationServer", cstring"set_locale")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  var argToPassToGodot0 = toGodotString(locale)
...
proc translate(message: string): string =
  ...
  if isNil(translationServerTranslateMethodBind):
    translationServerTranslateMethodBind = getMethod(
        cstring"TranslationServer", cstring"translate")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)

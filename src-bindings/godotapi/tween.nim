...
proc followMethod*(self: Tween; objectt: Object; methodd: string;
                   initialVal: Variant; target: Object; targetMethod: string;
...
proc followProperty*(self: Tween; objectt: Object; property: NodePath;
                     initialVal: Variant; target: Object;
                     targetProperty: NodePath; duration: float64;
...
proc interpolateCallback*(self: Tween; objectt: Object; duration: float64;
                          ...
                          arg5: Variant = newVariant()): bool {.gcsafe, locks: 0.}
proc interpolateDeferredCallback*(self: Tween; objectt: Object;
                                  duration: float64; callback: string;
                                  arg1: Variant = newVariant();
                                  arg2: Variant = newVariant();
                                  arg3: Variant = newVariant();
                                  arg4: Variant = newVariant();
...
proc interpolateMethod*(self: Tween; objectt: Object; methodd: string;
                        initialVal: Variant; finalVal: Variant;
                        duration: float64; transType: int64 = 0'i64;
                        easeType: int64 = 2'i64; delay: float64 = 0.0): bool {.
    gcsafe, locks: 0.}
...
proc remove*(self: Tween; objectt: Object; key: string = ""): bool {.gcsafe,
    locks: 0.}
proc removeAll*(self: Tween): bool {.gcsafe, locks: 0.}
proc reset*(self: Tween; objectt: Object; key: string = ""): bool {.gcsafe,
    locks: 0.}
proc resetAll*(self: Tween): bool {.gcsafe, locks: 0.}
proc resume*(self: Tween; objectt: Object; key: string = ""): bool {.gcsafe,
    locks: 0.}
...
proc stop*(self: Tween; objectt: Object; key: string = ""): bool {.gcsafe,
    locks: 0.}
proc stopAll*(self: Tween): bool {.gcsafe, locks: 0.}
proc targetingMethod*(self: Tween; objectt: Object; methodd: string;
                      initial: Object; initialMethod: string; finalVal: Variant;
                      duration: float64; transType: int64 = 0'i64;
                      easeType: int64 = 2'i64; delay: float64 = 0.0): bool {.
    gcsafe, locks: 0.}
proc targetingProperty*(self: Tween; objectt: Object; property: NodePath;
                        initial: Object; initialVal: NodePath;
                        finalVal: Variant; duration: float64;
                        transType: int64 = 0'i64; easeType: int64 = 2'i64;
                        delay: float64 = 0.0): bool {.gcsafe, locks: 0.}
...
proc `playbackProcessMode=`(self: Tween; val: int64) =
  ...
  var ptrCallRet: pointer
  tweenSetTweenProcessModeMethodBind.ptrCall(self.godotObject,
...
proc `repeat=`(self: Tween; val: bool) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  tweenSetRepeatMethodBind.ptrCall(self.godotObject, argsToPassToGodot,
                                   ptrCallRet)
...
proc followMethod(self: Tween; objectt: Object; methodd: string;
  ...
  if isNil(tweenFollowMethodMethodBind):
    tweenFollowMethodMethodBind = getMethod(cstring"Tween",
        cstring"follow_method")
  var
...
proc interpolateCallback(self: Tween; objectt: Object; duration: float64;
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  tweenInterpolateCallbackMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc interpolateProperty(self: Tween; objectt: Object; property: NodePath;
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  tweenInterpolatePropertyMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc setActive(self: Tween; active: bool) =
  ...
  var ptrCallRet: pointer
  tweenSetActiveMethodBind.ptrCall(self.godotObject, argsToPassToGodot,
                                   ptrCallRet)

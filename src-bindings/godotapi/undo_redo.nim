...
proc addDoProperty*(self: UndoRedo; objectt: Object; property: string;
...
proc addUndoMethod*(self: UndoRedo; objectt: Object; methodd: string;
                    variantArgs: varargs[Variant]) {.gcsafe, locks: 0.}
proc addUndoProperty*(self: UndoRedo; objectt: Object; property: string;
                      value: Variant) {.gcsafe, locks: 0.}
proc addUndoReference*(self: UndoRedo; objectt: Object) {.gcsafe, locks: 0.}
proc clearHistory*(self: UndoRedo; increaseVersion: bool = true) {.gcsafe,
    locks: 0.}
...
proc addUndoReference(self: UndoRedo; objectt: Object) =
  ...
  argsToPassToGodot[][0] = argToPassToGodot0
  var ptrCallRet: pointer
  undoRedoAddUndoReferenceMethodBind.ptrCall(self.godotObject,
...
proc getCurrentActionName(self: UndoRedo): string =
  ...
  undoRedoGetCurrentActionNameMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
  result = $ptrCallVal
  deinit(ptrCallVal)

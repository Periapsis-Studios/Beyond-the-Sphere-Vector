...
method nodeRemoved*(self: VisibilityEnabler; arg0: Node) {.gcsafe, locks: 0,
    base.}
...
proc `freezeBodies=`(self: VisibilityEnabler; val: bool) =
  if isNil(visibilityEnablerSetEnablerMethodBind):
    visibilityEnablerSetEnablerMethodBind = getMethod(
        cstring"VisibilityEnabler", cstring"set_enabler")
  var
    godotBoundArg0 = 1'i64

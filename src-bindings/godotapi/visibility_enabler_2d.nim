...
proc `pauseAnimatedSprites=`*(self: VisibilityEnabler2D; val: bool) {.gcsafe,
    locks: 0.}
proc pauseAnimations*(self: VisibilityEnabler2D): bool {.gcsafe, locks: 0.}
proc `pauseAnimations=`*(self: VisibilityEnabler2D; val: bool) {.gcsafe,
    locks: 0.}
...
proc `physicsProcessParent=`*(self: VisibilityEnabler2D; val: bool) {.gcsafe,
    locks: 0.}
...
method nodeRemoved*(self: VisibilityEnabler2D; arg0: Node) {.gcsafe, locks: 0,
    base.}

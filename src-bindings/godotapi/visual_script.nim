...
method nodePortsChanged*(self: VisualScript; arg0: int64) {.gcsafe, locks: 0,
    base.}
...
proc addNode*(self: VisualScript; funcc: string; id: int64;
              node: VisualScriptNode; position: Vector2 = vec2(0.0, 0.0)) {.
    gcsafe, locks: 0.}
...
proc customSignalAddArgument*(self: VisualScript; name: string; typee: int64;
                              argname: string; index: int64 = -1'i64) {.gcsafe,
    locks: 0.}
proc customSignalGetArgumentCount*(self: VisualScript; name: string): int64 {.
    gcsafe, locks: 0.}
proc customSignalGetArgumentName*(self: VisualScript; name: string;
                                  argidx: int64): string {.gcsafe, locks: 0.}
proc customSignalGetArgumentType*(self: VisualScript; name: string;
                                  argidx: int64): int64 {.gcsafe, locks: 0.}
proc customSignalRemoveArgument*(self: VisualScript; name: string; argidx: int64) {.
    gcsafe, locks: 0.}
proc customSignalSetArgumentName*(self: VisualScript; name: string;
                                  argidx: int64; argname: string) {.gcsafe,
    locks: 0.}
proc customSignalSetArgumentType*(self: VisualScript; name: string;
                                  argidx: int64; typee: int64) {.gcsafe,
    locks: 0.}
proc customSignalSwapArgument*(self: VisualScript; name: string; argidx: int64;
                               withidx: int64) {.gcsafe, locks: 0.}
proc dataConnect*(self: VisualScript; funcc: string; fromNode: int64;
                  fromPort: int64; toNode: int64; toPort: int64) {.gcsafe,
    locks: 0.}
proc dataDisconnect*(self: VisualScript; funcc: string; fromNode: int64;
                     fromPort: int64; toNode: int64; toPort: int64) {.gcsafe,
    locks: 0.}
proc getFunctionNodeId*(self: VisualScript; name: string): int64 {.gcsafe,
    locks: 0.}
proc getFunctionScroll*(self: VisualScript; name: string): Vector2 {.gcsafe,
    locks: 0.}
...
proc getVariableDefaultValue*(self: VisualScript; name: string): Variant {.
    gcsafe, locks: 0.}
proc getVariableExport*(self: VisualScript; name: string): bool {.gcsafe,
    locks: 0.}
proc getVariableInfo*(self: VisualScript; name: string): Dictionary {.gcsafe,
    locks: 0.}
...
proc hasNode*(self: VisualScript; funcc: string; id: int64): bool {.gcsafe,
    locks: 0.}
proc hasSequenceConnection*(self: VisualScript; funcc: string; fromNode: int64;
                            fromOutput: int64; toNode: int64): bool {.gcsafe,
    locks: 0.}
...
proc removeNode*(self: VisualScript; funcc: string; id: int64) {.gcsafe,
    locks: 0.}
...
proc setNodePosition*(self: VisualScript; funcc: string; id: int64;
...
proc setInstanceBaseType(self: VisualScript; typee: string) =
  if isNil(visualScriptSetInstanceBaseTypeMethodBind):
    visualScriptSetInstanceBaseTypeMethodBind = getMethod(
        cstring"VisualScript", cstring"set_instance_base_type")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)

...
method getCaption*(self: VisualScriptCustomNode): string {.gcsafe, locks: 0,
    base.}
method getCategory*(self: VisualScriptCustomNode): string {.gcsafe, locks: 0,
    base.}
method getInputValuePortCount*(self: VisualScriptCustomNode): int64 {.gcsafe,
    locks: 0, base.}
method getInputValuePortHint*(self: VisualScriptCustomNode; idx: int64): int64 {.
    gcsafe, locks: 0, base.}
method getInputValuePortHintString*(self: VisualScriptCustomNode; idx: int64): string {.
    gcsafe, locks: 0, base.}
...
method getOutputValuePortCount*(self: VisualScriptCustomNode): int64 {.gcsafe,
    locks: 0, base.}
method getOutputValuePortHint*(self: VisualScriptCustomNode; idx: int64): int64 {.
    gcsafe, locks: 0, base.}
method getOutputValuePortHintString*(self: VisualScriptCustomNode; idx: int64): string {.
    gcsafe, locks: 0, base.}
...
method getWorkingMemorySize*(self: VisualScriptCustomNode): int64 {.gcsafe,
    locks: 0, base.}
method hasInputSequencePort*(self: VisualScriptCustomNode): bool {.gcsafe,
    locks: 0, base.}
...
method step*(self: VisualScriptCustomNode; inputs: Array; outputs: Array;
             startMode: int64; workingMem: Array): Variant {.gcsafe, locks: 0,
    base.}
...
var visualScriptCustomNodeUnderscoregetInputValuePortCountMethodBind
...
var visualScriptCustomNodeUnderscoregetInputValuePortHintMethodBind {.threadvar.}: ptr GodotMethodBind
method getInputValuePortHint(self: VisualScriptCustomNode; idx: int64): int64 =
  if isNil(visualScriptCustomNodeUnderscoregetInputValuePortHintMethodBind):
    visualScriptCustomNodeUnderscoregetInputValuePortHintMethodBind = getMethod(
        cstring"VisualScriptCustomNode", cstring"_get_input_value_port_hint")
  var
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  visualScriptCustomNodeUnderscoregetInputValuePortHintMethodBind.ptrCall(
      self.godotObject, argsToPassToGodot, ptrCallRet)

var visualScriptCustomNodeUnderscoregetInputValuePortHintStringMethodBind
    {.threadvar.}: ptr GodotMethodBind
method getInputValuePortHintString(self: VisualScriptCustomNode; idx: int64): string =
  if isNil(visualScriptCustomNodeUnderscoregetInputValuePortHintStringMethodBind):
    visualScriptCustomNodeUnderscoregetInputValuePortHintStringMethodBind = getMethod(
        cstring"VisualScriptCustomNode",
        cstring"_get_input_value_port_hint_string")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(idx)
  ...
  var ptrCallVal: GodotString
  ptrCallRet = addr(ptrCallVal)
  visualScriptCustomNodeUnderscoregetInputValuePortHintStringMethodBind.ptrCall(
      self.godotObject, argsToPassToGodot, ptrCallRet)
  result = $ptrCallVal
  deinit(ptrCallVal)
...
method getOutputSequencePortText(self: VisualScriptCustomNode; idx: int64): string =
  if isNil(visualScriptCustomNodeUnderscoregetOutputSequencePortTextMethodBind):
    visualScriptCustomNodeUnderscoregetOutputSequencePortTextMethodBind = getMethod(
        cstring"VisualScriptCustomNode",
        cstring"_get_output_sequence_port_text")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(idx)
...
var visualScriptCustomNodeUnderscoregetOutputValuePortHintMethodBind
    {.threadvar.}: ptr GodotMethodBind
method getOutputValuePortHint(self: VisualScriptCustomNode; idx: int64): int64 =
  if isNil(visualScriptCustomNodeUnderscoregetOutputValuePortHintMethodBind):
    visualScriptCustomNodeUnderscoregetOutputValuePortHintMethodBind = getMethod(
        cstring"VisualScriptCustomNode", cstring"_get_output_value_port_hint")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(idx)
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  visualScriptCustomNodeUnderscoregetOutputValuePortHintMethodBind.ptrCall(
      self.godotObject, argsToPassToGodot, ptrCallRet)

var visualScriptCustomNodeUnderscoregetOutputValuePortHintStringMethodBind
    {.threadvar.}: ptr GodotMethodBind
method getOutputValuePortHintString(self: VisualScriptCustomNode; idx: int64): string =
  if isNil(visualScriptCustomNodeUnderscoregetOutputValuePortHintStringMethodBind):
    visualScriptCustomNodeUnderscoregetOutputValuePortHintStringMethodBind = getMethod(
        cstring"VisualScriptCustomNode",
        cstring"_get_output_value_port_hint_string")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(idx)
  ...
  var ptrCallVal: GodotString
  ptrCallRet = addr(ptrCallVal)
  visualScriptCustomNodeUnderscoregetOutputValuePortHintStringMethodBind.ptrCall(
      self.godotObject, argsToPassToGodot, ptrCallRet)
  result = $ptrCallVal
  deinit(ptrCallVal)

var visualScriptCustomNodeUnderscoregetOutputValuePortNameMethodBind
    {.threadvar.}: ptr GodotMethodBind
method getOutputValuePortName(self: VisualScriptCustomNode; idx: int64): string =
...
var visualScriptCustomNodeUnderscoregetOutputValuePortTypeMethodBind
    {.threadvar.}: ptr GodotMethodBind
method getOutputValuePortType(self: VisualScriptCustomNode; idx: int64): int64 =

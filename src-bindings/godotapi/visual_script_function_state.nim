...
method signalCallback*(self: VisualScriptFunctionState;
                       variantArgs: varargs[Variant]): Variant {.gcsafe,
    locks: 0, base.}
proc connectToSignal*(self: VisualScriptFunctionState; obj: Object;
                      signals: string; args: Array) {.gcsafe, locks: 0.}

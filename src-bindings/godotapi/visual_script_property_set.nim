...
proc `baseScript=`*(self: VisualScriptPropertySet; val: string) {.gcsafe,
    locks: 0.}
...
proc `nodePath=`*(self: VisualScriptPropertySet; val: NodePath) {.gcsafe,
    locks: 0.}
...
proc `typeCache=`*(self: VisualScriptPropertySet; val: Dictionary) {.gcsafe,
    locks: 0.}

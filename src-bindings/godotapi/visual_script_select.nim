...
proc typee(self: VisualScriptSelect): int64 =
  if isNil(visualScriptSelectGetTypedMethodBind):
    visualScriptSelectGetTypedMethodBind = getMethod(
        cstring"VisualScriptSelect", cstring"get_typed")
...
proc `typee=`(self: VisualScriptSelect; val: int64) =
  if isNil(visualScriptSelectSetTypedMethodBind):
    visualScriptSelectSetTypedMethodBind = getMethod(
        cstring"VisualScriptSelect", cstring"set_typed")
  var

...
const
  ...
  ARRAY_COMPRESS_DEFAULT* = 2194432'i64
  ...
  ARRAY_FLAG_USE_OCTAHEDRAL_COMPRESSION* = 2097152'i64
  ...
  ENV_TONE_MAPPER_ACES_FITTED* = 4'i64
  ...
  LIGHT_BAKE_ALL* = 2'i64
  LIGHT_BAKE_DISABLED* = 0'i64
  LIGHT_BAKE_INDIRECT* = 1'i64
  ...
  LIGHT_PARAM_ATTENUATION* = 5'i64
  LIGHT_PARAM_CONTACT_SHADOW_SIZE* = 8'i64
  LIGHT_PARAM_ENERGY* = 0'i64
  LIGHT_PARAM_INDIRECT_ENERGY* = 1'i64
  LIGHT_PARAM_MAX* = 16'i64
  LIGHT_PARAM_RANGE* = 4'i64
  LIGHT_PARAM_SHADOW_BIAS* = 14'i64
  LIGHT_PARAM_SHADOW_BIAS_SPLIT_SCALE* = 15'i64
  LIGHT_PARAM_SHADOW_MAX_DISTANCE* = 9'i64
  LIGHT_PARAM_SHADOW_NORMAL_BIAS* = 13'i64
  LIGHT_PARAM_SHADOW_SPLIT_1_OFFSET* = 10'i64
  LIGHT_PARAM_SHADOW_SPLIT_2_OFFSET* = 11'i64
  LIGHT_PARAM_SHADOW_SPLIT_3_OFFSET* = 12'i64
  LIGHT_PARAM_SIZE* = 2'i64
  LIGHT_PARAM_SPECULAR* = 3'i64
  LIGHT_PARAM_SPOT_ANGLE* = 6'i64
  LIGHT_PARAM_SPOT_ATTENUATION* = 7'i64
  LIGHT_SPOT* = 2'i64
...
proc blackBarsSetImages*(left: RID; top: RID; right: RID; bottom: RID) {.gcsafe,
    locks: 0.}
...
proc cameraSetFrustum*(camera: RID; size: float64; offset: Vector2;
                       zNear: float64; zFar: float64) {.gcsafe, locks: 0.}
proc cameraSetOrthogonal*(camera: RID; size: float64; zNear: float64;
...
proc canvasItemAddNinePatch*(item: RID; rect: Rect2; source: Rect2;
                             texture: RID; topleft: Vector2;
                             bottomright: Vector2; xAxisMode: int64 = 0'i64;
                             yAxisMode: int64 = 0'i64; drawCenter: bool = true;
                             modulate: Color = initColor(1.0, 1.0, 1.0, 1.0);
                             normalMap: RID = initRID()) {.gcsafe, locks: 0.}
proc canvasItemAddParticles*(item: RID; particles: RID; texture: RID;
                             normalMap: RID) {.gcsafe, locks: 0.}
...
proc canvasItemAddSetTransform*(item: RID; transform: Transform2D) {.gcsafe,
    locks: 0.}
...
proc canvasItemAddTextureRectRegion*(item: RID; rect: Rect2; texture: RID;
                                     srcRect: Rect2; modulate: Color = initColor(
    1.0, 1.0, 1.0, 1.0); transpose: bool = false; normalMap: RID = initRID();
...
proc canvasItemSetCustomRect*(item: RID; useCustomRect: bool;
    ...
    gcsafe, locks: 0.}
proc canvasItemSetDistanceFieldMode*(item: RID; enabled: bool) {.gcsafe,
    locks: 0.}
...
proc canvasItemSetTransform*(item: RID; transform: Transform2D) {.gcsafe,
    locks: 0.}
proc canvasItemSetUseParentMaterial*(item: RID; enabled: bool) {.gcsafe,
    locks: 0.}
proc canvasItemSetVisible*(item: RID; visible: bool) {.gcsafe, locks: 0.}
proc canvasItemSetZAsRelativeToParent*(item: RID; enabled: bool) {.gcsafe,
    locks: 0.}
...
proc canvasLightOccluderAttachToCanvas*(occluder: RID; canvas: RID) {.gcsafe,
    locks: 0.}
proc canvasLightOccluderCreate*(): RID {.gcsafe, locks: 0.}
proc canvasLightOccluderSetEnabled*(occluder: RID; enabled: bool) {.gcsafe,
    locks: 0.}
proc canvasLightOccluderSetLightMask*(occluder: RID; mask: int64) {.gcsafe,
    locks: 0.}
proc canvasLightOccluderSetPolygon*(occluder: RID; polygon: RID) {.gcsafe,
    locks: 0.}
...
proc canvasLightSetItemShadowCullMask*(light: RID; mask: int64) {.gcsafe,
    locks: 0.}
...
proc canvasLightSetTextureOffset*(light: RID; offset: Vector2) {.gcsafe,
    locks: 0.}
proc canvasLightSetTransform*(light: RID; transform: Transform2D) {.gcsafe,
    locks: 0.}
proc canvasLightSetZRange*(light: RID; minZ: int64; maxZ: int64) {.gcsafe,
    locks: 0.}
proc canvasOccluderPolygonCreate*(): RID {.gcsafe, locks: 0.}
proc canvasOccluderPolygonSetCullMode*(occluderPolygon: RID; mode: int64) {.
    gcsafe, locks: 0.}
proc canvasOccluderPolygonSetShape*(occluderPolygon: RID;
                                    shape: PoolVector2Array; closed: bool) {.
    gcsafe, locks: 0.}
...
proc draw*(swapBuffers: bool = true; frameStep: float64 = 0.0) {.gcsafe,
    locks: 0.}
...
proc environmentSetAmbientLight*(env: RID; color: Color; energy: float64 = 1.0;
                                 skyContibution: float64 = 0.0) {.gcsafe,
    locks: 0.}
...
proc environmentSetFogDepth*(env: RID; enable: bool; depthBegin: float64;
                             depthEnd: float64; depthCurve: float64;
                             transmit: bool; transmitCurve: float64) {.gcsafe,
    locks: 0.}
proc environmentSetFogHeight*(env: RID; enable: bool; minHeight: float64;
                              maxHeight: float64; heightCurve: float64) {.
    gcsafe, locks: 0.}
proc environmentSetGlow*(env: RID; enable: bool; levelFlags: int64;
                         intensity: float64; strength: float64;
                         bloomThreshold: float64; blendMode: int64;
                         hdrBleedThreshold: float64; hdrBleedScale: float64;
                         hdrLuminanceCap: float64; bicubicUpscale: bool;
                         highQuality: bool) {.gcsafe, locks: 0.}
...
proc environmentSetSkyOrientation*(env: RID; orientation: Basis) {.gcsafe,
    locks: 0.}
proc environmentSetSsao*(env: RID; enable: bool; radius: float64;
                         intensity: float64; radius2: float64;
                         intensity2: float64; bias: float64;
                         lightAffect: float64; aoChannelAffect: float64;
                         color: Color; quality: int64; blur: int64;
                         bilateralSharpness: float64) {.gcsafe, locks: 0.}
proc environmentSetSsr*(env: RID; enable: bool; maxSteps: int64;
                        fadeIn: float64; fadeOut: float64;
                        depthTolerance: float64; roughness: bool) {.gcsafe,
    locks: 0.}
proc environmentSetTonemap*(env: RID; toneMapper: int64; exposure: float64;
                            ...
                            autoExpSpeed: float64; autoExpGrey: float64) {.
    gcsafe, locks: 0.}
proc finish*() {.gcsafe, locks: 0.}
proc forceDraw*(swapBuffers: bool = true; frameStep: float64 = 0.0) {.gcsafe,
    locks: 0.}
...
proc instanceAttachObjectInstanceId*(instance: RID; id: int64) {.gcsafe,
    locks: 0.}
...
proc instanceSetSurfaceMaterial*(instance: RID; surface: int64; material: RID) {.
    gcsafe, locks: 0.}
proc instanceSetTransform*(instance: RID; transform: Transform) {.gcsafe,
    locks: 0.}
proc instanceSetUseLightmap*(instance: RID; lightmapInstance: RID;
                             lightmap: RID; lightmapSlice: int64 = -1'i64;
    lightmapUvRect: Rect2 = initRect2(0.0, 0.0, 1.0, 1.0)) {.gcsafe, locks: 0.}
proc instanceSetVisible*(instance: RID; visible: bool) {.gcsafe, locks: 0.}
proc instancesCullAabb*(aabb: AABB; scenario: RID = initRID()): Array {.gcsafe,
    locks: 0.}
...
proc lightDirectionalSetBlendSplits*(light: RID; enable: bool) {.gcsafe,
    locks: 0.}
...
proc lightSetBakeMode*(light: RID; bakeMode: int64) {.gcsafe, locks: 0.}
...
proc lightmapCaptureGetOctreeCellTransform*(capture: RID): Transform {.gcsafe,
    locks: 0.}
proc lightmapCaptureIsInterior*(capture: RID): bool {.gcsafe, locks: 0.}
...
proc lightmapCaptureSetInterior*(capture: RID; interior: bool) {.gcsafe,
    locks: 0.}
proc lightmapCaptureSetOctree*(capture: RID; octree: PoolByteArray) {.gcsafe,
    locks: 0.}
...
proc materialGetParam*(material: RID; parameter: string): Variant {.gcsafe,
    locks: 0.}
...
proc materialSetParam*(material: RID; parameter: string; value: Variant) {.
    gcsafe, locks: 0.}
proc materialSetRenderPriority*(material: RID; priority: int64) {.gcsafe,
    locks: 0.}
...
proc meshAddSurfaceFromArrays*(mesh: RID; primitive: int64; arrays: Array;
                               ...
                               compressFormat: int64 = 2194432'i64) {.gcsafe,
    locks: 0.}
...
proc meshSurfaceGetArray*(mesh: RID; surface: int64): PoolByteArray {.gcsafe,
    locks: 0.}
proc meshSurfaceGetArrayIndexLen*(mesh: RID; surface: int64): int64 {.gcsafe,
    locks: 0.}
proc meshSurfaceGetArrayLen*(mesh: RID; surface: int64): int64 {.gcsafe,
    locks: 0.}
...
proc meshSurfaceGetFormatOffset*(format: int64; vertexLen: int64;
                                 indexLen: int64; arrayIndex: int64): int64 {.
    gcsafe, locks: 0.}
proc meshSurfaceGetFormatStride*(format: int64; vertexLen: int64;
                                 indexLen: int64; arrayIndex: int64): int64 {.
    gcsafe, locks: 0.}
...
proc meshSurfaceGetPrimitiveType*(mesh: RID; surface: int64): int64 {.gcsafe,
    locks: 0.}
proc meshSurfaceGetSkeletonAabb*(mesh: RID; surface: int64): Array {.gcsafe,
    locks: 0.}
...
proc multimeshAllocate*(multimesh: RID; instances: int64;
                        transformFormat: int64; colorFormat: int64;
                        customDataFormat: int64 = 0'i64) {.gcsafe, locks: 0.}
...
proc multimeshInstanceGetColor*(multimesh: RID; index: int64): Color {.gcsafe,
    locks: 0.}
...
proc multimeshInstanceSetColor*(multimesh: RID; index: int64; color: Color) {.
    gcsafe, locks: 0.}
proc multimeshInstanceSetCustomData*(multimesh: RID; index: int64;
                                     customData: Color) {.gcsafe, locks: 0.}
...
proc multimeshSetAsBulkArray*(multimesh: RID; array: PoolRealArray) {.gcsafe,
    locks: 0.}
proc multimeshSetMesh*(multimesh: RID; mesh: RID) {.gcsafe, locks: 0.}
proc multimeshSetVisibleInstances*(multimesh: RID; visible: int64) {.gcsafe,
    locks: 0.}
...
proc particlesSetFractionalDelta*(particles: RID; enable: bool) {.gcsafe,
    locks: 0.}
...
proc particlesSetPreProcessTime*(particles: RID; time: float64) {.gcsafe,
    locks: 0.}
proc particlesSetProcessMaterial*(particles: RID; material: RID) {.gcsafe,
    locks: 0.}
proc particlesSetRandomnessRatio*(particles: RID; ratio: float64) {.gcsafe,
    locks: 0.}
proc particlesSetSpeedScale*(particles: RID; scale: float64) {.gcsafe, locks: 0.}
proc particlesSetUseLocalCoordinates*(particles: RID; enable: bool) {.gcsafe,
    locks: 0.}
...
proc reflectionProbeSetEnableBoxProjection*(probe: RID; enable: bool) {.gcsafe,
    locks: 0.}
proc reflectionProbeSetEnableShadows*(probe: RID; enable: bool) {.gcsafe,
    locks: 0.}
proc reflectionProbeSetExtents*(probe: RID; extents: Vector3) {.gcsafe, locks: 0.}
proc reflectionProbeSetIntensity*(probe: RID; intensity: float64) {.gcsafe,
    locks: 0.}
proc reflectionProbeSetInteriorAmbient*(probe: RID; color: Color) {.gcsafe,
    locks: 0.}
...
proc reflectionProbeSetMaxDistance*(probe: RID; distance: float64) {.gcsafe,
    locks: 0.}
proc reflectionProbeSetOriginOffset*(probe: RID; offset: Vector3) {.gcsafe,
    locks: 0.}
proc reflectionProbeSetUpdateMode*(probe: RID; mode: int64) {.gcsafe, locks: 0.}
proc requestFrameDrawnCallback*(where: Object; methodd: string;
...
proc setBootImage*(image: Image; color: Color; scale: bool;
                   useFilter: bool = true) {.gcsafe, locks: 0.}
...
proc setUseOcclusionCulling*(enable: bool) {.gcsafe, locks: 0.}
proc shaderCreate*(): RID {.gcsafe, locks: 0.}
proc shaderGetCode*(shader: RID): string {.gcsafe, locks: 0.}
proc shaderGetDefaultTextureParam*(shader: RID; name: string): RID {.gcsafe,
    locks: 0.}
...
proc skeletonBoneSetTransform*(skeleton: RID; bone: int64; transform: Transform) {.
    gcsafe, locks: 0.}
proc skeletonBoneSetTransform2d*(skeleton: RID; bone: int64;
                                 transform: Transform2D) {.gcsafe, locks: 0.}
...
proc skySetTexture*(sky: RID; cubeMap: RID; radianceSize: int64) {.gcsafe,
    locks: 0.}
...
proc textureCreateFromImage*(image: Image; flags: int64 = 7'i64): RID {.gcsafe,
    locks: 0.}
proc textureDebugUsage*(): Array {.gcsafe, locks: 0.}
proc textureGetData*(texture: RID; cubeSide: int64 = 0'i64): Image {.gcsafe,
    locks: 0.}
...
proc textureSetData*(texture: RID; image: Image; layer: int64 = 0'i64) {.gcsafe,
    locks: 0.}
proc textureSetDataPartial*(texture: RID; image: Image; srcX: int64;
                            srcY: int64; srcW: int64; srcH: int64; dstX: int64;
                            dstY: int64; dstMip: int64; layer: int64 = 0'i64) {.
    gcsafe, locks: 0.}
...
proc viewportGetRenderInfo*(viewport: RID; info: int64): int64 {.gcsafe,
    locks: 0.}
...
proc viewportSetDisableEnvironment*(viewport: RID; disabled: bool) {.gcsafe,
    locks: 0.}
...
proc viewportSetParentViewport*(viewport: RID; parentViewport: RID) {.gcsafe,
    locks: 0.}
proc viewportSetRenderDirectToScreen*(viewport: RID; enabled: bool) {.gcsafe,
    locks: 0.}
...
proc viewportSetSharpenIntensity*(viewport: RID; intensity: float64) {.gcsafe,
    locks: 0.}
proc viewportSetSize*(viewport: RID; width: int64; height: int64) {.gcsafe,
    locks: 0.}
...
proc viewportSetUseDebanding*(viewport: RID; debanding: bool) {.gcsafe, locks: 0.}
proc viewportSetUseFxaa*(viewport: RID; fxaa: bool) {.gcsafe, locks: 0.}
...
proc blackBarsSetMargins(left: int64; top: int64; right: int64; bottom: int64) =
  ...
  if isNil(visualServerBlackBarsSetMarginsMethodBind):
    visualServerBlackBarsSetMarginsMethodBind = getMethod(
        cstring"VisualServer", cstring"black_bars_set_margins")
  var
    argsStatic: array[4, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(left)
...
proc cameraSetEnvironment(camera: RID; env: RID) =
  ...
  if isNil(visualServerCameraSetEnvironmentMethodBind):
    visualServerCameraSetEnvironmentMethodBind = getMethod(
        cstring"VisualServer", cstring"camera_set_environment")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(camera)
...
proc cameraSetOrthogonal(camera: RID; size: float64; zNear: float64;
  ...
  if isNil(visualServerCameraSetOrthogonalMethodBind):
    visualServerCameraSetOrthogonalMethodBind = getMethod(
        cstring"VisualServer", cstring"camera_set_orthogonal")
  var
    argsStatic: array[4, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(camera)
...
proc cameraSetPerspective(camera: RID; fovyDegrees: float64; zNear: float64;
  ...
  if isNil(visualServerCameraSetPerspectiveMethodBind):
    visualServerCameraSetPerspectiveMethodBind = getMethod(
        cstring"VisualServer", cstring"camera_set_perspective")
  var
    argsStatic: array[4, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(camera)
...
proc canvasItemAddCircle(item: RID; pos: Vector2; radius: float64; color: Color) =
  ...
  if isNil(visualServerCanvasItemAddCircleMethodBind):
    visualServerCanvasItemAddCircleMethodBind = getMethod(
        cstring"VisualServer", cstring"canvas_item_add_circle")
  var
    argsStatic: array[4, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc canvasItemAddPolygon(item: RID; points: PoolVector2Array;
  ...
  if isNil(visualServerCanvasItemAddPolygonMethodBind):
    visualServerCanvasItemAddPolygonMethodBind = getMethod(
        cstring"VisualServer", cstring"canvas_item_add_polygon")
  var
...
proc canvasItemCreate(): RID =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  visualServerCanvasItemCreateMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc canvasItemSetParent(item: RID; parent: RID) =
  ...
  if isNil(visualServerCanvasItemSetParentMethodBind):
    visualServerCanvasItemSetParentMethodBind = getMethod(
        cstring"VisualServer", cstring"canvas_item_set_parent")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(item)
...
proc canvasItemSetVisible(item: RID; visible: bool) =
  ...
  if isNil(visualServerCanvasItemSetVisibleMethodBind):
    visualServerCanvasItemSetVisibleMethodBind = getMethod(
        cstring"VisualServer", cstring"canvas_item_set_visible")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(item)
...
proc canvasItemSetZIndex(item: RID; zIndex: int64) =
  ...
  if isNil(visualServerCanvasItemSetZIndexMethodBind):
    visualServerCanvasItemSetZIndexMethodBind = getMethod(
        cstring"VisualServer", cstring"canvas_item_set_z_index")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(item)
...
proc canvasLightSetColor(light: RID; color: Color) =
  ...
  if isNil(visualServerCanvasLightSetColorMethodBind):
    visualServerCanvasLightSetColorMethodBind = getMethod(
        cstring"VisualServer", cstring"canvas_light_set_color")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(light)
...
proc canvasLightSetEnergy(light: RID; energy: float64) =
  ...
  if isNil(visualServerCanvasLightSetEnergyMethodBind):
    visualServerCanvasLightSetEnergyMethodBind = getMethod(
        cstring"VisualServer", cstring"canvas_light_set_energy")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(light)
...
proc canvasLightSetHeight(light: RID; height: float64) =
  ...
  if isNil(visualServerCanvasLightSetHeightMethodBind):
    visualServerCanvasLightSetHeightMethodBind = getMethod(
        cstring"VisualServer", cstring"canvas_light_set_height")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(light)
...
proc canvasLightSetScale(light: RID; scale: float64) =
  ...
  if isNil(visualServerCanvasLightSetScaleMethodBind):
    visualServerCanvasLightSetScaleMethodBind = getMethod(
        cstring"VisualServer", cstring"canvas_light_set_scale")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(light)
...
proc canvasLightSetZRange(light: RID; minZ: int64; maxZ: int64) =
  ...
  if isNil(visualServerCanvasLightSetZRangeMethodBind):
    visualServerCanvasLightSetZRangeMethodBind = getMethod(
        cstring"VisualServer", cstring"canvas_light_set_z_range")
  var
    argsStatic: array[3, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(light)
...
proc environmentSetFogDepth(env: RID; enable: bool; depthBegin: float64;
                            depthEnd: float64; depthCurve: float64;
                            transmit: bool; transmitCurve: float64) =
  if isNil(singletonVisualServer):
    singletonVisualServer = getSingleton[VisualServer]()
  let self = singletonVisualServer
...
proc environmentSetGlow(env: RID; enable: bool; levelFlags: int64;
  ...
  argsToPassToGodot[][11] = unsafeAddr(highQuality)
  var ptrCallRet: pointer
...
proc environmentSetSsr(env: RID; enable: bool; maxSteps: int64; fadeIn: float64;
                       fadeOut: float64; depthTolerance: float64;
                       roughness: bool) =
  if isNil(singletonVisualServer):
    singletonVisualServer = getSingleton[VisualServer]()
  let self = singletonVisualServer
...
proc getVideoAdapterName(): string =
  ...
  if isNil(visualServerGetVideoAdapterNameMethodBind):
    visualServerGetVideoAdapterNameMethodBind = getMethod(
        cstring"VisualServer", cstring"get_video_adapter_name")
  var ptrCallRet: pointer
...
proc getWhiteTexture(): RID =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  visualServerGetWhiteTextureMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc giProbeGetNormalBias(probe: RID): float64 =
  ...
  if isNil(visualServerGiProbeGetNormalBiasMethodBind):
    visualServerGiProbeGetNormalBiasMethodBind = getMethod(
        cstring"VisualServer", cstring"gi_probe_get_normal_bias")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(probe)
...
proc giProbeIsCompressed(probe: RID): bool =
  ...
  if isNil(visualServerGiProbeIsCompressedMethodBind):
    visualServerGiProbeIsCompressedMethodBind = getMethod(
        cstring"VisualServer", cstring"gi_probe_is_compressed")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(probe)
...
proc giProbeSetNormalBias(probe: RID; bias: float64) =
  ...
  if isNil(visualServerGiProbeSetNormalBiasMethodBind):
    visualServerGiProbeSetNormalBiasMethodBind = getMethod(
        cstring"VisualServer", cstring"gi_probe_set_normal_bias")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(probe)
...
proc hasOsFeature(feature: string): bool =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  visualServerHasOsFeatureMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc immediateCreate(): RID =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  visualServerImmediateCreateMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc immediateEnd(immediate: RID) =
  ...
  argsToPassToGodot[][0] = unsafeAddr(immediate)
  var ptrCallRet: pointer
  visualServerImmediateEndMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc immediateGetMaterial(immediate: RID): RID =
  ...
  if isNil(visualServerImmediateGetMaterialMethodBind):
    visualServerImmediateGetMaterialMethodBind = getMethod(
        cstring"VisualServer", cstring"immediate_get_material")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(immediate)
...
proc immediateSetMaterial(immediate: RID; material: RID) =
  ...
  if isNil(visualServerImmediateSetMaterialMethodBind):
    visualServerImmediateSetMaterialMethodBind = getMethod(
        cstring"VisualServer", cstring"immediate_set_material")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(immediate)
...
proc immediateUv2(immediate: RID; texUv: Vector2) =
  ...
  argsToPassToGodot[][1] = unsafeAddr(texUv)
  var ptrCallRet: pointer
  visualServerImmediateUv2MethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc instanceSetExterior(instance: RID; enabled: bool) =
  ...
  if isNil(visualServerInstanceSetExteriorMethodBind):
    visualServerInstanceSetExteriorMethodBind = getMethod(
        cstring"VisualServer", cstring"instance_set_exterior")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(instance)
...
proc instanceSetLayerMask(instance: RID; mask: int64) =
  ...
  if isNil(visualServerInstanceSetLayerMaskMethodBind):
    visualServerInstanceSetLayerMaskMethodBind = getMethod(
        cstring"VisualServer", cstring"instance_set_layer_mask")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(instance)
...
proc instanceSetScenario(instance: RID; scenario: RID) =
  ...
  if isNil(visualServerInstanceSetScenarioMethodBind):
    visualServerInstanceSetScenarioMethodBind = getMethod(
        cstring"VisualServer", cstring"instance_set_scenario")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(instance)
...
proc instanceSetTransform(instance: RID; transform: Transform) =
  ...
  if isNil(visualServerInstanceSetTransformMethodBind):
    visualServerInstanceSetTransformMethodBind = getMethod(
        cstring"VisualServer", cstring"instance_set_transform")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(instance)
...
proc instanceSetUseLightmap(instance: RID; lightmapInstance: RID; lightmap: RID;
                            lightmapSlice: int64 = -1'i64; lightmapUvRect: Rect2 = initRect2(
    0.0, 0.0, 1.0, 1.0)) =
  if isNil(singletonVisualServer):
    singletonVisualServer = getSingleton[VisualServer]()
  let self = singletonVisualServer
  ...
  argsToPassToGodot[][3] = unsafeAddr(lightmapSlice)
  argsToPassToGodot[][4] = unsafeAddr(lightmapUvRect)
  var ptrCallRet: pointer
...
proc instancesCullConvex(convex: Array; scenario: RID = initRID()): Array =
  ...
  if isNil(visualServerInstancesCullConvexMethodBind):
    visualServerInstancesCullConvexMethodBind = getMethod(
        cstring"VisualServer", cstring"instances_cull_convex")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc isRenderLoopEnabled(): bool =
  ...
  if isNil(visualServerIsRenderLoopEnabledMethodBind):
    visualServerIsRenderLoopEnabledMethodBind = getMethod(
        cstring"VisualServer", cstring"is_render_loop_enabled")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
...
var visualServerLightSetBakeModeMethodBind {.threadvar.}: ptr GodotMethodBind
proc lightSetBakeMode(light: RID; bakeMode: int64) =
  if isNil(singletonVisualServer):
    singletonVisualServer = getSingleton[VisualServer]()
  let self = singletonVisualServer
  if isNil(visualServerLightSetBakeModeMethodBind):
    visualServerLightSetBakeModeMethodBind = getMethod(cstring"VisualServer",
        cstring"light_set_bake_mode")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(light)
  argsToPassToGodot[][1] = unsafeAddr(bakeMode)
  var ptrCallRet: pointer
  visualServerLightSetBakeModeMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc lightSetShadowColor(light: RID; color: Color) =
  ...
  if isNil(visualServerLightSetShadowColorMethodBind):
    visualServerLightSetShadowColorMethodBind = getMethod(
        cstring"VisualServer", cstring"light_set_shadow_color")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(light)
...
var visualServerLightmapCaptureIsInteriorMethodBind {.threadvar.}: ptr GodotMethodBind
proc lightmapCaptureIsInterior(capture: RID): bool =
  if isNil(singletonVisualServer):
    singletonVisualServer = getSingleton[VisualServer]()
  let self = singletonVisualServer
  if isNil(visualServerLightmapCaptureIsInteriorMethodBind):
    visualServerLightmapCaptureIsInteriorMethodBind = getMethod(
        cstring"VisualServer", cstring"lightmap_capture_is_interior")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(capture)
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  visualServerLightmapCaptureIsInteriorMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
var visualServerLightmapCaptureSetInteriorMethodBind {.threadvar.}: ptr GodotMethodBind
proc lightmapCaptureSetInterior(capture: RID; interior: bool) =
  if isNil(singletonVisualServer):
    singletonVisualServer = getSingleton[VisualServer]()
  let self = singletonVisualServer
  if isNil(visualServerLightmapCaptureSetInteriorMethodBind):
    visualServerLightmapCaptureSetInteriorMethodBind = getMethod(
        cstring"VisualServer", cstring"lightmap_capture_set_interior")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(capture)
  argsToPassToGodot[][1] = unsafeAddr(interior)
  var ptrCallRet: pointer
  visualServerLightmapCaptureSetInteriorMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc materialSetLineWidth(material: RID; width: float64) =
  ...
  if isNil(visualServerMaterialSetLineWidthMethodBind):
    visualServerMaterialSetLineWidthMethodBind = getMethod(
        cstring"VisualServer", cstring"material_set_line_width")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(material)
...
proc materialSetNextPass(material: RID; nextMaterial: RID) =
  ...
  if isNil(visualServerMaterialSetNextPassMethodBind):
    visualServerMaterialSetNextPassMethodBind = getMethod(
        cstring"VisualServer", cstring"material_set_next_pass")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(material)
...
proc meshAddSurfaceFromArrays(mesh: RID; primitive: int64; arrays: Array;
                              blendShapes: Array = newArray();
                              compressFormat: int64 = 2194432'i64) =
  if isNil(singletonVisualServer):
    singletonVisualServer = getSingleton[VisualServer]()
  let self = singletonVisualServer
...
proc meshGetSurfaceCount(mesh: RID): int64 =
  ...
  if isNil(visualServerMeshGetSurfaceCountMethodBind):
    visualServerMeshGetSurfaceCountMethodBind = getMethod(
        cstring"VisualServer", cstring"mesh_get_surface_count")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(mesh)
...
proc meshSurfaceGetArray(mesh: RID; surface: int64): PoolByteArray =
  ...
  if isNil(visualServerMeshSurfaceGetArrayMethodBind):
    visualServerMeshSurfaceGetArrayMethodBind = getMethod(
        cstring"VisualServer", cstring"mesh_surface_get_array")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(mesh)
...
proc meshSurfaceGetArrays(mesh: RID; surface: int64): Array =
  ...
  if isNil(visualServerMeshSurfaceGetArraysMethodBind):
    visualServerMeshSurfaceGetArraysMethodBind = getMethod(
        cstring"VisualServer", cstring"mesh_surface_get_arrays")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(mesh)
...
proc meshSurfaceGetFormat(mesh: RID; surface: int64): int64 =
  ...
  if isNil(visualServerMeshSurfaceGetFormatMethodBind):
    visualServerMeshSurfaceGetFormatMethodBind = getMethod(
        cstring"VisualServer", cstring"mesh_surface_get_format")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(mesh)
...
proc multimeshCreate(): RID =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  visualServerMultimeshCreateMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc omniLightCreate(): RID =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  visualServerOmniLightCreateMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc particlesCreate(): RID =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  visualServerParticlesCreateMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc particlesGetEmitting(particles: RID): bool =
  ...
  if isNil(visualServerParticlesGetEmittingMethodBind):
    visualServerParticlesGetEmittingMethodBind = getMethod(
        cstring"VisualServer", cstring"particles_get_emitting")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(particles)
...
proc particlesIsInactive(particles: RID): bool =
  ...
  if isNil(visualServerParticlesIsInactiveMethodBind):
    visualServerParticlesIsInactiveMethodBind = getMethod(
        cstring"VisualServer", cstring"particles_is_inactive")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(particles)
...
proc particlesSetEmitting(particles: RID; emitting: bool) =
  ...
  if isNil(visualServerParticlesSetEmittingMethodBind):
    visualServerParticlesSetEmittingMethodBind = getMethod(
        cstring"VisualServer", cstring"particles_set_emitting")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(particles)
...
proc particlesSetFixedFps(particles: RID; fps: int64) =
  ...
  if isNil(visualServerParticlesSetFixedFpsMethodBind):
    visualServerParticlesSetFixedFpsMethodBind = getMethod(
        cstring"VisualServer", cstring"particles_set_fixed_fps")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(particles)
...
proc particlesSetLifetime(particles: RID; lifetime: float64) =
  ...
  if isNil(visualServerParticlesSetLifetimeMethodBind):
    visualServerParticlesSetLifetimeMethodBind = getMethod(
        cstring"VisualServer", cstring"particles_set_lifetime")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(particles)
...
proc particlesSetOneShot(particles: RID; oneShot: bool) =
  ...
  if isNil(visualServerParticlesSetOneShotMethodBind):
    visualServerParticlesSetOneShotMethodBind = getMethod(
        cstring"VisualServer", cstring"particles_set_one_shot")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(particles)
...
proc setBootImage(image: Image; color: Color; scale: bool;
  ...
  var ptrCallRet: pointer
  visualServerSetBootImageMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc setDefaultClearColor(color: Color) =
  ...
  if isNil(visualServerSetDefaultClearColorMethodBind):
    visualServerSetDefaultClearColorMethodBind = getMethod(
        cstring"VisualServer", cstring"set_default_clear_color")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc setRenderLoopEnabled(enabled: bool) =
  ...
  if isNil(visualServerSetRenderLoopEnabledMethodBind):
    visualServerSetRenderLoopEnabledMethodBind = getMethod(
        cstring"VisualServer", cstring"set_render_loop_enabled")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
var visualServerSetUseOcclusionCullingMethodBind {.threadvar.}: ptr GodotMethodBind
proc setUseOcclusionCulling(enable: bool) =
  if isNil(singletonVisualServer):
    singletonVisualServer = getSingleton[VisualServer]()
  let self = singletonVisualServer
  if isNil(visualServerSetUseOcclusionCullingMethodBind):
    visualServerSetUseOcclusionCullingMethodBind = getMethod(
        cstring"VisualServer", cstring"set_use_occlusion_culling")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(enable)
  var ptrCallRet: pointer
  visualServerSetUseOcclusionCullingMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
proc skeletonGetBoneCount(skeleton: RID): int64 =
  ...
  if isNil(visualServerSkeletonGetBoneCountMethodBind):
    visualServerSkeletonGetBoneCountMethodBind = getMethod(
        cstring"VisualServer", cstring"skeleton_get_bone_count")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(skeleton)
...
proc spotLightCreate(): RID =
  ...
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  visualServerSpotLightCreateMethodBind.ptrCall(self.godotObject, nil,
      ptrCallRet)
...
proc texturesKeepOriginal(enable: bool) =
  ...
  if isNil(visualServerTexturesKeepOriginalMethodBind):
    visualServerTexturesKeepOriginalMethodBind = getMethod(
        cstring"VisualServer", cstring"textures_keep_original")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(enable)
...
proc viewportAttachCamera(viewport: RID; camera: RID) =
  ...
  if isNil(visualServerViewportAttachCameraMethodBind):
    visualServerViewportAttachCameraMethodBind = getMethod(
        cstring"VisualServer", cstring"viewport_attach_camera")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
...
proc viewportAttachCanvas(viewport: RID; canvas: RID) =
  ...
  if isNil(visualServerViewportAttachCanvasMethodBind):
    visualServerViewportAttachCanvasMethodBind = getMethod(
        cstring"VisualServer", cstring"viewport_attach_canvas")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(viewport)
...
proc viewportRemoveCanvas(viewport: RID; canvas: RID) =
  ...
  if isNil(visualServerViewportRemoveCanvasMethodBind):
    visualServerViewportRemoveCanvasMethodBind = getMethod(
        cstring"VisualServer", cstring"viewport_remove_canvas")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(viewport)
...
proc viewportSetClearMode(viewport: RID; clearMode: int64) =
  ...
  if isNil(visualServerViewportSetClearModeMethodBind):
    visualServerViewportSetClearModeMethodBind = getMethod(
        cstring"VisualServer", cstring"viewport_set_clear_mode")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(viewport)
...
proc viewportSetDebugDraw(viewport: RID; draw: int64) =
  ...
  if isNil(visualServerViewportSetDebugDrawMethodBind):
    visualServerViewportSetDebugDrawMethodBind = getMethod(
        cstring"VisualServer", cstring"viewport_set_debug_draw")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(viewport)
...
proc viewportSetDisable3d(viewport: RID; disabled: bool) =
  ...
  if isNil(visualServerViewportSetDisable3dMethodBind):
    visualServerViewportSetDisable3dMethodBind = getMethod(
        cstring"VisualServer", cstring"viewport_set_disable_3d")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(viewport)
...
proc viewportSetScenario(viewport: RID; scenario: RID) =
  ...
  if isNil(visualServerViewportSetScenarioMethodBind):
    visualServerViewportSetScenarioMethodBind = getMethod(
        cstring"VisualServer", cstring"viewport_set_scenario")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(viewport)
...
var visualServerViewportSetSharpenIntensityMethodBind {.threadvar.}: ptr GodotMethodBind
proc viewportSetSharpenIntensity(viewport: RID; intensity: float64) =
  if isNil(singletonVisualServer):
    singletonVisualServer = getSingleton[VisualServer]()
  let self = singletonVisualServer
  if isNil(visualServerViewportSetSharpenIntensityMethodBind):
    visualServerViewportSetSharpenIntensityMethodBind = getMethod(
        cstring"VisualServer", cstring"viewport_set_sharpen_intensity")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(viewport)
  argsToPassToGodot[][1] = unsafeAddr(intensity)
  var ptrCallRet: pointer
  visualServerViewportSetSharpenIntensityMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)
...
var visualServerViewportSetUseDebandingMethodBind {.threadvar.}: ptr GodotMethodBind
proc viewportSetUseDebanding(viewport: RID; debanding: bool) =
  if isNil(singletonVisualServer):
    singletonVisualServer = getSingleton[VisualServer]()
  let self = singletonVisualServer
  if isNil(visualServerViewportSetUseDebandingMethodBind):
    visualServerViewportSetUseDebandingMethodBind = getMethod(
        cstring"VisualServer", cstring"viewport_set_use_debanding")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(viewport)
  argsToPassToGodot[][1] = unsafeAddr(debanding)
  var ptrCallRet: pointer
  visualServerViewportSetUseDebandingMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

var visualServerViewportSetUseFxaaMethodBind {.threadvar.}: ptr GodotMethodBind
proc viewportSetUseFxaa(viewport: RID; fxaa: bool) =
  if isNil(singletonVisualServer):
    singletonVisualServer = getSingleton[VisualServer]()
  let self = singletonVisualServer
  if isNil(visualServerViewportSetUseFxaaMethodBind):
    visualServerViewportSetUseFxaaMethodBind = getMethod(cstring"VisualServer",
        cstring"viewport_set_use_fxaa")
  var
    argsStatic: array[2, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(viewport)
  argsToPassToGodot[][1] = unsafeAddr(fxaa)
  var ptrCallRet: pointer
  visualServerViewportSetUseFxaaMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

...
proc canConnectNodes*(self: VisualShader; typee: int64; fromNode: int64;
    ...
    gcsafe, locks: 0.}
proc connectNodes*(self: VisualShader; typee: int64; fromNode: int64;
                   fromPort: int64; toNode: int64; toPort: int64): Error {.
    gcsafe, locks: 0.}
...
proc getNode*(self: VisualShader; typee: int64; id: int64): VisualShaderNode {.
    gcsafe, locks: 0.}
proc getNodeConnections*(self: VisualShader; typee: int64): Array {.gcsafe,
    locks: 0.}
proc getNodeList*(self: VisualShader; typee: int64): PoolIntArray {.gcsafe,
    locks: 0.}
...
proc setNodePosition*(self: VisualShader; typee: int64; id: int64;
...
proc connectNodes(self: VisualShader; typee: int64; fromNode: int64;
  ...
  visualShaderConnectNodesMethodBind.ptrCall(self.godotObject,
      argsToPassToGodot, ptrCallRet)

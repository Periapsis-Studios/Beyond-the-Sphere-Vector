...
proc `defaultInputValues=`*(self: VisualShaderNode; val: Array) {.gcsafe,
    locks: 0.}
proc outputPortForPreview*(self: VisualShaderNode): int64 {.gcsafe, locks: 0.}
proc `outputPortForPreview=`*(self: VisualShaderNode; val: int64) {.gcsafe,
    locks: 0.}
proc getInputPortDefaultValue*(self: VisualShaderNode; port: int64): Variant {.
    gcsafe, locks: 0.}
proc setInputPortDefaultValue*(self: VisualShaderNode; port: int64;

...
proc initialized*(self: VisualShaderNodeCustom): bool {.gcsafe, locks: 0.}
proc `initialized=`*(self: VisualShaderNodeCustom; val: bool) {.gcsafe, locks: 0.}
method getCategory*(self: VisualShaderNodeCustom): string {.gcsafe, locks: 0,
    base.}
method getCode*(self: VisualShaderNodeCustom; inputVars: Array;
                outputVars: Array; mode: int64; typee: int64): string {.gcsafe,
    locks: 0, base.}
method getDescription*(self: VisualShaderNodeCustom): string {.gcsafe, locks: 0,
    base.}
method getGlobalCode*(self: VisualShaderNodeCustom; mode: int64): string {.
    gcsafe, locks: 0, base.}
method getInputPortCount*(self: VisualShaderNodeCustom): int64 {.gcsafe,
    locks: 0, base.}
...
method getOutputPortCount*(self: VisualShaderNodeCustom): int64 {.gcsafe,
    locks: 0, base.}
...
method getOutputPortType*(self: VisualShaderNodeCustom; port: int64): int64 {.
    gcsafe, locks: 0, base.}
method getReturnIconType*(self: VisualShaderNodeCustom): int64 {.gcsafe,
    locks: 0, base.}
method getSubcategory*(self: VisualShaderNodeCustom): string {.gcsafe, locks: 0,
    base.}
method setInputPortDefaultValue*(self: VisualShaderNodeCustom; port: int64;
                                 value: Variant) {.gcsafe, locks: 0, base.}
var visualShaderNodeCustomUnderscoreisInitializedMethodBind {.threadvar.}: ptr GodotMethodBind
proc initialized(self: VisualShaderNodeCustom): bool =
  if isNil(visualShaderNodeCustomUnderscoreisInitializedMethodBind):
    visualShaderNodeCustomUnderscoreisInitializedMethodBind = getMethod(
        cstring"VisualShaderNodeCustom", cstring"_is_initialized")
  var ptrCallRet: pointer
  ptrCallRet = addr(result)
  visualShaderNodeCustomUnderscoreisInitializedMethodBind.ptrCall(
      self.godotObject, nil, ptrCallRet)

var visualShaderNodeCustomUnderscoresetInitializedMethodBind {.threadvar.}: ptr GodotMethodBind
proc `initialized=`(self: VisualShaderNodeCustom; val: bool) =
  if isNil(visualShaderNodeCustomUnderscoresetInitializedMethodBind):
    visualShaderNodeCustomUnderscoresetInitializedMethodBind = getMethod(
        cstring"VisualShaderNodeCustom", cstring"_set_initialized")
  var
    argsStatic: array[1, pointer]
    argsToPassToGodot = cast[ptr array[MAX_ARG_COUNT, pointer]](addr argsStatic)
  argsToPassToGodot[][0] = unsafeAddr(val)
  var ptrCallRet: pointer
  visualShaderNodeCustomUnderscoresetInitializedMethodBind.ptrCall(
...
method getCode(self: VisualShaderNodeCustom; inputVars: Array;
               outputVars: Array; mode: int64; typee: int64): string =
...
var visualShaderNodeCustomUnderscoresetInputPortDefaultValueMethodBind
    {.threadvar.}: ptr GodotMethodBind
method setInputPortDefaultValue(self: VisualShaderNodeCustom; port: int64;
                                value: Variant) =
  if isNil(visualShaderNodeCustomUnderscoresetInputPortDefaultValueMethodBind):
    visualShaderNodeCustomUnderscoresetInputPortDefaultValueMethodBind = getMethod(
        cstring"VisualShaderNodeCustom", cstring"_set_input_port_default_value")
  var
  ...
  var ptrCallRet: pointer
  visualShaderNodeCustomUnderscoresetInputPortDefaultValueMethodBind.ptrCall(
      self.godotObject, argsToPassToGodot, ptrCallRet)

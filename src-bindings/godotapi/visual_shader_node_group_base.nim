...
proc getFreeInputPortId*(self: VisualShaderNodeGroupBase): int64 {.gcsafe,
    locks: 0.}
proc getFreeOutputPortId*(self: VisualShaderNodeGroupBase): int64 {.gcsafe,
    locks: 0.}
proc getInputPortCount*(self: VisualShaderNodeGroupBase): int64 {.gcsafe,
    locks: 0.}
proc getInputs*(self: VisualShaderNodeGroupBase): string {.gcsafe, locks: 0.}
proc getOutputPortCount*(self: VisualShaderNodeGroupBase): int64 {.gcsafe,
    locks: 0.}
proc getOutputs*(self: VisualShaderNodeGroupBase): string {.gcsafe, locks: 0.}
proc hasInputPort*(self: VisualShaderNodeGroupBase; id: int64): bool {.gcsafe,
    locks: 0.}
...
proc isValidPortName*(self: VisualShaderNodeGroupBase; name: string): bool {.
    gcsafe, locks: 0.}
proc removeInputPort*(self: VisualShaderNodeGroupBase; id: int64) {.gcsafe,
    locks: 0.}
proc removeOutputPort*(self: VisualShaderNodeGroupBase; id: int64) {.gcsafe,
    locks: 0.}
...
proc setInputPortType*(self: VisualShaderNodeGroupBase; id: int64; typee: int64) {.
    gcsafe, locks: 0.}
proc setInputs*(self: VisualShaderNodeGroupBase; inputs: string) {.gcsafe,
    locks: 0.}
...
proc setOutputPortType*(self: VisualShaderNodeGroupBase; id: int64; typee: int64) {.
    gcsafe, locks: 0.}
proc setOutputs*(self: VisualShaderNodeGroupBase; outputs: string) {.gcsafe,
    locks: 0.}
